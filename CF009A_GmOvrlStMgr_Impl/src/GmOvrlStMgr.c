 ...
 *  Generated at:  Mon Aug 22 11:57:14 2016
 *
...
static FUNC(void, GMOVRLSTMGR_CODE) LkaCheck(P2VAR(boolean, AUTOMATIC, GmOvrlStMgr_VAR) LkaFlt_Cnt_T_logl, 
                                             P2VAR(boolean, AUTOMATIC, GmOvrlStMgr_VAR) LkaInhb_Cnt_T_logl, 
                                             P2VAR(boolean, AUTOMATIC, GmOvrlStMgr_VAR) LkaPrmntFlt_Cnt_T_logl);                                            
 ...
 *********************************************************************************************************************/
    ...
    *Rte_Pim_PrevLkaFlt() = LkaFlt_Cnt_T_logl;
    ...
    /* LKA Check */
    LkaCheck(&LkaFlt_Cnt_T_logl, &LkaInhb_Cnt_T_logl, &LkaPrmntFlt_Cnt_T_logl);
	...
	else
	{
        ...
        if((ApaNrcvrlFlt_Cnt_T_logl == TRUE) || (LoaSt_Cnt_T_enum == LOAST_SWBASDMTGTN))
		{
...
*                   SysSt_Cnt_T_enum, *LkaSt_Cnt_T_u08
* Outputs       :   None
* Usage Notes   :
*****************************************************************************/
static FUNC(void, GMOVRLSTMGR_CODE) LkaStTran(boolean LkaMfgEna_Cnt_T_logl,
											  ...
											  P2VAR(uint8, AUTOMATIC, GmOvrlStMgr_VAR) LkaSt_Cnt_T_u08)
{
	...
	else
	{
		*LkaSt_Cnt_T_u08 = *Rte_Pim_PrevLkaSt();   
		...
		if((LkaPrmntFlt_Cnt_T_logl == TRUE) || (LoaSt_Cnt_T_enum == LOAST_SWBASDMTGTN))
		{
...
*                   SysSt_Cnt_T_enum, *EscSt_Cnt_T_u08
* Outputs       :   None
* Usage Notes   :
*****************************************************************************/
static FUNC(void, GMOVRLSTMGR_CODE) EscStTran(boolean EscMfgEna_Cnt_T_logl,
	...
	else
	{
		*EscSt_Cnt_T_u08 = *Rte_Pim_PrevEscSt();   
		...
		switch (*EscSt_Cnt_T_u08)
		{
			...
			{
				if((EscFlt_Cnt_T_logl == TRUE) || (LoaSt_Cnt_T_enum == LOAST_SWBASDMTGTN))
				{
...
/*******************************************************************************
* Name          :   LkaCheck
* Description   :   Implements LkaCheck block in model. The If subsystem it contains is executed prior
*                   to this function call and the resulting values passed to this function.               
* Inputs        :   *LkaFlt_Cnt_T_logl, *LkaInhb_Cnt_T_logl, *LkaPrmntFlt_Cnt_T_logl
* Outputs       :   
* Usage Notes   :
*****************************************************************************/
static FUNC(void, GMOVRLSTMGR_CODE) LkaCheck(P2VAR(boolean, AUTOMATIC, GmOvrlStMgr_VAR) LkaFlt_Cnt_T_logl, 
                                             ...
                                             P2VAR(boolean, AUTOMATIC, GmOvrlStMgr_VAR) LkaPrmntFlt_Cnt_T_logl)
{
    ...
    {
        /* Do nothing - keep the passed values the same */
    }
    else
    {
