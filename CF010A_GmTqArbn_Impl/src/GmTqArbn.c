...
#define ESCCMDACTV_CNT_U08						1U
#define ESCCMDTMPLIMD_CNT_U08					2U	
...
static FUNC(void, GMTQARBN_CODE) PosnServoSmotRamp(float32 PosSrvoCmd_HwNwtMtr_T_f32,
							                       ...
							                       P2VAR(float32, AUTOMATIC, GMTQARBN_APPL_VAR) APAOvrlCmd_HwNwtMtr_T_f32,
...
static FUNC(void, GMTQARBN_CODE) ESCLogic(float32 EscCmd_HwNwtMtr_T_f32,
 ...
 *********************************************************************************************************************/
	...
	VAR(float32, AUTOMATIC) HwTqOscCmd_HwNwtMtr_T_f32;
	VAR(float32, AUTOMATIC) MotTqServoCmd_HwNwtMtr_T_f32;
    VAR(boolean, AUTOMATIC) HwOscnEna_Cnt_T_logl;
	VAR(boolean, AUTOMATIC) HwAgServoEna_HwNwtMtr_T_f32;
	...
	VAR(float32, AUTOMATIC) APAOvrlCmd_HwNwtMtr_T_f32;
    ...
    (void)Rte_Read_HwTqOscCmd_Val(&HwTqOscCmd_HwNwtMtr_T_f32);
    ...
    (void)Rte_Read_HwAgServoEna_Logl(&HwAgServoEna_HwNwtMtr_T_f32);
	...
	PosnServoSmotRamp(MotTqServoCmd_HwNwtMtr_T_f32,
	                  HwAgServoEna_HwNwtMtr_T_f32,
					  HwTq_HwNwtMtr_T_f32,
					  &APAOvrlCmd_HwNwtMtr_T_f32,
				      &ScaleFactor_Uls_T_f32);
	
	if(HwOscnEna_Cnt_T_logl != FALSE)
	{
		MotTqCmdOvrl_MotNwtMtr_T_f32 = APAOvrlCmd_HwNwtMtr_T_f32 + HwTqOscCmd_HwNwtMtr_T_f32;
	}
	else
	{
		MotTqCmdOvrl_MotNwtMtr_T_f32 = APAOvrlCmd_HwNwtMtr_T_f32;
	}
	...
	if((LkaSt_Cnt_T_u08 != LKASTACTV_CNT_U08) || 
	   (HwAgServoEna_HwNwtMtr_T_f32 == TRUE))
	{
	...
	*Rte_Pim_dGmTqArbnDesLkaTqCmd() = DesLKATqCmd_HwNwtMtr_T_f32;   
	...
	/****** Ramp to Value ******/
	LKAInterTqCmd_HwNwtMtr_T_f32 = RampVal(DesLKATqCmd_HwNwtMtr_T_f32, VehSpdMaxSecur_Kph_T_f32);
	
	*Rte_Pim_dGmTqArbnLkaTqCmd() = LKAInterTqCmd_HwNwtMtr_T_f32;
	
	/****** ESC logic ******/
	ESCLogic(EscCmd_HwNwtMtr_T_f32,
	         EscSt_Cnt_T_u08,
	...
	*Rte_Pim_dGmTqArbnEscTqCmd() = ESCTqCmd_HwNwtMtr_T_f32; 
	...
	if((EscSt_Cnt_T_u08 == ESCCMDACTV_CNT_U08) || (EscSt_Cnt_T_u08 == ESCCMDTMPLIMD_CNT_U08))
	{
...
* Outputs       :   *APAOvrlCmd_HwNwtMtr_T_f32, *ScaleFactor_Uls_T_f32
* Usage Notes   :
*****************************************************************************/
static FUNC(void, GMTQARBN_CODE) PosnServoSmotRamp(float32 PosSrvoCmd_HwNwtMtr_T_f32,
	                                               boolean PosSrvoSmoothEnable_Cnt_T_logl,
												   ...
												   P2VAR(float32, AUTOMATIC, GMTQARBN_APPL_VAR) ScaleFactor_Uls_T_f32)
{
	...
	VAR(float32, AUTOMATIC) PosnServoSmotngEnaRate_UlsPerSec_T_f32;
	VAR(float32, AUTOMATIC) ScaleFactorInter_Uls_T_f32;	
	VAR(float32, AUTOMATIC) ScaleFactorSlew_UlsPerSec_T_f32;
	VAR(uint16, AUTOMATIC) ScaleFactorSlew_UlsPerSec_T_u1p15;
	...
	*Rte_Pim_dGmTqArbnPosnServoSmotngLowrLim() = LwrLim_UlsPerSec_T_f32;
	...
	if(PosSrvoSmoothEnable_Cnt_T_logl == TRUE)
	{
		...
		PosnServoSmotngEnaRate_UlsPerSec_T_f32 = 1.0F;
	}
	else
	{
		APAOvrlInterCmd_HwNwtMtr_T_f32 = *Rte_Pim_ActPosnServoCmd();
		PosnServoSmotngEnaRate_UlsPerSec_T_f32 = 0.0F;
	}
	
	*Rte_Pim_ActPosnServoCmd() = APAOvrlInterCmd_HwNwtMtr_T_f32;
	
	ScaleFactorSlew_UlsPerSec_T_f32  = Lim_f32(PosnServoSmotngEnaRate_UlsPerSec_T_f32, 
	...
	*Rte_Pim_PosnServoSmotngEnaRateLim() = ScaleFactorSlew_UlsPerSec_T_f32;
	
	ScaleFactorSlew_UlsPerSec_T_u1p15 = FloatToFixd_u16_f32(ScaleFactorSlew_UlsPerSec_T_f32,NXTRFIXDPT_FLOATTOP15_ULS_F32);
	...
	ScaleFactorInter_Uls_T_u1p15 = LnrIntrpn_u16_u16VariXu16VariY(PrmGmTqArbnApaSmotngX,
													              ...
													              ScaleFactorSlew_UlsPerSec_T_u1p15);
	
	ScaleFactorInter_Uls_T_f32 = FixdToFloat_f32_u16(ScaleFactorInter_Uls_T_u1p15,NXTRFIXDPT_P15TOFLOAT_ULS_F32);
	
	*ScaleFactor_Uls_T_f32 = ScaleFactorSlew_UlsPerSec_T_f32 * ScaleFactorInter_Uls_T_f32;
	
	*APAOvrlCmd_HwNwtMtr_T_f32 = APAOvrlInterCmd_HwNwtMtr_T_f32 * (*ScaleFactor_Uls_T_f32);
...
* Inputs        :   DesLKATqCmd_HwNwtMtr_T_f32, VehSpd_Kph_T_f32                   
* Outputs       :   LKAInterTqCmd_HwNwtMtr_T_f32
* Usage Notes   :
*****************************************************************************/
static FUNC(float32, GMTQARBN_CODE) RampVal(float32 DesLKATqCmd_HwNwtMtr_T_f32,
	                                        float32 VehSpd_Kph_T_f32)
...
* Inputs        :   EscCmd_HwNwtMtr_T_f32, EscSt_Cnt_T_u08                   
* Outputs       :   *ESCTqCmd_HwNwtMtr_T_f32, *EscLimdActv_Cnt_T_logl
* Usage Notes   :
*****************************************************************************/
static FUNC(void, GMTQARBN_CODE) ESCLogic(float32 EscCmd_HwNwtMtr_T_f32,
	                                      uint8 EscSt_Cnt_T_u08,
