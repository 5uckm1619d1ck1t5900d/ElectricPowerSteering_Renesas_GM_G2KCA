...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmTqArbn_EscSt_Val(P2VAR(uint8, AUTOMATIC, RTE_GMTQARBN_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmTqArbn_LkaSt_Val(P2VAR(uint8, AUTOMATIC, RTE_GMTQARBN_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
