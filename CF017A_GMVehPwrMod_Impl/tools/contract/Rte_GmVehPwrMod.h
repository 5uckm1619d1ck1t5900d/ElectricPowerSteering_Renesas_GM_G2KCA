...
# define Rte_InitValue_Msg0C9Miss_Logl (FALSE)
# define Rte_InitValue_Msg1F1Miss_Logl (FALSE)
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmVehPwrMod_Msg0C9Miss_Logl(P2VAR(boolean, AUTOMATIC, RTE_GMVEHPWRMOD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmVehPwrMod_Msg1F1Miss_Logl(P2VAR(boolean, AUTOMATIC, RTE_GMVEHPWRMOD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Read_Msg0C9Miss_Logl Rte_Read_GmVehPwrMod_Msg0C9Miss_Logl
# define Rte_Read_Msg1F1Miss_Logl Rte_Read_GmVehPwrMod_Msg1F1Miss_Logl
...
#   if RTE_MAGIC_NUMBER != 1460730004
...
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1460730004
