 ...
 *  Generated at:  Mon Sep 21 12:46:45 2015
 *
...
#define	BISTCOD2BITECCFAILR_CNT_U08			(1U)	/* bit 0 - BIST Code 2-Bit ECC Failure */
...
#define	DATAPROTNERR_CNT_U08				(1U)	/* bit 0 - Data Protection Violation (MDP Exception) */
#define INSTRPROTNERR_CNT_U08 				(2U)	/* bit 1 - Execution Protection Violation (MIP Exception) */
 ...
 *********************************************************************************************************************/
 ...
 /*** This function implements subfunction "Reset Source Determination" of the CM101A Exception Handling RH850 FDD ***/
	...
	else if ((RstInfo_Cnt_T_enum == MCUDIAGC_PWRONRST) || (RstInfo_Cnt_T_enum == MCUDIAGC_FLSPROGMCMPL))
	{
...
static FUNC(void, CDD_ExcpnHndlg_CODE) ProcStrtUpOrSwRst(void)
{
	...
	switch (RstInfo_Cnt_T_enum)
	{
		...
		case MCUDIAGC_BIST2BITERR:
			(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X021, BISTCOD2BITECCFAILR_CNT_U08, NTCSTS_FAILD, 0U);
		break;
		...
		case MCUDIAGC_MPU:
			(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X025, DATAPROTNERR_CNT_U08, NTCSTS_FAILD, 0U);
		break;
		
		case MCUDIAGC_PRVLGDINSTREXCPN:
			(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X025, INSTRPROTNERR_CNT_U08, NTCSTS_FAILD, 0U);
		break;
