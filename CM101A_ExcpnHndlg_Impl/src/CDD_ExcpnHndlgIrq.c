...
FUNC(void, CDD_ExcpnHndlg_CODE) SysErrIrq(void)
{
	...
	else if ((Segflag_Cnt_T_u16 & SEGTCMFMASK_CNT_U16) != 0U)
	{
		...
		if (ECCCPU1DEDF0 == 1U)  
		{
			TmpData_Cnt_T_u32 = (uint32)(ECCCPU1LR1STEADR0_PE1 << 4) | LCLRAMBASADR_CNT_U32;
		}
		else if (ECCCPU1DEDF1 == 1U)
		{
			TmpData_Cnt_T_u32 = (uint32)(ECCCPU1LR1STEADR1_PE1 << 4) | LCLRAMBASADR_CNT_U32 | 0x00000004UL;
		}
		else if (ECCCPU1DEDF2 == 1U)
		{
			TmpData_Cnt_T_u32 = (uint32)(ECCCPU1LR1STEADR2_PE1 << 4) | LCLRAMBASADR_CNT_U32 | 0x00000008UL;
		}
		else /* assume bank 3 (ECCCPU1DEDF3 == 1) */
		{
			TmpData_Cnt_T_u32 = (uint32)(ECCCPU1LR1STEADR3_PE1 << 4) | LCLRAMBASADR_CNT_U32 | 0x0000000CUL;
		}
	...
	/* Both bits have code flash ECC */
	{
		...
		{
			TmpSrc_Cnt_T_enum = MCUDIAGC_VCIE; /* Other VCIE setting */
		}
	}
