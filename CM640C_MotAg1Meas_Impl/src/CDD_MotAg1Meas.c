 ...
 *  Generated at:  Wed Jan 25 10:07:36 2017
 *
...
* 12/20/16  2        SR        Updated according to FDD v1.4.0                                                 EA4#8990
* 01/25/17  3        AJM       Updated to design version 1.5.0                                                 EA4#9381
* **********************************************************************************************************************/
/**********************************************************************************************************************
...
#define  MOTAG1ERRTHD_MOTREV_U0P16			((u0p16)3604U)
...
#define  CNTPERREV_MOTREV_S15P16            ((sint32)65536U)
...
#define  dPimMotAg1RawReg   ( *(Ary1D_u32_10 *) (Rte_Pim_dMotAg1MeasMotAg1RawReg()) )
...
static FUNC(uint8, CDD_MotAg1Meas_CODE) CalcNtcPrm(uint32 MotAg1StatReg_Cnt_T_u32, boolean MotAg1SyncErr_Cnt_T_lgc);
static FUNC(sint32, CDD_MotAg1Meas_CODE) GetMechMtrPos(uint16 MotAg1SpiMecl_MotRev_T_u0p16);
 ...
 *********************************************************************************************************************/
	...
	/* Configure CSIH3CFG0 register */
	CSIH3CFG0   =  0x00000000U
	...
	/* Configure CSIH3CFG1 register in bit field level */
	CSIH3RCB1	=  1u;	/* Recessive configuration = recessive */	
						/* Other bits are not written to at init - parameters derived from CFG0 */
						
	/* Configure CSIH3BRS0 register in bit field level */
	CSIH3BRS	=  10u;	/* k = 10. (alpha = 2, Clock = 80 MHz/(2^alpha*k*2) = 10MHz) */	
	...
	/* Write the TxBuffer */
	CSIH3TX0W	= 15663120U;		/*TxBuffer00 :WriteCmd7   */
	CSIH3TX0W	= 15663332U;		/*TxBuffer01 :WriteACTSTAT*/
	CSIH3TX0W	= 15673392U;		/*TxBuffer02 :WriteCmd8   */
	CSIH3TX0W	= 15679490U;		/*TxBuffer03 :WriteMOD_1  */
	CSIH3TX0W	= 15683712U;		/*TxBuffer04 :WriteCmd9   */
	CSIH3TX0W	= 15665152U;		/*TxBuffer05 :WriteMOD_2  */
	CSIH3TX0W	= 15683810U;		/*TxBuffer06 :WriteCmd10  */
	CSIH3TX0W	= 15663104U;		/*TxBuffer07 :WriteMOD_4  */
	CSIH3TX0W	= 15696896U;		/*TxBuffer08 :WrtieCmd11  */
	CSIH3TX0W	= 15728639U;		/*TxBuffer09 :ReadSTAT    */
	CSIH3TX0W	= 16646144U;		/*TxBuffer10 :CSQDeselect */
	CSIH3TX0W	= 15696928U;		/*TxBuffer11 :WriteCmd12  */
	CSIH3TX0W	= 15728639U;		/*TxBuffer12 :ReadAVAL    */
	CSIH3TX0W	= 16646144U;		/*TxBuffer13 :CSQDeselect */
	CSIH3TX0W	= 15696960U;		/*TxBuffer14 :WriteCmd13  */
	CSIH3TX0W	= 15728639U;		/*TxBuffer15 :ReadAREV    */
	CSIH3TX0W	= 16646144U;		/*TxBuffer16 :CSQDeselect */
	CSIH3TX0W	= 15717888U;		/*TxBuffer17 :WriteCmd14  */
	CSIH3TX0W	= 15728639U;		/*TxBuffer18 :ReadIIFCNT  */
	CSIH3TX0W	= 16646144U;		/*TxBuffer19 :CSQDeselect */
	...
	/************************************************************************************************************/
	/* Send Tx data */
	CSIH3MCTL2 = STRTPTRINITVAL_CNT_U32;
 ...
 *********************************************************************************************************************/
	...
	VAR(sint8,    AUTOMATIC)  MotAgMecl1Polarity_Cnt_T_s08;
	VAR(uint32,   AUTOMATIC)  MotAg1RawRegBuf_Cnt_u32[READBUFIDX_CNT_U08];
	VAR(boolean,  AUTOMATIC)  MotAg1SpiTrsmEna_Cnt_T_lgc;
	VAR(u0p16,    AUTOMATIC)  MotAg4Mecl_MotRev_T_u0p16;
	VAR(uint16,   AUTOMATIC)  MotAg1SpiCntr_Cnt_T_u0p16;
	VAR(u0p16,    AUTOMATIC)  MotAg1RawSpiMecl_Cnt_T_u0p16;
	VAR(u0p16,    AUTOMATIC)  MotAg1SpiMecl_MotRev_T_u0p16;
	VAR(sint32,   AUTOMATIC)  MotAg1Offs_Cnt_T_s32;
	VAR(sint32,   AUTOMATIC)  MotAg1RtnOffs_Cnt_T_s32 ;
	VAR(uint32,   AUTOMATIC)  MotAg1StatReg_Cnt_T_u32;
	VAR(uint8,    AUTOMATIC)  NtcStInfo_Cnt_T_u08 = 0U;
	VAR(boolean,  AUTOMATIC)  MotAg1SyncErr_Cnt_T_lgc;
	VAR(uint32,   AUTOMATIC)  MotAg1Dif1_MotRev_T_u32;
	VAR(uint32,   AUTOMATIC)  MotAg1Dif2_MotRev_T_u32;
	VAR(uint32,   AUTOMATIC)  MotAg1TurnCntrRegVal_Cnt_T_u32;
	VAR(sint16,   AUTOMATIC)  MotAg1TurnCntrRegVal_Cnt_T_s16;
	VAR(sint32,   AUTOMATIC)  MotAg1TurnCntrOffs_Cnt_T_s32;
	VAR(sint32,   AUTOMATIC)  MotAg1TurnCntr_Cnt_T_s32;
    VAR(sint32,   AUTOMATIC)  MechMtrPosOut_MotRev_T_s32;
	VAR(u0p16,    AUTOMATIC)  MotAg1DiagcAg_MotRev_T_u0p16;
	
	/* Read Module inputs */
	(void) Rte_Read_MotAgMecl1Polarity_Val(&MotAgMecl1Polarity_Cnt_T_s08);
	
	/* Inter Runnable variable read */
	MotAg1DiagcAg_MotRev_T_u0p16 = Rte_IrvRead_MotAg1MeasPer2_MotAg1DiagcAg();
	MotAg1SpiTrsmEna_Cnt_T_lgc = Rte_IrvRead_MotAg1MeasPer2_MotAg1SpiTrsmEna();
	MotAg4Mecl_MotRev_T_u0p16 = Rte_IrvRead_MotAg1MeasPer2_MotAg4Mecl();
	if(MotAg1SpiTrsmEna_Cnt_T_lgc == TRUE)
	{
		/*** ----------------------------- START: Process MotAg1RawErr -------------------------------- ***/
		CSIH3MRWP0 = READBUFADR_CNT_U32;
		
		for(SpiReadCntr_Cnt_T_u08=0U;SpiReadCntr_Cnt_T_u08<READBUFIDX_CNT_U08;SpiReadCntr_Cnt_T_u08++)
		{
			MotAg1RawRegBuf_Cnt_u32[SpiReadCntr_Cnt_T_u08] = CSIH3RX0W;
			dPimMotAg1RawReg[SpiReadCntr_Cnt_T_u08] = MotAg1RawRegBuf_Cnt_u32[SpiReadCntr_Cnt_T_u08];
		}

		/* SPI IIF Motor Angle Calculation*/
		MotAg1SpiCntr_Cnt_T_u0p16 = (u0p16)(MotAg1RawRegBuf_Cnt_u32[SPIAGCNTREGIDX_CNT_U08] & SNSRCNTMASK_CNT_U32);
		MotAg1SpiCntr_Cnt_T_u0p16 <<= 2U;
		*Rte_Pim_dMotAg1MeasMotAg1SpiCntrAg() = MotAg1SpiCntr_Cnt_T_u0p16;
		
		/* SPI  Motor Angle Calculation */
		*Rte_Pim_dMotAg1MeasMotAg1RawAgReg() = MotAg1RawRegBuf_Cnt_u32[SPIAGREGIDX_CNT_U08];
		MotAg1RawSpiMecl_Cnt_T_u0p16 = (u0p16)(MotAg1RawRegBuf_Cnt_u32[SPIAGREGIDX_CNT_U08] & SNSRAGMASK_CNT_U32);
		MotAg1RawSpiMecl_Cnt_T_u0p16<<= 1U;
		
		if(MotAgMecl1Polarity_Cnt_T_s08 < 0)
		{
			MotAg1SpiMecl_MotRev_T_u0p16 = MAX16BIT_CNT_U32 - MotAg1RawSpiMecl_Cnt_T_u0p16;
		}
		else
		{
			MotAg1SpiMecl_MotRev_T_u0p16 = MotAg1RawSpiMecl_Cnt_T_u0p16;
		}
		
		*Rte_Pim_dMotAg1MeasMotAg1SpiMecl() = MotAg1SpiMecl_MotRev_T_u0p16;
		
		/* Offset Compensation */
		if(*Rte_Pim_MotAg1InitOffs() == 0U)
		{
			MotAg1Offs_Cnt_T_s32 = ((sint32)MotAg4Mecl_MotRev_T_u0p16 - (sint32)MotAg1SpiMecl_MotRev_T_u0p16);
			*Rte_Pim_MotAg1InitOffs() += 1U;
			*Rte_Pim_MotAg1PrevOffs() = MotAg1Offs_Cnt_T_s32;
		}
		else
		{
			MotAg1RtnOffs_Cnt_T_s32 = ((sint32)MotAg4Mecl_MotRev_T_u0p16 - (sint32)MotAg1SpiMecl_MotRev_T_u0p16);
			MotAg1Offs_Cnt_T_s32 = *Rte_Pim_MotAg1PrevOffs();
			*Rte_Pim_dMotAg1MeasMotAg1RtOffs() = MotAg1RtnOffs_Cnt_T_s32;
		}

		/*** ----------------------------- START  : MotAgSyncErr -------------------------------- ***/
         MechMtrPosOut_MotRev_T_s32 = GetMechMtrPos(MotAg1SpiMecl_MotRev_T_u0p16);
		 MotAg1Dif1_MotRev_T_u32 = Abslt_u32_s32((sint32)MotAg1DiagcAg_MotRev_T_u0p16 - MechMtrPosOut_MotRev_T_s32);
		 if((sint32)MotAg1Dif1_MotRev_T_u32 > MOTAGOFFS_CNT_S32)
		 {
		  MotAg1Dif2_MotRev_T_u32 = Abslt_u32_s32((sint32)MotAg1Dif1_MotRev_T_u32 - MOTAGLIMMASK_CNT_S32);
		 }
		 else
		 {
		  MotAg1Dif2_MotRev_T_u32 = MotAg1Dif1_MotRev_T_u32;
		 }
		 
		 *Rte_Pim_dMotAg1MeasMotAg1Delta() = (u0p16)MotAg1Dif2_MotRev_T_u32;
		 
		 if((u0p16)MotAg1Dif2_MotRev_T_u32 > MOTAG1ERRTHD_MOTREV_U0P16)
		 {
		  MotAg1SyncErr_Cnt_T_lgc = TRUE;
		 }
		 else
		 {
		  MotAg1SyncErr_Cnt_T_lgc = FALSE; 
		 }
		/*** ----------------------------- END  : MotAgSyncErr -------------------------------- ***/
		
		/*** ----------------------------- START  : Turns Counter -------------------------------- ***/
		MotAg1TurnCntrRegVal_Cnt_T_u32 = (MotAg1RawRegBuf_Cnt_u32[SPITURNCNTRREGIDX_CNT_U08] & TURNCNTRREGMASK_CNT_U32);
		MotAg1TurnCntrRegVal_Cnt_T_s16 = (sint16)MotAg1TurnCntrRegVal_Cnt_T_u32;
		*Rte_Pim_dMotAg1MeasMotAg1RawTurnCntrReg() = MotAg1RawRegBuf_Cnt_u32[SPITURNCNTRREGIDX_CNT_U08];
		
		if(MotAg1TurnCntrRegVal_Cnt_T_s16 >= TURNCNTRHALFOFFS_CNT_S16)
		{
			MotAg1TurnCntrOffs_Cnt_T_s32 = (sint32)(((sint32)MotAg1TurnCntrRegVal_Cnt_T_s16 - (sint32)TURNCNTROFFS_CNT_S16) * MOTAGLIMMASK_CNT_S32);
		}
		else
		{
			MotAg1TurnCntrOffs_Cnt_T_s32 = (MotAg1TurnCntrRegVal_Cnt_T_s16) * MOTAGLIMMASK_CNT_S32;
		}
		MotAg1TurnCntr_Cnt_T_s32 = (((sint32)MotAg1SpiMecl_MotRev_T_u0p16 + MotAg1TurnCntrOffs_Cnt_T_s32) * MotAgMecl1Polarity_Cnt_T_s08);
		*Rte_Pim_dMotAg1MeasMotAg1TurnCntr() = FixdToFloat_f32_s32(MotAg1TurnCntr_Cnt_T_s32,NXTRFIXDPT_P32TOFLOAT_ULS_F32 );
		
		/*** ----------------------------- STOP  : Turns Counter -------------------------------- ***/
		
		/*** ------------------------ START: MotAg1 Protocol Fault Operation -------------------------- ***/
		
		*Rte_Pim_dMotAg1MeasMotAg1RawErrReg() = MotAg1RawRegBuf_Cnt_u32[SPISTATREGIDX_CNT_U08];
		MotAg1StatReg_Cnt_T_u32 = MotAg1RawRegBuf_Cnt_u32[SPISTATREGIDX_CNT_U08];
		
		if(((MotAg1StatReg_Cnt_T_u32 & MOTAGFLTMASK_CNT_U32)!= 0U) || (MotAg1SyncErr_Cnt_T_lgc == TRUE))
		{
			NtcStInfo_Cnt_T_u08 = CalcNtcPrm(MotAg1StatReg_Cnt_T_u32,MotAg1SyncErr_Cnt_T_lgc );
		}
		else
		{
			*Rte_Pim_MotAg1PrevRollgCntr() += 1U;
		}
		...
		(void) Rte_Write_MotAg1Offs_Val(MotAg1Offs_Cnt_T_s32);
		(void) Rte_Write_MotAg1MeclQlfr_Val( MotAg1MeclQlfr_Cnt_T_enum );  
		(void) Rte_Write_MotAg1MeclRollgCntr_Val(*Rte_Pim_MotAg1PrevRollgCntr());
 ...
 *********************************************************************************************************************/
	...
	if((CSIH3STR0 & MOTAGSPITRSMMASK_CNT_U32) == 0U)
	{
		*Rte_Pim_MotAg1PrevSpiErrFltCntr() += 1U;
		(void)Rte_Call_IoHwAb_SetFctGpioMotAg1_Oper();
		(void)Rte_Call_IoHwAb_SetGpioMotAg1CsihCs_Oper(0U);
		...
		(void)Rte_Call_IoHwAb_SetGpioMotAg1CsihCs_Oper(1U);
		(void)Rte_Call_GetMotAg4Mecl_Oper(&MotAgMecl_MotRev_T_u0p16);
		(void)Rte_Call_IoHwAb_SetFctPrphlCsihMotAg1_Oper();
		/* Send Tx data */
		CSIH3MCTL2 = STRTPTRPERVAL_CNT_U32;
		
		Rte_IrvWrite_MotAg1MeasPer3_MotAg1DiagcAg(*Rte_Pim_MotAg1Diagc());
		Rte_IrvWrite_MotAg1MeasPer3_MotAg4Mecl(MotAgMecl_MotRev_T_u0p16);
		Rte_IrvWrite_MotAg1MeasPer3_MotAg1SpiTrsmEna(1U);
	}
	else
	{
		Rte_IrvWrite_MotAg1MeasPer3_MotAg1SpiTrsmEna(0U);
	}
...
* Inputs:      MotAg1StatReg_Cnt_T_u32,MotAg1SyncErr_Cnt_T_lgc
...
static FUNC(uint8, CDD_MotAg1Meas_CODE) CalcNtcPrm(uint32 MotAg1StatReg_Cnt_T_u32, boolean MotAg1SyncErr_Cnt_T_lgc)
{
	...
	if((MotAg1StatReg_Cnt_T_u32 & NOMOTAGFLTMASK_CNT_U32) !=0U )
	{
		NtcStInfo_Cnt_T_u08 = (uint8)(0x01u << 0u);
	}
	if((MotAg1StatReg_Cnt_T_u32 & VLDMOTAGFLTMASK_CNT_U32) !=0U )
	{
		NtcStInfo_Cnt_T_u08 |= (uint8)(0x01u << 1u);
	}
	if((MotAg1StatReg_Cnt_T_u32 & MOTAGMGNLIMFLTMASK_CNT_U32) !=0U )
	{
		NtcStInfo_Cnt_T_u08 |= (uint8)(0x01u << 2u);
	}
	if((MotAg1StatReg_Cnt_T_u32 & MOTAGCPTLIMFLTMASK_CNT_U32) !=0U )
	{
		NtcStInfo_Cnt_T_u08 |= (uint8)(0x01u << 3u);
	}
	if((MotAg1StatReg_Cnt_T_u32 & MOTAGOVFFLTMASK_CNT_U32) !=0U )
	{
		NtcStInfo_Cnt_T_u08 |= (uint8)(0x01u << 4u);
	}
	if((MotAg1StatReg_Cnt_T_u32 & MOTAGVLTGFLTMASK_CNT_U32) !=0U )
	{
		NtcStInfo_Cnt_T_u08 |= (uint8)(0x01u << 5u);
	}
	if( MotAg1SyncErr_Cnt_T_lgc == TRUE )
	{
...
/**********************************************************************************************************************
* Name:        GetMechMtrPos
* Description: Calculate Mechanical Motor Position after offset
* Inputs:      MotAg1SpiMecl_MotRev_T_u0p16
* Outputs:     MechMtrPosOut_MotRev_T_s32
* Usage Notes: None
**********************************************************************************************************************/
static FUNC(sint32, CDD_MotAg1Meas_CODE) GetMechMtrPos(uint16 MotAg1SpiMecl_MotRev_T_u0p16)
{
    ...
    MechMtrPosOut_MotRev_T_s32 = (sint32)MotAg1SpiMecl_MotRev_T_u0p16 - (sint32)Rte_Prm_MotAg1MeasMotAgOffs_Val();
    if(MechMtrPosOut_MotRev_T_s32 < 0)
    {
        MechMtrPosOut_MotRev_T_s32 = MechMtrPosOut_MotRev_T_s32 + CNTPERREV_MOTREV_S15P16;
    }

    return MechMtrPosOut_MotRev_T_s32;
}
