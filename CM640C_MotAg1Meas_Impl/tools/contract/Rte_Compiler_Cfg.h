...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:CDD_MotAg0Meas_CONST)  ***************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:CDD_MotAg0Meas_CODE)  ****************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CDD_MOTAG0MEAS_APPL)  ************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:CDD_MotAg0Meas_VAR)  *****************/
...
#    error "The magic number of the generated file <C:/Component/CM640C_MotAg1Meas_Impl/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
