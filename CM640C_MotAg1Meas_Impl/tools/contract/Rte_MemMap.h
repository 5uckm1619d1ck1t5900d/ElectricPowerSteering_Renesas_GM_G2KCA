...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_CDD_MOTAG0MEAS_APPL_CODE)  ****/
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_CDD_MOTAG0MEAS_APPL_CODE)  ***/
...
#   error "The magic number of the generated file <C:/Component/CM640C_MotAg1Meas_Impl/tools/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
