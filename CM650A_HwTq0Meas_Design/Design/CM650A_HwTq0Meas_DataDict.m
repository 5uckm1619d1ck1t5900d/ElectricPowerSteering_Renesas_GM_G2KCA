...
%%-------------------------------------------
HwTq0Phy = DataDict.IpSignal;
HwTq0Phy.LongName = 'Hand Wheel Torque 0 Physical';
HwTq0Phy.DocUnits = 'Volt';
HwTq0Phy.EngDT = dt.Phy;
HwTq0Phy.EngInit = 0;
HwTq0Phy.EngMin = 0;
HwTq0Phy.EngMax = 5;
HwTq0Phy.ReadIn = {''};
HwTq0Phy.ReadType = 'Phy';
...
RegInpRSENT0CS = DataDict.IpSignal;
RegInpRSENT0CS.LongName = 'Register Input RSENT0 Comm Stat';
RegInpRSENT0CS.DocUnits = 'Cnt';
RegInpRSENT0CS.EngDT = dt.u32;
RegInpRSENT0CS.EngInit = 0;
RegInpRSENT0CS.EngMin = 0;
RegInpRSENT0CS.EngMax = 4294967295;
RegInpRSENT0CS.ReadIn = {'HwTq0MeasPer1'};
RegInpRSENT0CS.ReadType = 'Phy';


RegInpRSENT0FND = DataDict.IpSignal;
RegInpRSENT0FND.LongName = 'Register Input RSENT0 FND';
RegInpRSENT0FND.DocUnits = 'Cnt';
RegInpRSENT0FND.EngDT = dt.u08;
RegInpRSENT0FND.EngInit = 0;
RegInpRSENT0FND.EngMin = 0;
RegInpRSENT0FND.EngMax = 1;
RegInpRSENT0FND.ReadIn = {'HwTq0MeasPer1'};
RegInpRSENT0FND.ReadType = 'Phy';


RegInpRSENT0FRS = DataDict.IpSignal;
RegInpRSENT0FRS.LongName = 'Register Input RSENT0 FSM';
RegInpRSENT0FRS.DocUnits = 'Cnt';
RegInpRSENT0FRS.EngDT = dt.u08;
RegInpRSENT0FRS.EngInit = 0;
RegInpRSENT0FRS.EngMin = 0;
RegInpRSENT0FRS.EngMax = 1;
RegInpRSENT0FRS.ReadIn = {'HwTq0MeasPer1'};
RegInpRSENT0FRS.ReadType = 'Phy';


RegInpRSENT0FRXD = DataDict.IpSignal;
RegInpRSENT0FRXD.LongName = 'Register Input RSENT0 Fast Receive Data';
RegInpRSENT0FRXD.DocUnits = 'Cnt';
RegInpRSENT0FRXD.EngDT = dt.u32;
RegInpRSENT0FRXD.EngInit = 0;
RegInpRSENT0FRXD.EngMin = 0;
RegInpRSENT0FRXD.EngMax = 4294967295;
RegInpRSENT0FRXD.ReadIn = {'HwTq0MeasPer1'};
RegInpRSENT0FRXD.ReadType = 'Phy';


RegInpRSENT0NRS = DataDict.IpSignal;
RegInpRSENT0NRS.LongName = 'Register Input RSENT0 NRS';
RegInpRSENT0NRS.DocUnits = 'Cnt';
RegInpRSENT0NRS.EngDT = dt.u08;
RegInpRSENT0NRS.EngInit = 0;
RegInpRSENT0NRS.EngMin = 0;
RegInpRSENT0NRS.EngMax = 1;
RegInpRSENT0NRS.ReadIn = {'HwTq0MeasTrigStrt'};
RegInpRSENT0NRS.ReadType = 'Phy';


RegInpRSENT0SRXD = DataDict.IpSignal;
RegInpRSENT0SRXD.LongName = 'Register Input RSENT0 Slow Receive Data';
RegInpRSENT0SRXD.DocUnits = 'Cnt';
RegInpRSENT0SRXD.EngDT = dt.u32;
RegInpRSENT0SRXD.EngInit = 0;
RegInpRSENT0SRXD.EngMin = 0;
RegInpRSENT0SRXD.EngMax = 4294967295;
RegInpRSENT0SRXD.ReadIn = {'HwTq0MeasPer1'};
RegInpRSENT0SRXD.ReadType = 'Phy';
...
RegOutRSENT0NRC = DataDict.OpSignal;
RegOutRSENT0NRC.LongName = 'Register Input RSENT0 NRC Trigger';
RegOutRSENT0NRC.Description = 'NRC Trigger';
RegOutRSENT0NRC.DocUnits = 'Cnt';
RegOutRSENT0NRC.SwcShoName = 'HwTq0Meas';
RegOutRSENT0NRC.EngDT = dt.u08;
RegOutRSENT0NRC.EngInit = 0;
RegOutRSENT0NRC.EngMin = 0;
RegOutRSENT0NRC.EngMax = 1;
RegOutRSENT0NRC.TestTolerance = 0;
RegOutRSENT0NRC.WrittenIn = {'HwTq0MeasTrigStrt'};
RegOutRSENT0NRC.WriteType = 'Phy';


RegOutRSENT0SPCT = DataDict.OpSignal;
RegOutRSENT0SPCT.LongName = 'Register Input RSENT0 SPC Trigger';
RegOutRSENT0SPCT.Description = 'SPC Trigger';
RegOutRSENT0SPCT.DocUnits = 'Cnt';
RegOutRSENT0SPCT.SwcShoName = 'HwTq0Meas';
RegOutRSENT0SPCT.EngDT = dt.u32;
RegOutRSENT0SPCT.EngInit = 0;
RegOutRSENT0SPCT.EngMin = 0;
RegOutRSENT0SPCT.EngMax = 4294967295;
RegOutRSENT0SPCT.TestTolerance = 0;
RegOutRSENT0SPCT.WrittenIn = {'HwTq0MeasTrigStrt'};
RegOutRSENT0SPCT.WriteType = 'Phy';
