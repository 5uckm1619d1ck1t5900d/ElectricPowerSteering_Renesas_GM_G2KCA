...
%%-------------------------------------------
HwTq1Phy = DataDict.IpSignal;
HwTq1Phy.LongName = 'Hand Wheel Torque 1 Physical';
HwTq1Phy.DocUnits = 'Volt';
HwTq1Phy.EngDT = dt.Phy;
HwTq1Phy.EngInit = 0;
HwTq1Phy.EngMin = 0;
HwTq1Phy.EngMax = 5;
HwTq1Phy.ReadIn = {''};
HwTq1Phy.ReadType = 'Phy';
...
RegInpRSENT1CS = DataDict.IpSignal;
RegInpRSENT1CS.LongName = 'Register Input RSENT1 Comm Stat';
RegInpRSENT1CS.DocUnits = 'Cnt';
RegInpRSENT1CS.EngDT = dt.u32;
RegInpRSENT1CS.EngInit = 0;
RegInpRSENT1CS.EngMin = 0;
RegInpRSENT1CS.EngMax = 4294967295;
RegInpRSENT1CS.ReadIn = {'HwTq1MeasPer1'};
RegInpRSENT1CS.ReadType = 'Phy';


RegInpRSENT1FND = DataDict.IpSignal;
RegInpRSENT1FND.LongName = 'Register Input RSENT1 FND';
RegInpRSENT1FND.DocUnits = 'Cnt';
RegInpRSENT1FND.EngDT = dt.u08;
RegInpRSENT1FND.EngInit = 0;
RegInpRSENT1FND.EngMin = 0;
RegInpRSENT1FND.EngMax = 1;
RegInpRSENT1FND.ReadIn = {'HwTq1MeasPer1'};
RegInpRSENT1FND.ReadType = 'Phy';


RegInpRSENT1FRS = DataDict.IpSignal;
RegInpRSENT1FRS.LongName = 'Register Input RSENT1 FSM';
RegInpRSENT1FRS.DocUnits = 'Cnt';
RegInpRSENT1FRS.EngDT = dt.u08;
RegInpRSENT1FRS.EngInit = 0;
RegInpRSENT1FRS.EngMin = 0;
RegInpRSENT1FRS.EngMax = 1;
RegInpRSENT1FRS.ReadIn = {'HwTq1MeasPer1'};
RegInpRSENT1FRS.ReadType = 'Phy';


RegInpRSENT1FRXD = DataDict.IpSignal;
RegInpRSENT1FRXD.LongName = 'Register Input RSENT1 Fast Receive Data';
RegInpRSENT1FRXD.DocUnits = 'Cnt';
RegInpRSENT1FRXD.EngDT = dt.u32;
RegInpRSENT1FRXD.EngInit = 0;
RegInpRSENT1FRXD.EngMin = 0;
RegInpRSENT1FRXD.EngMax = 4294967295;
RegInpRSENT1FRXD.ReadIn = {'HwTq1MeasPer1'};
RegInpRSENT1FRXD.ReadType = 'Phy';


RegInpRSENT1NRS = DataDict.IpSignal;
RegInpRSENT1NRS.LongName = 'Register Input RSENT1 NRS';
RegInpRSENT1NRS.DocUnits = 'Cnt';
RegInpRSENT1NRS.EngDT = dt.u08;
RegInpRSENT1NRS.EngInit = 0;
RegInpRSENT1NRS.EngMin = 0;
RegInpRSENT1NRS.EngMax = 1;
RegInpRSENT1NRS.ReadIn = {'HwTq1MeasTrigStrt'};
RegInpRSENT1NRS.ReadType = 'Phy';


RegInpRSENT1SRXD = DataDict.IpSignal;
RegInpRSENT1SRXD.LongName = 'Register Input RSENT1 Slow Receive Data';
RegInpRSENT1SRXD.DocUnits = 'Cnt';
RegInpRSENT1SRXD.EngDT = dt.u32;
RegInpRSENT1SRXD.EngInit = 0;
RegInpRSENT1SRXD.EngMin = 0;
RegInpRSENT1SRXD.EngMax = 4294967295;
RegInpRSENT1SRXD.ReadIn = {'HwTq1MeasPer1'};
RegInpRSENT1SRXD.ReadType = 'Phy';
...
RegOutRSENT1NRC = DataDict.OpSignal;
RegOutRSENT1NRC.LongName = 'Register Input RSENT1 NRC Trigger';
RegOutRSENT1NRC.Description = 'NRC Trigger';
RegOutRSENT1NRC.DocUnits = 'Cnt';
RegOutRSENT1NRC.SwcShoName = 'HwTq1Meas';
RegOutRSENT1NRC.EngDT = dt.u08;
RegOutRSENT1NRC.EngInit = 0;
RegOutRSENT1NRC.EngMin = 0;
RegOutRSENT1NRC.EngMax = 1;
RegOutRSENT1NRC.TestTolerance = 0;
RegOutRSENT1NRC.WrittenIn = {'HwTq1MeasTrigStrt'};
RegOutRSENT1NRC.WriteType = 'Phy';


RegOutRSENT1SPCT = DataDict.OpSignal;
RegOutRSENT1SPCT.LongName = 'Register Input RSENT1 SPC Trigger';
RegOutRSENT1SPCT.Description = 'SPC Trigger';
RegOutRSENT1SPCT.DocUnits = 'Cnt';
RegOutRSENT1SPCT.SwcShoName = 'HwTq1Meas';
RegOutRSENT1SPCT.EngDT = dt.u32;
RegOutRSENT1SPCT.EngInit = 0;
RegOutRSENT1SPCT.EngMin = 0;
RegOutRSENT1SPCT.EngMax = 4294967295;
RegOutRSENT1SPCT.TestTolerance = 0;
RegOutRSENT1SPCT.WrittenIn = {'HwTq1MeasTrigStrt'};
RegOutRSENT1SPCT.WriteType = 'Phy';
