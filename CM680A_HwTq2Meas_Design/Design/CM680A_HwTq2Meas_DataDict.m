...
%%-------------------------------------------
HwTq2Phy = DataDict.IpSignal;
HwTq2Phy.LongName = 'Hand Wheel Torque 2 Physical';
HwTq2Phy.DocUnits = 'Volt';
HwTq2Phy.EngDT = dt.Phy;
HwTq2Phy.EngInit = 0;
HwTq2Phy.EngMin = 0;
HwTq2Phy.EngMax = 5;
HwTq2Phy.ReadIn = {''};
HwTq2Phy.ReadType = 'Phy';
...
RegInpRSENT3CS = DataDict.IpSignal;
RegInpRSENT3CS.LongName = 'Register Input RSENT3 Comm Stat';
RegInpRSENT3CS.DocUnits = 'Cnt';
RegInpRSENT3CS.EngDT = dt.u32;
RegInpRSENT3CS.EngInit = 0;
RegInpRSENT3CS.EngMin = 0;
RegInpRSENT3CS.EngMax = 4294967295;
RegInpRSENT3CS.ReadIn = {'HwTq2MeasPer1'};
RegInpRSENT3CS.ReadType = 'Phy';


RegInpRSENT3FND = DataDict.IpSignal;
RegInpRSENT3FND.LongName = 'Register Input RSENT3 FND';
RegInpRSENT3FND.DocUnits = 'Cnt';
RegInpRSENT3FND.EngDT = dt.u08;
RegInpRSENT3FND.EngInit = 0;
RegInpRSENT3FND.EngMin = 0;
RegInpRSENT3FND.EngMax = 1;
RegInpRSENT3FND.ReadIn = {'HwTq2MeasPer1'};
RegInpRSENT3FND.ReadType = 'Phy';


RegInpRSENT3FRS = DataDict.IpSignal;
RegInpRSENT3FRS.LongName = 'Register Input RSENT3 FSM';
RegInpRSENT3FRS.DocUnits = 'Cnt';
RegInpRSENT3FRS.EngDT = dt.u08;
RegInpRSENT3FRS.EngInit = 0;
RegInpRSENT3FRS.EngMin = 0;
RegInpRSENT3FRS.EngMax = 1;
RegInpRSENT3FRS.ReadIn = {'HwTq2MeasPer1'};
RegInpRSENT3FRS.ReadType = 'Phy';


RegInpRSENT3FRXD = DataDict.IpSignal;
RegInpRSENT3FRXD.LongName = 'Register Input RSENT3 Fast Receive Data';
RegInpRSENT3FRXD.DocUnits = 'Cnt';
RegInpRSENT3FRXD.EngDT = dt.u32;
RegInpRSENT3FRXD.EngInit = 0;
RegInpRSENT3FRXD.EngMin = 0;
RegInpRSENT3FRXD.EngMax = 4294967295;
RegInpRSENT3FRXD.ReadIn = {'HwTq2MeasPer1'};
RegInpRSENT3FRXD.ReadType = 'Phy';


RegInpRSENT3NRS = DataDict.IpSignal;
RegInpRSENT3NRS.LongName = 'Register Input RSENT3 NRS';
RegInpRSENT3NRS.DocUnits = 'Cnt';
RegInpRSENT3NRS.EngDT = dt.u08;
RegInpRSENT3NRS.EngInit = 0;
RegInpRSENT3NRS.EngMin = 0;
RegInpRSENT3NRS.EngMax = 1;
RegInpRSENT3NRS.ReadIn = {'HwTq2MeasTrigStrt'};
RegInpRSENT3NRS.ReadType = 'Phy';


RegInpRSENT3SRXD = DataDict.IpSignal;
RegInpRSENT3SRXD.LongName = 'Register Input RSENT3 Slow Receive Data';
RegInpRSENT3SRXD.DocUnits = 'Cnt';
RegInpRSENT3SRXD.EngDT = dt.u32;
RegInpRSENT3SRXD.EngInit = 0;
RegInpRSENT3SRXD.EngMin = 0;
RegInpRSENT3SRXD.EngMax = 4294967295;
RegInpRSENT3SRXD.ReadIn = {'HwTq2MeasPer1'};
RegInpRSENT3SRXD.ReadType = 'Phy';
...
RegOutRSENT3CSC = DataDict.OpSignal;
RegOutRSENT3CSC.LongName = 'Register Input RSENT3 CSC';
RegOutRSENT3CSC.Description = 'CSC Register';
RegOutRSENT3CSC.DocUnits = 'Cnt';
RegOutRSENT3CSC.SwcShoName = 'HwTq2Meas';
RegOutRSENT3CSC.EngDT = dt.u32;
RegOutRSENT3CSC.EngInit = 0;
RegOutRSENT3CSC.EngMin = 0;
RegOutRSENT3CSC.EngMax = 4294967295;
RegOutRSENT3CSC.TestTolerance = 0;
RegOutRSENT3CSC.WrittenIn = {'HwTq2MeasTrigStrt', 'HwTq2MeasPer1'};
RegOutRSENT3CSC.WriteType = 'Phy';


RegOutRSENT3NRC = DataDict.OpSignal;
RegOutRSENT3NRC.LongName = 'Register Input RSENT3 NRC Trigger';
RegOutRSENT3NRC.Description = 'NRC Trigger';
RegOutRSENT3NRC.DocUnits = 'Cnt';
RegOutRSENT3NRC.SwcShoName = 'HwTq2Meas';
RegOutRSENT3NRC.EngDT = dt.u08;
RegOutRSENT3NRC.EngInit = 0;
RegOutRSENT3NRC.EngMin = 0;
RegOutRSENT3NRC.EngMax = 1;
RegOutRSENT3NRC.TestTolerance = 0;
RegOutRSENT3NRC.WrittenIn = {'HwTq2MeasTrigStrt'};
RegOutRSENT3NRC.WriteType = 'Phy';


RegOutRSENT3SPCT = DataDict.OpSignal;
RegOutRSENT3SPCT.LongName = 'Register Input RSENT3 SPC Trigger';
RegOutRSENT3SPCT.Description = 'SPC Trigger';
RegOutRSENT3SPCT.DocUnits = 'Cnt';
RegOutRSENT3SPCT.SwcShoName = 'HwTq2Meas';
RegOutRSENT3SPCT.EngDT = dt.u32;
RegOutRSENT3SPCT.EngInit = 0;
RegOutRSENT3SPCT.EngMin = 0;
RegOutRSENT3SPCT.EngMax = 4294967295;
RegOutRSENT3SPCT.TestTolerance = 0;
RegOutRSENT3SPCT.WrittenIn = {'HwTq2MeasTrigStrt'};
RegOutRSENT3SPCT.WriteType = 'Phy';
