...
%%-------------------------------------------
HwTq3Phy = DataDict.IpSignal;
HwTq3Phy.LongName = 'Hand Wheel Torque 3 Physical';
HwTq3Phy.DocUnits = 'Volt';
HwTq3Phy.EngDT = dt.Phy;
HwTq3Phy.EngInit = 0;
HwTq3Phy.EngMin = 0;
HwTq3Phy.EngMax = 5;
HwTq3Phy.ReadIn = {''};
HwTq3Phy.ReadType = 'Phy';
...
RegInpRSENT5CS = DataDict.IpSignal;
RegInpRSENT5CS.LongName = 'Register Input RSENT5 Comm Stat';
RegInpRSENT5CS.DocUnits = 'Cnt';
RegInpRSENT5CS.EngDT = dt.u32;
RegInpRSENT5CS.EngInit = 0;
RegInpRSENT5CS.EngMin = 0;
RegInpRSENT5CS.EngMax = 4294967295;
RegInpRSENT5CS.ReadIn = {'HwTq3MeasPer1'};
RegInpRSENT5CS.ReadType = 'Phy';


RegInpRSENT5FND = DataDict.IpSignal;
RegInpRSENT5FND.LongName = 'Register Input RSENT5 FND';
RegInpRSENT5FND.DocUnits = 'Cnt';
RegInpRSENT5FND.EngDT = dt.u08;
RegInpRSENT5FND.EngInit = 0;
RegInpRSENT5FND.EngMin = 0;
RegInpRSENT5FND.EngMax = 1;
RegInpRSENT5FND.ReadIn = {'HwTq3MeasPer1'};
RegInpRSENT5FND.ReadType = 'Phy';


RegInpRSENT5FRS = DataDict.IpSignal;
RegInpRSENT5FRS.LongName = 'Register Input RSENT5 FSM';
RegInpRSENT5FRS.DocUnits = 'Cnt';
RegInpRSENT5FRS.EngDT = dt.u08;
RegInpRSENT5FRS.EngInit = 0;
RegInpRSENT5FRS.EngMin = 0;
RegInpRSENT5FRS.EngMax = 1;
RegInpRSENT5FRS.ReadIn = {'HwTq3MeasPer1'};
RegInpRSENT5FRS.ReadType = 'Phy';


RegInpRSENT5FRXD = DataDict.IpSignal;
RegInpRSENT5FRXD.LongName = 'Register Input RSENT5 Fast Receive Data';
RegInpRSENT5FRXD.DocUnits = 'Cnt';
RegInpRSENT5FRXD.EngDT = dt.u32;
RegInpRSENT5FRXD.EngInit = 0;
RegInpRSENT5FRXD.EngMin = 0;
RegInpRSENT5FRXD.EngMax = 4294967295;
RegInpRSENT5FRXD.ReadIn = {'HwTq3MeasPer1'};
RegInpRSENT5FRXD.ReadType = 'Phy';


RegInpRSENT5NRS = DataDict.IpSignal;
RegInpRSENT5NRS.LongName = 'Register Input RSENT5 NRS';
RegInpRSENT5NRS.DocUnits = 'Cnt';
RegInpRSENT5NRS.EngDT = dt.u08;
RegInpRSENT5NRS.EngInit = 0;
RegInpRSENT5NRS.EngMin = 0;
RegInpRSENT5NRS.EngMax = 1;
RegInpRSENT5NRS.ReadIn = {'HwTq3MeasTrigStrt'};
RegInpRSENT5NRS.ReadType = 'Phy';


RegInpRSENT5SRXD = DataDict.IpSignal;
RegInpRSENT5SRXD.LongName = 'Register Input RSENT5 Slow Receive Data';
RegInpRSENT5SRXD.DocUnits = 'Cnt';
RegInpRSENT5SRXD.EngDT = dt.u32;
RegInpRSENT5SRXD.EngInit = 0;
RegInpRSENT5SRXD.EngMin = 0;
RegInpRSENT5SRXD.EngMax = 4294967295;
RegInpRSENT5SRXD.ReadIn = {'HwTq3MeasPer1'};
RegInpRSENT5SRXD.ReadType = 'Phy';
...
RegOutRSENT5CSC = DataDict.OpSignal;
RegOutRSENT5CSC.LongName = 'Register Input RSENT5 CSC';
RegOutRSENT5CSC.Description = 'CSC Register';
RegOutRSENT5CSC.DocUnits = 'Cnt';
RegOutRSENT5CSC.SwcShoName = 'HwTq3Meas';
RegOutRSENT5CSC.EngDT = dt.u32;
RegOutRSENT5CSC.EngInit = 0;
RegOutRSENT5CSC.EngMin = 0;
RegOutRSENT5CSC.EngMax = 4294967295;
RegOutRSENT5CSC.TestTolerance = 0;
RegOutRSENT5CSC.WrittenIn = {'HwTq3MeasTrigStrt','HwTq3MeasPer1'};
RegOutRSENT5CSC.WriteType = 'Phy';


RegOutRSENT5NRC = DataDict.OpSignal;
RegOutRSENT5NRC.LongName = 'Register Input RSENT5 NRC Trigger';
RegOutRSENT5NRC.Description = 'NRC Trigger';
RegOutRSENT5NRC.DocUnits = 'Cnt';
RegOutRSENT5NRC.SwcShoName = 'HwTq3Meas';
RegOutRSENT5NRC.EngDT = dt.u08;
RegOutRSENT5NRC.EngInit = 0;
RegOutRSENT5NRC.EngMin = 0;
RegOutRSENT5NRC.EngMax = 1;
RegOutRSENT5NRC.TestTolerance = 0;
RegOutRSENT5NRC.WrittenIn = {'HwTq3MeasTrigStrt'};
RegOutRSENT5NRC.WriteType = 'Phy';


RegOutRSENT5SPCT = DataDict.OpSignal;
RegOutRSENT5SPCT.LongName = 'Register Input RSENT5 SPC Trigger';
RegOutRSENT5SPCT.Description = 'SPC Trigger';
RegOutRSENT5SPCT.DocUnits = 'Cnt';
RegOutRSENT5SPCT.SwcShoName = 'HwTq3Meas';
RegOutRSENT5SPCT.EngDT = dt.u32;
RegOutRSENT5SPCT.EngInit = 0;
RegOutRSENT5SPCT.EngMin = 0;
RegOutRSENT5SPCT.EngMax = 4294967295;
RegOutRSENT5SPCT.TestTolerance = 0;
RegOutRSENT5SPCT.WrittenIn = {'HwTq3MeasTrigStrt'};
RegOutRSENT5SPCT.WriteType = 'Phy';
