 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_Sci30CfgAndUse_Type.h
...
#ifndef _RTE_CDD_SCI30CFGANDUSE_TYPE_H
# define _RTE_CDD_SCI30CFGANDUSE_TYPE_H
...
#    error "The magic number of the generated file <C:/Component/CM745A_Sci30CfgAndUse_Impl/tools/contract/Rte_CDD_Sci30CfgAndUse_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_CDD_SCI30CFGANDUSE_TYPE_H */
