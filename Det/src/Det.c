...
DET_LOCAL volatile VAR(uint8, DET_VAR) detLock2;                                     /* used to resolve ESCAN00029923 */
# endif

# if defined (DET_DEBUG_ENABLED)
#  if (DET_LOGBUFFERSIZE > 0)
DET_LOCAL volatile VAR(uint8, DET_VAR) detLock1;                                     /* used to resolve ESCAN00029923 */
#  endif
# endif
 ...
 *  \reentrant  TRUE
 *  \synchronous TRUE
 *  \trace      CREQ-11, DSGN-Det22783, DSGN-Det22785
 **********************************************************************************************************************/
 ...
 *  \reentrant  TRUE
 *  \synchronous TRUE
 *  \trace      CREQ-8, DSGN-Det22792, DSGN-Det22784
 **********************************************************************************************************************/
#  if (DET_LOGBUFFERSIZE > 0)
...
/* SBSW_JUSTIFICATION_BEGIN
   ...
   \ID SBSW_DET_8    
     ...
     \COUNTERMEASURE \S The DET should not be in production code. 
      ...
      All of the above listed array write accesses occur only if extended debug features are enabled.
   \ID SBSW_DET_9    
