%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 13-Jun-2016 14:32:59       %
...
TmplMonrPer1.Description = 'Normal processing, also turns on Temporal Monitor Pin';
...
IoHwAb_SetGpioSysFlt2A.CallLocation = {'TmplMonrInit1'};
IoHwAb_SetGpioSysFlt2A.Description = 'SetGpioSysFlt2A GPIO Read';
...
IoHwAb_SetGpioSysFlt2A.Return.Description = 'SetGpioSysFlt2A GPIO Read';
...
IoHwAb_SetGpioSysFlt2B.CallLocation = {'TmplMonrInit1'};
IoHwAb_SetGpioSysFlt2B.Description = 'SetGpioSysFlt2B GPIO Read';
...
IoHwAb_SetGpioSysFlt2B.Return.Description = 'SetGpioSysFlt2B GPIO Read';
...
IoHwAb_SetGpioTmplMonrWdg.Return.Description = 'Read Wdg Monitor Function Arguments';
...
%%-------------------------------------------
NErr = DataDict.IpSignal;
NErr.LongName = 'NError';
NErr.Description = 'Not Error Pin';
NErr.DocUnits = 'Cnt';
NErr.EngDT = dt.Phy;
NErr.EngInit = 0;
NErr.EngMin = 0;
NErr.EngMax = 1;
NErr.ReadIn = {'TmplMonrPer1'};
NErr.ReadType = 'Phy';


PwrOutpEnaFb = DataDict.IpSignal;
PwrOutpEnaFb.LongName = 'PowerOutputEnableFdbk';
PwrOutpEnaFb.Description = 'PowerOutputEnableFdbk';
PwrOutpEnaFb.DocUnits = 'Cnt';
PwrOutpEnaFb.EngDT = dt.Phy;
PwrOutpEnaFb.EngInit = 0;
PwrOutpEnaFb.EngMin = 0;
PwrOutpEnaFb.EngMax = 1;
PwrOutpEnaFb.ReadIn = {'TmplMonrPer1'};
PwrOutpEnaFb.ReadType = 'Phy';
...
%%-------------------------------------------
PwrOutpEna = DataDict.OpSignal;
PwrOutpEna.LongName = 'Power Output Enable';
PwrOutpEna.Description = 'Power Output Enable Physicl Output';
PwrOutpEna.DocUnits = 'Cnt';
PwrOutpEna.SwcShoName = 'TmplMonr';
PwrOutpEna.EngDT = dt.Phy;
PwrOutpEna.EngInit = 0;
PwrOutpEna.EngMin = 0;
PwrOutpEna.EngMax = 1;
PwrOutpEna.TestTolerance = 0;
PwrOutpEna.WrittenIn = {};
PwrOutpEna.WriteType = 'Phy';
...
IninFlt.NtcStInfo.Bit0Descr = 'Fault Occured Between TmplMonrInitCntr =  9 ~ 10';
IninFlt.NtcStInfo.Bit1Descr = 'Fault Occured Between TmplMonrInitCntr = 12';
IninFlt.NtcStInfo.Bit2Descr = 'Fault Occured Between TmplMonrInitCntr = 14 ~ 15';
IninFlt.NtcStInfo.Bit3Descr = 'Fault Occured at TmplMonrInitCntr = 17  (POE Fault)';
IninFlt.NtcStInfo.Bit4Descr = 'Fault Occured at TmplMonrInitCntr = 18 (WD_STATE Fault)';
IninFlt.NtcStInfo.Bit5Descr = 'Fault Occured at TmplMonrInitCntr = 20 (Edge/Valid Write Fault)';
IninFlt.NtcStInfo.Bit6Descr = 'Fault Occured at TmplMonrInitCntr = 52 (POE + Non-WD Fault)';
IninFlt.NtcStInfo.Bit7Descr = 'Fault Occured at TmplMonrInitCntr = 52 (POE + WD Fault) ';
