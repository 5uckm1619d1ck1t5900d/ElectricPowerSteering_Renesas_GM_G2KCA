 ...
 *          File:  TmplMonr.c
 *     SW-C Type:  TmplMonr
 *  Generated at:  Mon Sep 28 15:28:27 2015
 *
...
static FUNC(void, TmplMonr_CODE) TMFInitTestCase9To10Case14To16( void ); 
static FUNC(void, TmplMonr_CODE) TMFInitTestCase12( void ); 
static FUNC(void, TmplMonr_CODE) TMFInitTestCase17( void ); 
static FUNC(void, TmplMonr_CODE) TMFInitTestCase18( void ); 
static FUNC(void, TmplMonr_CODE) TMFInitTestCase52( void ); 
 ...
 *********************************************************************************************************************/
	...
	/* Set the GPIO SysFlt2A pin to Low */
	(void) Rte_Call_IoHwAb_SetGpioSysFlt2A_Oper( STD_LOW ); /* REQ: ES005A #102 I */
	
	/* Set the GPIO SysFlt2B pin to Low */
	(void) Rte_Call_IoHwAb_SetGpioSysFlt2B_Oper( STD_LOW ); /* REQ: ES005A #103 I */
...
static FUNC(void, TmplMonr_CODE) TMFInitTest( void )
{
	...
	{
		/* REQ: ES005A #107 I */
		case 0U: case 1U: case 2U: case 3U: case 4U: case 5U: case 6U: case 7U: case 8U: 
			/* Set GPIO TmplMonrWdg pin to High */
		...
		case 9U: case 10U: case 14U: case 15U: case 16U:
			TMFInitTestCase9To10Case14To16();
		break;
		...
		case 21U: case 22U: case 23U: case 24U: case 25U: case 26U: case 27U: case 28U: case 29U: case 30U: 
...
/**********************************************************************************************************************
* Name:        TMFInitTestCase9To10Case14To16
* Description: Temporal Monitor Initialization Test Case 9~10, 14, 16
* Inputs:      None
* Outputs:     None
* Usage Notes: None
**********************************************************************************************************************/
static FUNC(void, TmplMonr_CODE) TMFInitTestCase9To10Case14To16( void )
{
	...
	if( *Rte_Pim_TmplMonrIninCntr() < 16U )
	{
		...
		{	/* Fault Condition - WD Signal */
			...
			if( *Rte_Pim_TmplMonrIninCntr() > 13U )
			{
...
/**********************************************************************************************************************
* Name:        TMFInitTestCase12
* Description: Temporal Monitor Initialization Test Case 12
* Inputs:      None
* Outputs:     None
* Usage Notes: None
**********************************************************************************************************************/
...
/**********************************************************************************************************************
* Name:        TMFInitTestCase17
* Description: Temporal Monitor Initialization Test Case 17
* Inputs:      None
* Outputs:     None
* Usage Notes: None
**********************************************************************************************************************/
...
/**********************************************************************************************************************
* Name:        TMFInitTestCase52
* Description: Temporal Monitor Initialization Test Case 52
* Inputs:      None
* Outputs:     None
* Usage Notes: None
**********************************************************************************************************************/
