%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 29-Sep-2016 12:17:03       %
...
NVMSAMPLECNTRPOSN_CNT_U08.EngVal = 3;
NVMSAMPLECNTRPOSN_CNT_U08.Define = 'Local';


RAMAVRGPOSN_CNT_U08 = DataDict.Constant;
RAMAVRGPOSN_CNT_U08.LongName = 'Ram Average position';
RAMAVRGPOSN_CNT_U08.Description = [...
  'Position of state health signal average value in a local ram buffer. E' ...
  'ach state health signal has buffer size of 4 and average value of sign' ...
  'al resides in 3rd postion'];
RAMAVRGPOSN_CNT_U08.DocUnits = 'Cnt';
RAMAVRGPOSN_CNT_U08.EngDT = dt.u08;
RAMAVRGPOSN_CNT_U08.EngVal = 3;
RAMAVRGPOSN_CNT_U08.Define = 'Local';
