 ...
 *********************************************************************************************************************/
    ...
    VAR(uint8, AUTOMATIC) RamAvrgVal_Uls_T_u08;   
    VAR(uint8, AUTOMATIC) SampleCntSize_Uls_T_u08;   
    VAR(uint8, AUTOMATIC) TmpDif_Uls_T_u08;      
    ...
    {  
        ...
        if(SampleCnt_Uls_T_u32 != 0U)/* REQ: ES106A #45 I */
        {
            ...
            RamAvrgVal_Uls_T_u08 = PimStHlthSigStcRamBuf_u8[StrtAdr_Uls_T_u08 + RAMAVRGPOSN_CNT_U08];
            ...
            if(*Rte_Pim_VldNvm() == TRUE)
            {
                ...
                NvmAvrgVal_Uls_T_u08 = NvmPim_Ptr_T_u08[NvmOffs_Uls_T_u08 + NVMAVRGPOSN_CNT_U08]; 
                ...
                if(RamAvrgVal_Uls_T_u08 >= NvmAvrgVal_Uls_T_u08)
                {
                    TmpDif_Uls_T_u08 =   RamAvrgVal_Uls_T_u08 - NvmAvrgVal_Uls_T_u08;
                    NvmAvrgVal_Uls_T_u08 += (uint8)(((uint32)TmpDif_Uls_T_u08)/NvmSampleCnt_Uls_T_u32);
                }
                else
                {
                    TmpDif_Uls_T_u08 =   NvmAvrgVal_Uls_T_u08 - RamAvrgVal_Uls_T_u08;
                    NvmAvrgVal_Uls_T_u08 -= (uint8)(((uint32)TmpDif_Uls_T_u08)/NvmSampleCnt_Uls_T_u32);
                }
            }
            else
            {
                ...
                NvmAvrgVal_Uls_T_u08 = RamAvrgVal_Uls_T_u08;
                NvmSampleCnt_Uls_T_u32 = SampleCnt_Uls_T_u32;
            }
            /* REQ: ES106A #15 I */
            /* REQ: ES106A #18 I */
            ...
            UpdNvm_str.NvmAvrgVal   = NvmAvrgVal_Uls_T_u08;
 ...
 static FUNC(void, StHlthSigStc_CODE) StHlthSigStc_ClrDataSample(boolean TarSel_Uls_T_logl)
{
    ...
    while(SigCnt_Uls_T_u16 !=0U)
    {
        ...
        PimStHlthSigStcRamBuf_u8[StrtAdr_Uls_T_u08 + RAMMINPOSN_CNT_U08]  = STHLTHMAXVAL_CNT_U08;
        PimStHlthSigStcRamBuf_u8[StrtAdr_Uls_T_u08 + RAMAVRGPOSN_CNT_U08] = 0U;
    }
...
static FUNC(void, StHlthSigStc_CODE) StHlthSigStc_GetSigStHlthData(StHlthMonSig3 SigId_Uls_T_enum, uint8* TarAdr)
{
    ...
    if((IgnCycSampleCnt_Uls_T_u32 != 0U) && (*Rte_Pim_VldNvm() == TRUE))
    {
        ...
        NvmAvrgVal_Uls_T_u08 = NvmBlkPim_Ptr_T_u08[NvmOffs_Uls_T_u08 + NVMAVRGPOSN_CNT_U08]; 
                                                            ...
                                                            uint32 NvmSampleCnt_Uls_T_u32)
{
    ...
    NvmPim_Ptr_T_u08[NVMAVRGPOSN_CNT_U08] = NvmAvrgVal_Uls_T_u08; 
    SampleCntSize_Uls_T_u08 = WORDSIZE_CNT_U08;
    SampleCnt_Ptr_T_u08 = (uint8*)(&NvmSampleCnt_Uls_T_u32);
...
static FUNC(void, StHlthSigStc_CODE) StHlthSigStc_UpdDataSample(uint8 TaskRef_Uls_T_u08)
{
    ...
    VAR(uint8, AUTOMATIC) AvrgVal_Uls_T_u08;    
    VAR(uint8, AUTOMATIC) TmpDif_Uls_T_u08;       
    ...
    for(SigCnt_Uls_T_u16 = 0U; SigCnt_Uls_T_u16 < SIGCNT_ULS_U08; SigCnt_Uls_T_u16++)
    {
        ...
        if(StHlthSigStcCfgRecInst.SigPrm[SigCnt_Uls_T_u16].TaskRef == TaskRef_Uls_T_u08) 
        {
            ...
            AvrgVal_Uls_T_u08 = PimStHlthSigStcRamBuf_u8[StrtAdr_Uls_T_u08 +RAMAVRGPOSN_CNT_U08];
            ...
            /* NewAvrg = OldAvrg + ((NewVal - OldAvrg)/(SampleCnt_Uls_T_u32 + 1)) */
            if (RawVal_Uls_T_u08 >= AvrgVal_Uls_T_u08)
            {
                TmpDif_Uls_T_u08 = RawVal_Uls_T_u08 - AvrgVal_Uls_T_u08;
                AvrgVal_Uls_T_u08 += (uint8)(((uint32)TmpDif_Uls_T_u08)/(PimStHlthSigStcIgnCycSampleCntrAry_u32[SigCnt_Uls_T_u16]));                        
            }
            else
            {
                TmpDif_Uls_T_u08 = AvrgVal_Uls_T_u08 - RawVal_Uls_T_u08;
                AvrgVal_Uls_T_u08 -= (uint8)(((uint32)TmpDif_Uls_T_u08)/(PimStHlthSigStcIgnCycSampleCntrAry_u32[SigCnt_Uls_T_u16]));
            }   
            ...
            PimStHlthSigStcRamBuf_u8[StrtAdr_Uls_T_u08 + RAMAVRGPOSN_CNT_U08] = AvrgVal_Uls_T_u08;            
        }
        /* ENDREQ: ES106A #15 I */
        /* ENDREQ: ES106A #18 I */
        /* ENDREQ: ES106A #21 I */
...
FUNC(void, StHlthSigStc_CODE) NONTRUSTED_NtWrapS_StHlthSigStc_UpdNvmPim(NonTrustedFunctionIndexType FunctionIndex, NonTrustedFunctionParameterRefType FunctionParams)
{
    ...
    VAR(uint8, AUTOMATIC) NvmAvrgVal_Cnt_T_u08;  
    ...
    NvmAvrgVal_Cnt_T_u08   = ((NtUpdNvmPimRec*)FunctionParams)->NvmAvrgVal;
    NvmSampleCnt_Cnt_T_u32 = ((NtUpdNvmPimRec*)FunctionParams)->NvmSampleCnt;
    
    StHlthSigStc_UpdNvmPim(NvmBasPtr, NvmMaxVal_Cnt_T_u08,NvmMinVal_Cnt_T_u08,NvmAvrgVal_Cnt_T_u08,NvmSampleCnt_Cnt_T_u32);
}
 /******************************************************************************
