...
{
  /* PIM Handles section */
  P2VAR(boolean, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_MotAgCmpFirstRunCmpl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Pim_MotAgCmpFirstRunCmpl() (Rte_Inst_CDD_MotAgCmp->Pim_MotAgCmpFirstRunCmpl) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#   if RTE_MAGIC_NUMBER != 1446848062
...
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1446848062
