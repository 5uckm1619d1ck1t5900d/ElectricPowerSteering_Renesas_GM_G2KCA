...
Fee_FILES               = Fee\Fee.c Fee\Fee_Partition.c Fee\Fee_Sector.c Fee\Fee_ChunkInfo.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Fee\Fee.c Fee\Fee_Partition.c Fee\Fee_Sector.c Fee\Fee_ChunkInfo.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
