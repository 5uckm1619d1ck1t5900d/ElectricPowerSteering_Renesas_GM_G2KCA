 ...
 *          File:  CustDiagc.c
 *     SW-C Type:  CustDiagc
 *  Generated at:  Fri Oct  7 10:49:42 2016
 *
 ...
 * DataArray_Type_5: Array with 5 element(s) of type UInt8
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
	...
	if (Dem_DcmGetDTCByOccurrenceTime(DEM_MOST_RECENT_FAILED_DTC, &FaildDtc_Cnt_T_u32) == DEM_OCCURR_OK)
	{
		...
		EveId_Cnt_T_u08 = 0U;
		for (Index_Cnt_T_u16 = 1U; Index_Cnt_T_u16 <= Dem_Cfg_GlobalDtcCount(); Index_Cnt_T_u16 += 1U)
		{
...
#else
FUNC(Std_ReturnType, CustDiagc_CODE) CSDataServices_TiIgnOn_ReadData(P2VAR(DataArray_Type_5, AUTOMATIC, RTE_CUSTDIAGC_APPL_VAR) Data) /* PRQA S 0850 */ /* MD_MSR_19.8 */
#endif
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 ...
 *********************************************************************************************************************/
	...
	Data[0U] = 0x00U; /* We only support 32-bits, upper byte is always zero */
	Data[1U] = DescGetHiHiByte(SysTi_mS_T_u32);
	Data[2U] = DescGetHiLoByte(SysTi_mS_T_u32);
	Data[3U] = DescGetLoHiByte(SysTi_mS_T_u32);
	Data[4U] = DescGetLoLoByte(SysTi_mS_T_u32);
 ...
 *   Std_ReturnType Rte_Call_GetRefTmr100MicroSec32bit_Oper(uint32 *RefTmr_Arg)
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_GetSigStcHlthData_Oper(StHlthMonSig2 SigId_Arg, uint32 *BufPtr_Arg)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_GetSigStcHlthData_PortIf2_E_NOT_OK
	...
	*Rte_Pim_PrevGmFctDiArbnSts() = GmFctDiArbnSts_Cnt_T_enum;
	...
	if (*Rte_Pim_Srv12LoopCntr() != 0xFFU)
	{
		...
		else
		{
			...
			Len_Cnt_T_u16 = 400U;
			RetCod_Cnt_T_enum = Dem_DcmGetFreezeFrameDataByDTC(*Rte_Pim_DtcNr(), DEM_DTC_ORIGIN_PRIMARY_MEMORY, 1U, &((DescMsgContext*)*Rte_Pim_MsgCntxt())->resData[5U], &Len_Cnt_T_u16);
			CallNonTrustedFunction(NtWrapS_CustDiagc_EnaDtcRecUpd, NULL_PTR);
			((DescMsgContext*)*Rte_Pim_MsgCntxt())->resDataLen += Len_Cnt_T_u16;

			/* If the freeze frame is invalid return negative response. */
