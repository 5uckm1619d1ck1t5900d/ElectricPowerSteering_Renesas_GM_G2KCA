...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_CustDiagc_GetSigStcHlthData_Oper(StHlthMonSig2 SigId_Arg, P2VAR(uint32, AUTOMATIC, RTE_CUSTDIAGC_APPL_VAR) BufPtr_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define RTE_E_GetSigStcHlthData_PortIf2_E_NOT_OK (1U)
...
#   if RTE_MAGIC_NUMBER != 1475849950
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Sandbox/GM_003A_CustDiagc_Impl/tools/contract/Rte_CustDiagc.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1475849950
