...
#define NROFNVMBLKS_CNT_U08        115U /* Number of NvM Blocks */
#define NROFCRCNVMBLKS_CNT_U08     67U /* Number of NvM Blocks using a CRC */
#define NROFCRCPROXYBLKS_CNT_U08   63U /* Number of NvM CRC checks configured for NvM Proxy Init */
