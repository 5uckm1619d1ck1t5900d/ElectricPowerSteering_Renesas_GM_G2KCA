...
* Generation Time   : 02.02.2017 14:31:31
***********************************************************************************************************************
* Version Control:
* %version:          3 %
* %derived_by:       CZ8L9T %
...
CONST(NonSysCritRegRec1, AUTOMATIC) PerCritReg8BitChk_rec[NROFPERCRITREG8BIT_CNT_U16]=
{
		  ...
		  { 0xffdf0008U, 0xf0U, 0xffU}, /* SCI30SCR */
...
CONST(NonSysCritRegRec1, AUTOMATIC) PerCritReg32BitChk_rec[NROFPERCRITREG32BIT_CNT_U16]=
{
		  ...
		  { 0xfffeeaf0U, 0x10000U, 0x10300U}, /* IMR0 */
		  ...
		  { 0xffcd0030U, 0x7ffffffbU, 0xffffffffU}, /* OPBT0 */
