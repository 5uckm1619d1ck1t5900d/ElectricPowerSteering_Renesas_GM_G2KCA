...
#  define Rte_Read_AssiSumLim_MotTqCmdLimDi_Logl(data) (*(data) = Rte_AssiSumLim_MotTqCmdLimDi_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_AssiSumLim_PinionCentrLrnCmd_Val(data) (*(data) = Rte_AssiSumLim_PinionCentrLrnCmd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_PinionCentrLrnEna_Logl Rte_Read_AssiSumLim_PinionCentrLrnEna_Logl
#  define Rte_Read_AssiSumLim_PinionCentrLrnEna_Logl(data) (*(data) = Rte_AssiSumLim_PinionCentrLrnEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_AssiSumLim_TqSteerMtgtnCmd_Val(data) (*(data) = Rte_AssiSumLim_TqSteerMtgtnCmd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
