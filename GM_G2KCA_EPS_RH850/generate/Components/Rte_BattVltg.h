...
#  define Rte_Read_BattVltg_BattVltg_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltg_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd1_Val Rte_Read_BattVltg_BattVltgSwd1_Val
#  define Rte_Read_BattVltg_BattVltgSwd1_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgSwd1_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd2_Val Rte_Read_BattVltg_BattVltgSwd2_Val
#  define Rte_Read_BattVltg_BattVltgSwd2_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgSwd2_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
