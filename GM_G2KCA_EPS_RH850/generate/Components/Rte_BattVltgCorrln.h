...
#  define Rte_Read_BattVltgCorrln_BattVltg_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltg_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgAdcFaild_Logl Rte_Read_BattVltgCorrln_BattVltgAdcFaild_Logl
#  define Rte_Read_BattVltgCorrln_BattVltgAdcFaild_Logl(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgAdcFaild_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd1_Val Rte_Read_BattVltgCorrln_BattVltgSwd1_Val
#  define Rte_Read_BattVltgCorrln_BattVltgSwd1_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgSwd1_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd1AdcFaild_Logl Rte_Read_BattVltgCorrln_BattVltgSwd1AdcFaild_Logl
#  define Rte_Read_BattVltgCorrln_BattVltgSwd1AdcFaild_Logl(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgSwd1AdcFaild_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd2_Val Rte_Read_BattVltgCorrln_BattVltgSwd2_Val
#  define Rte_Read_BattVltgCorrln_BattVltgSwd2_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgSwd2_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd2AdcFaild_Logl Rte_Read_BattVltgCorrln_BattVltgSwd2AdcFaild_Logl
#  define Rte_Read_BattVltgCorrln_BattVltgSwd2AdcFaild_Logl(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltgSwd2AdcFaild_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_BattVltgCorrln_InhbBattVltgDiagc_Logl(data) (*(data) = Rte_BattVltgCorrln_InhbBattVltgDiagc_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
