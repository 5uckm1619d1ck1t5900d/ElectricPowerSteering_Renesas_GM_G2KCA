...
#  define Rte_Read_CDD_CurrMeas_MotCurrAdcVlyD_Val(data) (*(data) = Rte_CDD_MotCtrlMgr_MotCurrAdcVlyA_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotCurrAdcVlyE_Val Rte_Read_CDD_CurrMeas_MotCurrAdcVlyE_Val
#  define Rte_Read_CDD_CurrMeas_MotCurrAdcVlyE_Val(data) (*(data) = Rte_CDD_MotCtrlMgr_MotCurrAdcVlyB_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotCurrAdcVlyF_Val Rte_Read_CDD_CurrMeas_MotCurrAdcVlyF_Val
#  define Rte_Read_CDD_CurrMeas_MotCurrAdcVlyF_Val(data) (*(data) = Rte_CDD_MotCtrlMgr_MotCurrAdcVlyC_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_CurrMeasEolGainCalSet_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)95, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_CurrMeasEolOffsCalSet_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)96, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
