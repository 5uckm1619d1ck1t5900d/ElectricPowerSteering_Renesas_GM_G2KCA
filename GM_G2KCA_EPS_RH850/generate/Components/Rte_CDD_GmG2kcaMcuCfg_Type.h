 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_GmG2kcaMcuCfg_Type.h
 *        Config:  EPS.dpa
 *   ECU-Project:  EPS
 *
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_GmG2kcaMcuCfg>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_GMG2KCAMCUCFG_TYPE_H
# define _RTE_CDD_GMG2KCAMCUCFG_TYPE_H
...
#endif /* _RTE_CDD_GMG2KCAMCUCFG_TYPE_H */
