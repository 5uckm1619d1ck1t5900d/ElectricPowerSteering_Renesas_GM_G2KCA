...
#  define Rte_Call_MotAgCmpMotAgBackEmf_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)113, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Pim_MotAgCmpFirstRunCmpl() \
  (&Rte_CDD_MotAgCmp_MotAgCmpFirstRunCmpl) /* PRQA S 3453 */ /* MD_MSR_19.7 */
