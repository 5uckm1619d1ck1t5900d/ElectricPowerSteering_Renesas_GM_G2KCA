...
#  define Rte_Write_CDD_MotVel_HwVel_Val(data) (Rte_CDD_MotVel_HwVel_Val = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Pim_MotAgBufIdx() \
  (&Rte_CDD_MotVel_MotAgBufIdx) /* PRQA S 3453 */ /* MD_MSR_19.7 */
