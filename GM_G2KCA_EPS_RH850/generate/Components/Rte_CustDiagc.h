...
#  define Rte_Read_CustDiagc_BattVltg_Val(data) (*(data) = Rte_CDD_GmG2kcaMcuCfg_BattVltg_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_CustDiagc_ThermLimFlgCntr_Val(data) (*(data) = Rte_CustDiagc_ThermLimFlgCntr_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_CustDiagcGmIgnCntr_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)8, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
