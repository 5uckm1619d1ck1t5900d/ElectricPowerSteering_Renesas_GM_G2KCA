...
#  define Rte_Read_DiagcMgr_RegInBRAMDAT1_Val(data) (*(data) = Rte_DiagcMgr_RegInBRAMDAT1_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_SnpshtDataAry_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)6, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Enter_DiagcMgrExclusiveArea() \
  { \
...
/* PRQA S 3458 L1 */ /* MD_MSR_19.4 */
#  define Rte_Exit_DiagcMgrExclusiveArea() \
  { \
...
#  ifdef RTE_PTR2ARRAYBASETYPE_PASSING
#   define Rte_Pim_SnpshtDataAry() (&((*RtePim_SnpshtDataAry())[0]))
#  else
#   define Rte_Pim_SnpshtDataAry() RtePim_SnpshtDataAry()
#  endif
#  define RtePim_SnpshtDataAry() \
  (&Rte_DiagcMgr_SnpshtDataAry) /* PRQA S 3453 */ /* MD_MSR_19.7 */
