...
#  define Rte_Read_DutyCycThermProtn_DualEcuFltMtgtnEna_Logl(data) (*(data) = Rte_DutyCycThermProtn_DualEcuFltMtgtnEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_DutyCycThermProtn_IgnTiOff_Val(data) (*(data) = Rte_DutyCycThermProtn_IgnTiOff_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_IvtrLoaMtgtnEna_Logl Rte_Read_DutyCycThermProtn_IvtrLoaMtgtnEna_Logl
#  define Rte_Read_DutyCycThermProtn_IvtrLoaMtgtnEna_Logl(data) (*(data) = Rte_LoaMgr_IvtrLoaMtgtnEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_DutyCycThermProtn_VehTiVld_Logl(data) (*(data) = Rte_DutyCycThermProtn_VehTiVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_FilStVal_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((NvM_BlockIdType)71, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_FilStVal_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)71, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
