...
#  define Rte_Read_GmMsg184BusHiSpd_HandsOnWhlEstim_Val(data) (*(data) = Rte_HowDetn_HowDetnEstimn_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_GmMsg184BusHiSpd_SysStFltOutpReqDi_Logl(data) (*(data) = Rte_DiagcMgr_SysStFltOutpReqDi_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_GmMsg184BusHiSpdHandsOnThd_Val() (((P2CONST(Rte_Calprm_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP])->GmMsg184BusHiSpdHandsOnThd_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
