...
#  define Rte_Read_GmMsg1E5BusChassisExp_HwAgStsToSerlCom_Logl(data) (*(data) = Rte_HwAgSysArbn_HwAgStsToSerlCom_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_GmMsg1E5BusChassisExp_HwVel_Val(data) (*(data) = Rte_CDD_MotVel_HwVel_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotAgLoaMtgtnEna_Logl Rte_Read_GmMsg1E5BusChassisExp_MotAgLoaMtgtnEna_Logl
#  define Rte_Read_GmMsg1E5BusChassisExp_MotAgLoaMtgtnEna_Logl(data) (*(data) = Rte_LoaMgr_MotAgLoaMtgtnEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
