...
#  define Rte_Read_GmMsg1F1BusHiSpd_BackUpPwrModMstVirtDevAuthyRaw_Val(data) (*(data) = Rte_SerlComInpProxy_BackUpPwrModMstVirtDevAuthyRaw_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
