...
#  define Rte_Read_GmOvrlStMgr_HwAgTrajEna_Logl(data) (*(data) = Rte_GmOvrlStMgr_HwAgTrajEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_GmLoaIgnCntr_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((NvM_BlockIdType)67, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_GmLoaIgnCntr_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)67, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
