...
#  define Rte_Read_GmVehPwrMod_Msg0C9Miss_Logl(data) (*(data) = Rte_GmMsg0C9BusHiSpd_MissMsg0C9_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_Msg1F1Miss_Logl Rte_Read_GmVehPwrMod_Msg1F1Miss_Logl
#  define Rte_Read_GmVehPwrMod_Msg1F1Miss_Logl(data) (*(data) = Rte_GmMsg1F1BusHiSpd_MissMsg1F1_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
