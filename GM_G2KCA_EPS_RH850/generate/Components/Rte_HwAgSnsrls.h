...
extern VAR(boolean, RTE_VAR_INIT) Rte_HwAgSnsrls_MotAgCumvAlgndVld_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_InitValue_MotAgCumvAlgndVld_Logl (TRUE)
...
#  define Rte_Read_HwAgSnsrls_MotAgCumvAlgndVld_Logl(data) (*(data) = Rte_HwAgSnsrls_MotAgCumvAlgndVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_NvmStordLstPrm_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)5, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
