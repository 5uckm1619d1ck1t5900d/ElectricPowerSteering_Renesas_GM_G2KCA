...
#  define Rte_Write_HwAgStsToSerlCom_Logl Rte_Write_HwAgSysArbn_HwAgStsToSerlCom_Logl
#  define Rte_Write_HwAgSysArbn_HwAgStsToSerlCom_Logl(data) (Rte_HwAgSysArbn_HwAgStsToSerlCom_Logl = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
