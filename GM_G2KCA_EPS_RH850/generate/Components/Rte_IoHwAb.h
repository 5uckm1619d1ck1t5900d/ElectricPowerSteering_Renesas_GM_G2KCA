...
#  define RTE_RUNNABLE_IoHwAb_SetFctGpioMotAg0_Oper IoHwAb_SetFctGpioMotAg0_Oper
#  define RTE_RUNNABLE_IoHwAb_SetFctGpioMotAg1_Oper IoHwAb_SetFctGpioMotAg1_Oper
...
#  define RTE_RUNNABLE_IoHwAb_SetFctPeriphMotAg0_Oper IoHwAb_SetFctPeriphMotAg0_Oper
#  define RTE_RUNNABLE_IoHwAb_SetFctPeriphMotAg1_Oper IoHwAb_SetFctPeriphMotAg1_Oper
...
#  define RTE_RUNNABLE_IoHwAb_SetGpioMotAg0_Oper IoHwAb_SetGpioMotAg0_Oper
#  define RTE_RUNNABLE_IoHwAb_SetGpioMotAg1_Oper IoHwAb_SetGpioMotAg1_Oper
...
FUNC(Std_ReturnType, IoHwAb_CODE) IoHwAb_SetFctGpioMotAg0_Oper(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, IoHwAb_CODE) IoHwAb_SetFctGpioMotAg1_Oper(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, IoHwAb_CODE) IoHwAb_SetFctPeriphMotAg0_Oper(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, IoHwAb_CODE) IoHwAb_SetFctPeriphMotAg1_Oper(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, IoHwAb_CODE) IoHwAb_SetGpioMotAg0_Oper(IOHWAB_BOOL PinSt_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, IoHwAb_CODE) IoHwAb_SetGpioMotAg1_Oper(IOHWAB_BOOL PinSt_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
