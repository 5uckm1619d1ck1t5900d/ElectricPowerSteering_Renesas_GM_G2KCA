...
#  define Rte_Read_MotAgCorrln_MotAgAMeclRollgCntr_Val(data) (*(data) = Rte_CDD_MotAg0Meas_MotAg0MeclRollgCntr_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_MotAgCorrln_MotAgBMeclRollgCntr_Val(data) (*(data) = Rte_CDD_MotAg1Meas_MotAg1MeclRollgCntr_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
