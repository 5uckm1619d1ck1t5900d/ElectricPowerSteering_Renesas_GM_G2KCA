...
#  define Rte_Read_MotCurrPeakEstimn_DualEcuMotCtrlMtgtnEna_Logl(data) (*(data) = Rte_MotCurrPeakEstimn_DualEcuMotCtrlMtgtnEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_IvtrLoaMtgtnEna_Logl Rte_Read_MotCurrPeakEstimn_IvtrLoaMtgtnEna_Logl
#  define Rte_Read_MotCurrPeakEstimn_IvtrLoaMtgtnEna_Logl(data) (*(data) = Rte_LoaMgr_IvtrLoaMtgtnEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
