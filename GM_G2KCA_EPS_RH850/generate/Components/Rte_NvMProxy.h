...
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_EraseNvBlock(NvM_BlockIdType parg0); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(void, NvMProxy_CODE) NvMProxy_GetDataIndex(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_GetErrorStatus(NvM_BlockIdType parg0, P2VAR(NvM_RequestResultType, AUTOMATIC, RTE_NVMPROXY_APPL_VAR) ErrorStatus_Arg); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_InvalidateNvBlock(NvM_BlockIdType parg0); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(void, NvMProxy_CODE) NvMProxy_MainFunction(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_ReadBlock(NvM_BlockIdType parg0, dtRef_VOID DstPtr_Arg); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_RestoreBlockDefaults(NvM_BlockIdType parg0, dtRef_VOID DstPtr_Arg); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_SetBlockProtection(NvM_BlockIdType parg0, boolean ProtectionEnabled_Arg); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(void, NvMProxy_CODE) NvM_SetDataIndex(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_SetRamBlockStatus(NvM_BlockIdType parg0, boolean RamBlockStatus_Arg); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_WriteBlock(NvM_BlockIdType parg0, dtRef_const_VOID SrcPtr_Arg); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
