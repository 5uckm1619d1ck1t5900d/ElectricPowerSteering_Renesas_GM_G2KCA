...
#  define Rte_Read_PullCmpActv_HwVel_Val(data) (*(data) = Rte_CDD_MotVel_HwVel_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_PullCmpActv_VehLatA_Val(data) (*(data) = Rte_VehSigCdng_VehLatA_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_PullCmpLongTerm_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((NvM_BlockIdType)70, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_PullCmpLongTerm_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)70, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
