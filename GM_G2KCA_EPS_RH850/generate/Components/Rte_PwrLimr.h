...
#  define Rte_Read_PwrLimr_AltFltActv_Logl(data) (*(data) = Rte_PwrLimr_AltFltActv_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_PwrLimr_DualEcuFltMtgtnSca_Val(data) (*(data) = Rte_PwrLimr_DualEcuFltMtgtnSca_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
