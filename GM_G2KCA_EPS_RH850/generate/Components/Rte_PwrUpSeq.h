...
extern VAR(boolean, RTE_VAR_INIT) Rte_PwrUpSeq_MotDrvr1IninTestCmpl_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_InitValue_MotDrvr1IninTestCmpl_Logl (TRUE)
...
#  define Rte_Read_PwrUpSeq_MotDrvr1IninTestCmpl_Logl(data) (*(data) = Rte_PwrUpSeq_MotDrvr1IninTestCmpl_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
