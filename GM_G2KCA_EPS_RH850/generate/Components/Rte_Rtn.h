...
#  define Rte_Read_Rtn_HwAgRtnOffs_Val(data) (*(data) = Rte_Rtn_HwAgRtnOffs_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_Rtn_HwVel_Val(data) (*(data) = Rte_CDD_MotVel_HwVel_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_Rtn_RtnCmdDiagcDi_Logl(data) (*(data) = Rte_Rtn_RtnCmdDiagcDi_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_Rtn_RtnCmdScaServo_Val(data) (*(data) = Rte_Rtn_RtnCmdScaServo_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
