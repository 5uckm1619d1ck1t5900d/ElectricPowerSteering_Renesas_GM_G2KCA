...
extern VAR(float32, RTE_VAR_INIT) Rte_StHlthSigNormn_MotAg2VltgSqd_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(u0p16, RTE_VAR_INIT) Rte_StHlthSigNormn_MotAgABErrTerm_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(u0p16, RTE_VAR_INIT) Rte_StHlthSigNormn_MotAgACErrTerm_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(u0p16, RTE_VAR_INIT) Rte_StHlthSigNormn_MotAgBCErrTerm_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_StHlthSigNormn_MotAg2VltgSqd_Val(data) (*(data) = Rte_StHlthSigNormn_MotAg2VltgSqd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotAgABErrTerm_Val Rte_Read_StHlthSigNormn_MotAgABErrTerm_Val
#  define Rte_Read_StHlthSigNormn_MotAgABErrTerm_Val(data) (*(data) = Rte_StHlthSigNormn_MotAgABErrTerm_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotAgACErrTerm_Val Rte_Read_StHlthSigNormn_MotAgACErrTerm_Val
#  define Rte_Read_StHlthSigNormn_MotAgACErrTerm_Val(data) (*(data) = Rte_StHlthSigNormn_MotAgACErrTerm_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotAgBCErrTerm_Val Rte_Read_StHlthSigNormn_MotAgBCErrTerm_Val
#  define Rte_Read_StHlthSigNormn_MotAgBCErrTerm_Val(data) (*(data) = Rte_StHlthSigNormn_MotAgBCErrTerm_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
