...
#  define Rte_Call_SigStcHistDataAry_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((NvM_BlockIdType)64, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_SigStcHistDataAry_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)64, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Enter_StHlthSigStc_ExclusiveArea() \
  { \
...
/* PRQA S 3458 L1 */ /* MD_MSR_19.4 */
#  define Rte_Exit_StHlthSigStc_ExclusiveArea() \
  { \
