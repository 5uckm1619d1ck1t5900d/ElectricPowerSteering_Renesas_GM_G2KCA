...
#  define Rte_InitValue_FricLrngCustEna_Logl (FALSE)
...
#  define Rte_Read_SysFricLrng_FricLrngCustEna_Logl(data) (*(data) = Rte_SysFricLrng_FricLrngCustEna_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_SysFricLrng_HwVel_Val(data) (*(data) = Rte_CDD_MotVel_HwVel_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_FricLrngData_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)55, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_FricNonLrngData_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((NvM_BlockIdType)54, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
