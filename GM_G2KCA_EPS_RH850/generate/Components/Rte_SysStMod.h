...
extern VAR(boolean, RTE_VAR_INIT) Rte_SysStMod_SysStImdtTranReqOff_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_SysStMod_SysStImdtTranReqOff_Logl(data) (*(data) = Rte_SysStMod_SysStImdtTranReqOff_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
