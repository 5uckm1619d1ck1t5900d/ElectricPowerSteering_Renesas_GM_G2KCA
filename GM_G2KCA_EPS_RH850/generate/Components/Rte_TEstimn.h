...
#  define Rte_Read_TEstimn_AmbTVld_Logl(data) (*(data) = Rte_TEstimn_AmbTVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_TEstimn_EngOilTVld_Logl(data) (*(data) = Rte_TEstimn_EngOilTVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_HwVel_Val Rte_Read_TEstimn_HwVel_Val
#  define Rte_Read_TEstimn_HwVel_Val(data) (*(data) = Rte_CDD_MotVel_HwVel_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
