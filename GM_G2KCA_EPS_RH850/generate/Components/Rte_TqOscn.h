...
#  define Rte_Read_TqOscn_HwOscnFallRampRate_Val(data) (*(data) = Rte_TqOscn_HwOscnFallRampRate_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_TqOscn_HwOscnRisngRampRate_Val(data) (*(data) = Rte_TqOscn_HwOscnRisngRampRate_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
