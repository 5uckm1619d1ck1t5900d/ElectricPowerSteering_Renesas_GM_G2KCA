...
#  define Rte_Read_TunSelnMngt_DesIninIdx_Val(data) (*(data) = Rte_TunSelnMngt_DesIninIdx_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Enter_TunSelnMngtIntDataProtnExclsvArea() \
  { \
...
/* PRQA S 3458 L1 */ /* MD_MSR_19.4 */
#  define Rte_Exit_TunSelnMngtIntDataProtnExclsvArea() \
  { \
