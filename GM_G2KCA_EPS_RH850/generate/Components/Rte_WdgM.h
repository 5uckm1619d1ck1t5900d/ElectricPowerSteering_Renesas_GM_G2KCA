...
FUNC(Std_ReturnType, WdgM_CODE) WdgM_ActivateSupervisionEntity(WdgM_SupervisedEntityIdType parg0); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(Std_ReturnType, WdgM_CODE) WdgM_CheckpointReached(WdgM_SupervisedEntityIdType parg0, WdgM_CheckpointIdType parg1); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
FUNC(Std_ReturnType, WdgM_CODE) WdgM_DeactivateSupervisionEntity(WdgM_SupervisedEntityIdType parg0); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
...
FUNC(Std_ReturnType, WdgM_CODE) WdgM_GetLocalStatus(WdgM_SupervisedEntityIdType parg0, P2VAR(WdgM_LocalStatusType, AUTOMATIC, RTE_WDGM_APPL_VAR) Status); /* PRQA S 0850, 1330 */ /* MD_MSR_19.8, MD_Rte_1330 */
