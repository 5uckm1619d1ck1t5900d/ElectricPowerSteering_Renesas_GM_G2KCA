...
static CONST(struct Fee_BlockConfigStruct, FEE_APPL_CONFIG) Fee_BlockConfig_at[] =
{
  ...
  { /*  Block: FeeRte_NvmBlock_DiagcMgr_SnpshtDataAry  */ 
  ...
  { /*  Block: FeeRte_NvmBlock_WhlImbRejctn_ActvCmpBand2  */ 
  ...
  { /*  Block: FeeRte_NvmBlock_WhlImbRejctn_LePeakPrev  */ 
  ...
  { /*  Block: FeeRte_NvmBlock_WhlImbRejctn_RiPeakPrev  */ 
  ...
  { /*  Block: FeeRte_NvmBlock_WhlImbRejctn_ActvCmpBand1  */ 
  ...
  { /*  Block: FeeRte_NvmBlock_WhlImbRejctn_ActvCmpBand3  */ 
  ...
  { /*  Block: FeeRte_NvmBlock_WhlImbRejctn_MaxCompPerc  */ 
  ...
  { /*  Block: FeeMotAg2Meas_Deprecated  */ 
    14U /*  index of the block in the linktable  */ , 
    20U /*  payload length  */ , 
    1U /*  number of datasets  */ , 
    FEE0 /*  partition where the block resides in  */ , 
...
static CONST(struct Fee_PartitionConfigStruct, FEE_APPL_CONFIG) Fee_PartitionConfig_at[FEE_NUMBER_OF_PARTITIONS] =
{
  ...
  } /*  ramData_pt  */ , 
  {
    ...
    {
      3108UL /*  FSS threshold  */ , 
      2706UL /*  BSS threshold  */ 
    }, 
    { /*  AssociatedSectors_at  */ 
      { /*  LowerSector  */ 
