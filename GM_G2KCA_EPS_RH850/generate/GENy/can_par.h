...
#define CanRxSG16_Msg_EPS_B                  20
#define CanRxSG15_Msg_EPS_B                  21
#define CanRxSG14_Msg_EPS_B                  22
#define CanRxSG13_Msg_EPS_B                  23
#define CanRxSG12_Msg_EPS_B                  24
#define CanRxSG11_Msg_EPS_B                  25
#define CanRxSG10_Msg_EPS_B                  26
#define CanRxSG9_Msg_EPS_B                   27
#define CanRxSG8_Msg_EPS_B                   28
#define CanRxSG7_Msg_EPS_B                   29
#define CanRxSG6_Msg_EPS_B                   30
#define CanRxSG5_Msg_EPS_B                   31
#define CanRxSG4_Msg_EPS_B                   32
#define CanRxSG3_Msg_EPS_B                   33
#define CanRxSG2_Msg_EPS_B                   34
#define CanRxSG1_Msg_EPS_B                   35
#define CanRxSG0_Msg_EPS_B_ONLY_SCI          36
...
#define SG16_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b23)
#define CanWriteSyncSG16_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG16_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG15_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b24)
#define CanWriteSyncSG15_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG15_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG14_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b25)
#define CanWriteSyncSG14_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG14_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG13_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b26)
#define CanWriteSyncSG13_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG13_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG12_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b27)
#define CanWriteSyncSG12_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG12_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG11_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b30)
#define CanWriteSyncSG11_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG11_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG10_Msg_EPS_B_ind_b                 (CanIndicationFlags.w[0].b31)
#define CanWriteSyncSG10_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG10_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG9_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[0].b32)
#define CanWriteSyncSG9_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG9_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG8_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[0].b33)
#define CanWriteSyncSG8_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG8_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG7_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[0].b34)
#define CanWriteSyncSG7_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG7_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG6_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[0].b35)
#define CanWriteSyncSG6_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG6_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG5_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[0].b36)
#define CanWriteSyncSG5_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG5_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG4_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[0].b37)
#define CanWriteSyncSG4_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG4_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG3_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[1].b0)
#define CanWriteSyncSG3_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG3_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG2_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[1].b1)
#define CanWriteSyncSG2_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG2_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG1_Msg_EPS_B_ind_b                  (CanIndicationFlags.w[1].b2)
#define CanWriteSyncSG1_Msg_EPS_B_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG1_Msg_EPS_B_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
#define SG0_Msg_EPS_B_ONLY_SCI_ind_b         (CanIndicationFlags.w[1].b3)
#define CanWriteSyncSG0_Msg_EPS_B_ONLY_SCI_ind_b(x) \
{ \
  CanStartFlagWriteSync(); \
  SG0_Msg_EPS_B_ONLY_SCI_ind_b = (x); \
  CanEndFlagWriteSync(); \
}
...
/* ID: 0x00000021, Handle: 20, SG16_Msg_EPS_B [FC] */
...
/* ID: 0x0000001f, Handle: 21, SG15_Msg_EPS_B [FC] */
...
/* ID: 0x0000001d, Handle: 22, SG14_Msg_EPS_B [FC] */
...
/* ID: 0x0000001b, Handle: 23, SG13_Msg_EPS_B [FC] */
...
/* ID: 0x00000019, Handle: 24, SG12_Msg_EPS_B [FC] */
...
/* ID: 0x00000017, Handle: 25, SG11_Msg_EPS_B [FC] */
...
/* ID: 0x00000015, Handle: 26, SG10_Msg_EPS_B [FC] */
...
/* ID: 0x00000013, Handle: 27, SG9_Msg_EPS_B [FC] */
...
/* ID: 0x00000011, Handle: 28, SG8_Msg_EPS_B [FC] */
...
/* ID: 0x0000000f, Handle: 29, SG7_Msg_EPS_B [FC] */
...
/* ID: 0x0000000d, Handle: 30, SG6_Msg_EPS_B [FC] */
...
/* ID: 0x0000000b, Handle: 31, SG5_Msg_EPS_B [FC] */
...
/* ID: 0x00000009, Handle: 32, SG4_Msg_EPS_B [FC] */
...
/* ID: 0x00000007, Handle: 33, SG3_Msg_EPS_B [FC] */
...
/* ID: 0x00000005, Handle: 34, SG2_Msg_EPS_B [FC] */
...
/* ID: 0x00000003, Handle: 35, SG1_Msg_EPS_B [FC] */
...
/* ID: 0x00000001, Handle: 36, SG0_Msg_EPS_B_ONLY_SCI [BC] */
...
/* ID: 0x00000708, Handle: 38, Xcp_Master_Msg [BC] */
...
/* ID: 0x00000012, Handle: 13, SG9_Msg_EPS_A [BC] */
...
/* ID: 0x00000000, Handle: 14, SG0_Msg_EPS_A_ONLY_SCI [BC] */
...
/* ID: 0x00000020, Handle: 15, SG16_Msg_EPS_A [FC] */
...
/* ID: 0x0000001e, Handle: 16, SG15_Msg_EPS_A [FC] */
...
/* ID: 0x0000001c, Handle: 17, SG14_Msg_EPS_A [FC] */
...
/* ID: 0x0000001a, Handle: 18, SG13_Msg_EPS_A [FC] */
...
/* ID: 0x00000018, Handle: 19, SG12_Msg_EPS_A [FC] */
...
/* ID: 0x00000016, Handle: 20, SG11_Msg_EPS_A [FC] */
...
/* ID: 0x00000014, Handle: 21, SG10_Msg_EPS_A [FC] */
...
/* ID: 0x00000010, Handle: 22, SG8_Msg_EPS_A [FC] */
...
/* ID: 0x0000000e, Handle: 23, SG7_Msg_EPS_A [FC] */
...
/* ID: 0x0000000c, Handle: 24, SG6_Msg_EPS_A [FC] */
...
/* ID: 0x0000000a, Handle: 25, SG5_Msg_EPS_A [FC] */
...
/* ID: 0x00000008, Handle: 26, SG4_Msg_EPS_A [FC] */
...
/* ID: 0x00000006, Handle: 27, SG3_Msg_EPS_A [FC] */
...
/* ID: 0x00000004, Handle: 28, SG2_Msg_EPS_A [FC] */
...
/* ID: 0x00000002, Handle: 29, SG1_Msg_EPS_A [FC] */
...
#define b_CAN_SG9_Data_EPS_A_0_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_0)
#define b_CAN_SG9_Data_EPS_A_1_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_1)
#define b_CAN_SG9_Data_EPS_A_2_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_2)
#define b_CAN_SG9_Data_EPS_A_3_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_3)
#define b_CAN_SG9_Data_EPS_A_4_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_4)
#define b_CAN_SG9_Data_EPS_A_5_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_5)
#define b_CAN_SG9_Data_EPS_A_6_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_6)
#define b_CAN_SG9_Data_EPS_A_7_b             (RDSTx_2.SG9_Msg_EPS_A.SG9_Data_EPS_A_7)
...
#define b_CAN_SG0_Data_EPS_A_0_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_0)
#define b_CAN_SG0_Data_EPS_A_1_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_1)
#define b_CAN_SG0_Data_EPS_A_2_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_2)
#define b_CAN_SG0_Data_EPS_A_3_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_3)
#define b_CAN_SG0_Data_EPS_A_4_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_4)
#define b_CAN_SG0_Data_EPS_A_5_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_5)
#define b_CAN_SG0_Data_EPS_A_6_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_6)
#define b_CAN_SG0_Data_EPS_A_7_b             (RDSTx_2.SG0_Msg_EPS_A_ONLY_SCI.SG0_Data_EPS_A_7)

typedef struct _c_SG0_Msg_EPS_A_ONLY_SCI_RDS_msgTypeTag
{
  vbittype SG0_Data_EPS_A_7 : 8;
  vbittype SG0_Data_EPS_A_6 : 8;
  vbittype SG0_Data_EPS_A_5 : 8;
  vbittype SG0_Data_EPS_A_4 : 8;
  vbittype SG0_Data_EPS_A_3 : 8;
  vbittype SG0_Data_EPS_A_2 : 8;
  vbittype SG0_Data_EPS_A_1 : 8;
  vbittype SG0_Data_EPS_A_0 : 8;
} _c_SG0_Msg_EPS_A_ONLY_SCI_RDS_msgType;

#define b_CAN_SG1_Data_EPS_A_0_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_0)
#define b_CAN_SG1_Data_EPS_A_1_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_1)
#define b_CAN_SG1_Data_EPS_A_2_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_2)
#define b_CAN_SG1_Data_EPS_A_3_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_3)
#define b_CAN_SG1_Data_EPS_A_4_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_4)
#define b_CAN_SG1_Data_EPS_A_5_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_5)
#define b_CAN_SG1_Data_EPS_A_6_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_6)
#define b_CAN_SG1_Data_EPS_A_7_b             (RDS193.SG1_Msg_EPS_A.SG1_Data_EPS_A_7)
...
#define b_CAN_SG2_Data_EPS_A_0_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_0)
#define b_CAN_SG2_Data_EPS_A_1_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_1)
#define b_CAN_SG2_Data_EPS_A_2_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_2)
#define b_CAN_SG2_Data_EPS_A_3_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_3)
#define b_CAN_SG2_Data_EPS_A_4_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_4)
#define b_CAN_SG2_Data_EPS_A_5_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_5)
#define b_CAN_SG2_Data_EPS_A_6_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_6)
#define b_CAN_SG2_Data_EPS_A_7_b             (RDS194.SG2_Msg_EPS_A.SG2_Data_EPS_A_7)
...
#define b_CAN_SG3_Data_EPS_A_0_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_0)
#define b_CAN_SG3_Data_EPS_A_1_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_1)
#define b_CAN_SG3_Data_EPS_A_2_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_2)
#define b_CAN_SG3_Data_EPS_A_3_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_3)
#define b_CAN_SG3_Data_EPS_A_4_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_4)
#define b_CAN_SG3_Data_EPS_A_5_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_5)
#define b_CAN_SG3_Data_EPS_A_6_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_6)
#define b_CAN_SG3_Data_EPS_A_7_b             (RDS195.SG3_Msg_EPS_A.SG3_Data_EPS_A_7)
...
#define b_CAN_SG4_Data_EPS_A_0_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_0)
#define b_CAN_SG4_Data_EPS_A_1_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_1)
#define b_CAN_SG4_Data_EPS_A_2_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_2)
#define b_CAN_SG4_Data_EPS_A_3_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_3)
#define b_CAN_SG4_Data_EPS_A_4_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_4)
#define b_CAN_SG4_Data_EPS_A_5_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_5)
#define b_CAN_SG4_Data_EPS_A_6_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_6)
#define b_CAN_SG4_Data_EPS_A_7_b             (RDS196.SG4_Msg_EPS_A.SG4_Data_EPS_A_7)
...
#define b_CAN_SG5_Data_EPS_A_0_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_0)
#define b_CAN_SG5_Data_EPS_A_1_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_1)
#define b_CAN_SG5_Data_EPS_A_2_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_2)
#define b_CAN_SG5_Data_EPS_A_3_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_3)
#define b_CAN_SG5_Data_EPS_A_4_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_4)
#define b_CAN_SG5_Data_EPS_A_5_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_5)
#define b_CAN_SG5_Data_EPS_A_6_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_6)
#define b_CAN_SG5_Data_EPS_A_7_b             (RDS197.SG5_Msg_EPS_A.SG5_Data_EPS_A_7)
...
#define b_CAN_SG6_Data_EPS_A_0_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_0)
#define b_CAN_SG6_Data_EPS_A_1_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_1)
#define b_CAN_SG6_Data_EPS_A_2_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_2)
#define b_CAN_SG6_Data_EPS_A_3_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_3)
#define b_CAN_SG6_Data_EPS_A_4_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_4)
#define b_CAN_SG6_Data_EPS_A_5_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_5)
#define b_CAN_SG6_Data_EPS_A_6_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_6)
#define b_CAN_SG6_Data_EPS_A_7_b             (RDS198.SG6_Msg_EPS_A.SG6_Data_EPS_A_7)
...
#define b_CAN_SG7_Data_EPS_A_0_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_0)
#define b_CAN_SG7_Data_EPS_A_1_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_1)
#define b_CAN_SG7_Data_EPS_A_2_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_2)
#define b_CAN_SG7_Data_EPS_A_3_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_3)
#define b_CAN_SG7_Data_EPS_A_4_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_4)
#define b_CAN_SG7_Data_EPS_A_5_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_5)
#define b_CAN_SG7_Data_EPS_A_6_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_6)
#define b_CAN_SG7_Data_EPS_A_7_b             (RDS199.SG7_Msg_EPS_A.SG7_Data_EPS_A_7)
...
#define b_CAN_SG8_Data_EPS_A_0_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_0)
#define b_CAN_SG8_Data_EPS_A_1_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_1)
#define b_CAN_SG8_Data_EPS_A_2_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_2)
#define b_CAN_SG8_Data_EPS_A_3_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_3)
#define b_CAN_SG8_Data_EPS_A_4_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_4)
#define b_CAN_SG8_Data_EPS_A_5_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_5)
#define b_CAN_SG8_Data_EPS_A_6_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_6)
#define b_CAN_SG8_Data_EPS_A_7_b             (RDS200.SG8_Msg_EPS_A.SG8_Data_EPS_A_7)
...
#define b_CAN_SG10_Data_EPS_A_0_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_0)
#define b_CAN_SG10_Data_EPS_A_1_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_1)
#define b_CAN_SG10_Data_EPS_A_2_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_2)
#define b_CAN_SG10_Data_EPS_A_3_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_3)
#define b_CAN_SG10_Data_EPS_A_4_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_4)
#define b_CAN_SG10_Data_EPS_A_5_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_5)
#define b_CAN_SG10_Data_EPS_A_6_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_6)
#define b_CAN_SG10_Data_EPS_A_7_b            (RDS201.SG10_Msg_EPS_A.SG10_Data_EPS_A_7)
...
#define b_CAN_SG11_Data_EPS_A_0_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_0)
#define b_CAN_SG11_Data_EPS_A_1_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_1)
#define b_CAN_SG11_Data_EPS_A_2_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_2)
#define b_CAN_SG11_Data_EPS_A_3_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_3)
#define b_CAN_SG11_Data_EPS_A_4_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_4)
#define b_CAN_SG11_Data_EPS_A_5_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_5)
#define b_CAN_SG11_Data_EPS_A_6_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_6)
#define b_CAN_SG11_Data_EPS_A_7_b            (RDS202.SG11_Msg_EPS_A.SG11_Data_EPS_A_7)
...
#define b_CAN_SG12_Data_EPS_A_0_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_0)
#define b_CAN_SG12_Data_EPS_A_1_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_1)
#define b_CAN_SG12_Data_EPS_A_2_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_2)
#define b_CAN_SG12_Data_EPS_A_3_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_3)
#define b_CAN_SG12_Data_EPS_A_4_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_4)
#define b_CAN_SG12_Data_EPS_A_5_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_5)
#define b_CAN_SG12_Data_EPS_A_6_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_6)
#define b_CAN_SG12_Data_EPS_A_7_b            (RDS203.SG12_Msg_EPS_A.SG12_Data_EPS_A_7)
...
#define b_CAN_SG13_Data_EPS_A_0_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_0)
#define b_CAN_SG13_Data_EPS_A_1_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_1)
#define b_CAN_SG13_Data_EPS_A_2_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_2)
#define b_CAN_SG13_Data_EPS_A_3_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_3)
#define b_CAN_SG13_Data_EPS_A_4_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_4)
#define b_CAN_SG13_Data_EPS_A_5_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_5)
#define b_CAN_SG13_Data_EPS_A_6_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_6)
#define b_CAN_SG13_Data_EPS_A_7_b            (RDS204.SG13_Msg_EPS_A.SG13_Data_EPS_A_7)
...
#define b_CAN_SG14_Data_EPS_A_0_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_0)
#define b_CAN_SG14_Data_EPS_A_1_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_1)
#define b_CAN_SG14_Data_EPS_A_2_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_2)
#define b_CAN_SG14_Data_EPS_A_3_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_3)
#define b_CAN_SG14_Data_EPS_A_4_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_4)
#define b_CAN_SG14_Data_EPS_A_5_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_5)
#define b_CAN_SG14_Data_EPS_A_6_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_6)
#define b_CAN_SG14_Data_EPS_A_7_b            (RDS205.SG14_Msg_EPS_A.SG14_Data_EPS_A_7)
...
#define b_CAN_SG15_Data_EPS_A_0_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_0)
#define b_CAN_SG15_Data_EPS_A_1_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_1)
#define b_CAN_SG15_Data_EPS_A_2_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_2)
#define b_CAN_SG15_Data_EPS_A_3_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_3)
#define b_CAN_SG15_Data_EPS_A_4_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_4)
#define b_CAN_SG15_Data_EPS_A_5_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_5)
#define b_CAN_SG15_Data_EPS_A_6_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_6)
#define b_CAN_SG15_Data_EPS_A_7_b            (RDS206.SG15_Msg_EPS_A.SG15_Data_EPS_A_7)
...
#define b_CAN_SG16_Data_EPS_A_0_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_0)
#define b_CAN_SG16_Data_EPS_A_1_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_1)
#define b_CAN_SG16_Data_EPS_A_2_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_2)
#define b_CAN_SG16_Data_EPS_A_3_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_3)
#define b_CAN_SG16_Data_EPS_A_4_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_4)
#define b_CAN_SG16_Data_EPS_A_5_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_5)
#define b_CAN_SG16_Data_EPS_A_6_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_6)
#define b_CAN_SG16_Data_EPS_A_7_b            (RDS207.SG16_Msg_EPS_A.SG16_Data_EPS_A_7)
...
#define b_CAN_SG16_Data_EPS_B_0_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_0)
#define b_CAN_SG16_Data_EPS_B_1_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_1)
#define b_CAN_SG16_Data_EPS_B_2_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_2)
#define b_CAN_SG16_Data_EPS_B_3_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_3)
#define b_CAN_SG16_Data_EPS_B_4_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_4)
#define b_CAN_SG16_Data_EPS_B_5_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_5)
#define b_CAN_SG16_Data_EPS_B_6_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_6)
#define b_CAN_SG16_Data_EPS_B_7_b            (RDS20.SG16_Msg_EPS_B.SG16_Data_EPS_B_7)
...
#define b_CAN_SG15_Data_EPS_B_0_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_0)
#define b_CAN_SG15_Data_EPS_B_1_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_1)
#define b_CAN_SG15_Data_EPS_B_2_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_2)
#define b_CAN_SG15_Data_EPS_B_3_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_3)
#define b_CAN_SG15_Data_EPS_B_4_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_4)
#define b_CAN_SG15_Data_EPS_B_5_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_5)
#define b_CAN_SG15_Data_EPS_B_6_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_6)
#define b_CAN_SG15_Data_EPS_B_7_b            (RDS21.SG15_Msg_EPS_B.SG15_Data_EPS_B_7)
...
#define b_CAN_SG14_Data_EPS_B_0_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_0)
#define b_CAN_SG14_Data_EPS_B_1_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_1)
#define b_CAN_SG14_Data_EPS_B_2_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_2)
#define b_CAN_SG14_Data_EPS_B_3_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_3)
#define b_CAN_SG14_Data_EPS_B_4_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_4)
#define b_CAN_SG14_Data_EPS_B_5_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_5)
#define b_CAN_SG14_Data_EPS_B_6_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_6)
#define b_CAN_SG14_Data_EPS_B_7_b            (RDS22.SG14_Msg_EPS_B.SG14_Data_EPS_B_7)
...
#define b_CAN_SG13_Data_EPS_B_0_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_0)
#define b_CAN_SG13_Data_EPS_B_1_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_1)
#define b_CAN_SG13_Data_EPS_B_2_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_2)
#define b_CAN_SG13_Data_EPS_B_3_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_3)
#define b_CAN_SG13_Data_EPS_B_4_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_4)
#define b_CAN_SG13_Data_EPS_B_5_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_5)
#define b_CAN_SG13_Data_EPS_B_6_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_6)
#define b_CAN_SG13_Data_EPS_B_7_b            (RDS23.SG13_Msg_EPS_B.SG13_Data_EPS_B_7)
...
#define b_CAN_SG12_Data_EPS_B_0_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_0)
#define b_CAN_SG12_Data_EPS_B_1_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_1)
#define b_CAN_SG12_Data_EPS_B_2_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_2)
#define b_CAN_SG12_Data_EPS_B_3_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_3)
#define b_CAN_SG12_Data_EPS_B_4_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_4)
#define b_CAN_SG12_Data_EPS_B_5_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_5)
#define b_CAN_SG12_Data_EPS_B_6_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_6)
#define b_CAN_SG12_Data_EPS_B_7_b            (RDS24.SG12_Msg_EPS_B.SG12_Data_EPS_B_7)
...
#define b_CAN_SG11_Data_EPS_B_0_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_0)
#define b_CAN_SG11_Data_EPS_B_1_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_1)
#define b_CAN_SG11_Data_EPS_B_2_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_2)
#define b_CAN_SG11_Data_EPS_B_3_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_3)
#define b_CAN_SG11_Data_EPS_B_4_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_4)
#define b_CAN_SG11_Data_EPS_B_5_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_5)
#define b_CAN_SG11_Data_EPS_B_6_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_6)
#define b_CAN_SG11_Data_EPS_B_7_b            (RDS25.SG11_Msg_EPS_B.SG11_Data_EPS_B_7)
...
#define b_CAN_SG10_Data_EPS_B_0_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_0)
#define b_CAN_SG10_Data_EPS_B_1_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_1)
#define b_CAN_SG10_Data_EPS_B_2_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_2)
#define b_CAN_SG10_Data_EPS_B_3_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_3)
#define b_CAN_SG10_Data_EPS_B_4_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_4)
#define b_CAN_SG10_Data_EPS_B_5_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_5)
#define b_CAN_SG10_Data_EPS_B_6_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_6)
#define b_CAN_SG10_Data_EPS_B_7_b            (RDS26.SG10_Msg_EPS_B.SG10_Data_EPS_B_7)
...
#define b_CAN_SG9_Data_EPS_B_0_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_0)
#define b_CAN_SG9_Data_EPS_B_1_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_1)
#define b_CAN_SG9_Data_EPS_B_2_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_2)
#define b_CAN_SG9_Data_EPS_B_3_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_3)
#define b_CAN_SG9_Data_EPS_B_4_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_4)
#define b_CAN_SG9_Data_EPS_B_5_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_5)
#define b_CAN_SG9_Data_EPS_B_6_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_6)
#define b_CAN_SG9_Data_EPS_B_7_b             (RDS27.SG9_Msg_EPS_B.SG9_Data_EPS_B_7)
...
#define b_CAN_SG8_Data_EPS_B_0_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_0)
#define b_CAN_SG8_Data_EPS_B_1_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_1)
#define b_CAN_SG8_Data_EPS_B_2_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_2)
#define b_CAN_SG8_Data_EPS_B_3_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_3)
#define b_CAN_SG8_Data_EPS_B_4_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_4)
#define b_CAN_SG8_Data_EPS_B_5_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_5)
#define b_CAN_SG8_Data_EPS_B_6_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_6)
#define b_CAN_SG8_Data_EPS_B_7_b             (RDS28.SG8_Msg_EPS_B.SG8_Data_EPS_B_7)
...
#define b_CAN_SG7_Data_EPS_B_0_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_0)
#define b_CAN_SG7_Data_EPS_B_1_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_1)
#define b_CAN_SG7_Data_EPS_B_2_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_2)
#define b_CAN_SG7_Data_EPS_B_3_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_3)
#define b_CAN_SG7_Data_EPS_B_4_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_4)
#define b_CAN_SG7_Data_EPS_B_5_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_5)
#define b_CAN_SG7_Data_EPS_B_6_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_6)
#define b_CAN_SG7_Data_EPS_B_7_b             (RDS29.SG7_Msg_EPS_B.SG7_Data_EPS_B_7)
...
#define b_CAN_SG6_Data_EPS_B_0_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_0)
#define b_CAN_SG6_Data_EPS_B_1_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_1)
#define b_CAN_SG6_Data_EPS_B_2_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_2)
#define b_CAN_SG6_Data_EPS_B_3_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_3)
#define b_CAN_SG6_Data_EPS_B_4_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_4)
#define b_CAN_SG6_Data_EPS_B_5_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_5)
#define b_CAN_SG6_Data_EPS_B_6_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_6)
#define b_CAN_SG6_Data_EPS_B_7_b             (RDS30.SG6_Msg_EPS_B.SG6_Data_EPS_B_7)
...
#define b_CAN_SG5_Data_EPS_B_0_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_0)
#define b_CAN_SG5_Data_EPS_B_1_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_1)
#define b_CAN_SG5_Data_EPS_B_2_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_2)
#define b_CAN_SG5_Data_EPS_B_3_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_3)
#define b_CAN_SG5_Data_EPS_B_4_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_4)
#define b_CAN_SG5_Data_EPS_B_5_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_5)
#define b_CAN_SG5_Data_EPS_B_6_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_6)
#define b_CAN_SG5_Data_EPS_B_7_b             (RDS31.SG5_Msg_EPS_B.SG5_Data_EPS_B_7)
...
#define b_CAN_SG4_Data_EPS_B_0_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_0)
#define b_CAN_SG4_Data_EPS_B_1_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_1)
#define b_CAN_SG4_Data_EPS_B_2_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_2)
#define b_CAN_SG4_Data_EPS_B_3_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_3)
#define b_CAN_SG4_Data_EPS_B_4_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_4)
#define b_CAN_SG4_Data_EPS_B_5_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_5)
#define b_CAN_SG4_Data_EPS_B_6_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_6)
#define b_CAN_SG4_Data_EPS_B_7_b             (RDS32.SG4_Msg_EPS_B.SG4_Data_EPS_B_7)
...
#define b_CAN_SG3_Data_EPS_B_0_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_0)
#define b_CAN_SG3_Data_EPS_B_1_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_1)
#define b_CAN_SG3_Data_EPS_B_2_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_2)
#define b_CAN_SG3_Data_EPS_B_3_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_3)
#define b_CAN_SG3_Data_EPS_B_4_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_4)
#define b_CAN_SG3_Data_EPS_B_5_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_5)
#define b_CAN_SG3_Data_EPS_B_6_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_6)
#define b_CAN_SG3_Data_EPS_B_7_b             (RDS33.SG3_Msg_EPS_B.SG3_Data_EPS_B_7)
...
#define b_CAN_SG2_Data_EPS_B_0_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_0)
#define b_CAN_SG2_Data_EPS_B_1_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_1)
#define b_CAN_SG2_Data_EPS_B_2_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_2)
#define b_CAN_SG2_Data_EPS_B_3_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_3)
#define b_CAN_SG2_Data_EPS_B_4_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_4)
#define b_CAN_SG2_Data_EPS_B_5_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_5)
#define b_CAN_SG2_Data_EPS_B_6_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_6)
#define b_CAN_SG2_Data_EPS_B_7_b             (RDS34.SG2_Msg_EPS_B.SG2_Data_EPS_B_7)
...
#define b_CAN_SG1_Data_EPS_B_0_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_0)
#define b_CAN_SG1_Data_EPS_B_1_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_1)
#define b_CAN_SG1_Data_EPS_B_2_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_2)
#define b_CAN_SG1_Data_EPS_B_3_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_3)
#define b_CAN_SG1_Data_EPS_B_4_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_4)
#define b_CAN_SG1_Data_EPS_B_5_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_5)
#define b_CAN_SG1_Data_EPS_B_6_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_6)
#define b_CAN_SG1_Data_EPS_B_7_b             (RDS35.SG1_Msg_EPS_B.SG1_Data_EPS_B_7)
...
#define b_CAN_SG0_Data_EPS_B_0_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_0)
#define b_CAN_SG0_Data_EPS_B_1_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_1)
#define b_CAN_SG0_Data_EPS_B_2_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_2)
#define b_CAN_SG0_Data_EPS_B_3_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_3)
#define b_CAN_SG0_Data_EPS_B_4_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_4)
#define b_CAN_SG0_Data_EPS_B_5_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_5)
#define b_CAN_SG0_Data_EPS_B_6_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_6)
#define b_CAN_SG0_Data_EPS_B_7_b             (RDSBasic_2.SG0_Msg_EPS_B_ONLY_SCI.SG0_Data_EPS_B_7)
...
typedef union _c_RDS_Tx_buf_2Tag
{
  ...
  _c_SG0_Msg_EPS_A_ONLY_SCI_RDS_msgType SG0_Msg_EPS_A_ONLY_SCI;
} _c_RDS_Tx_buf_2;
...
#define RDS35                                ((* ((_c_RDS35_buf MEMORY_NORMAL *)(canRDSRxPtr[2]))))
#define RDSBasic_2                           ((* ((_c_RDSBasic_buf_2 MEMORY_NORMAL *)(canRDSRxPtr[2]))))
...
#define CanTxSG1_Msg_EPS_A_HW_OBJ            193
#define CanTxSG1_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG2_Msg_EPS_A_HW_OBJ            194
#define CanTxSG2_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG3_Msg_EPS_A_HW_OBJ            195
#define CanTxSG3_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG4_Msg_EPS_A_HW_OBJ            196
#define CanTxSG4_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG5_Msg_EPS_A_HW_OBJ            197
#define CanTxSG5_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG6_Msg_EPS_A_HW_OBJ            198
#define CanTxSG6_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG7_Msg_EPS_A_HW_OBJ            199
#define CanTxSG7_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG8_Msg_EPS_A_HW_OBJ            200
#define CanTxSG8_Msg_EPS_A_HW_CHANNEL        2
#define CanTxSG10_Msg_EPS_A_HW_OBJ           201
#define CanTxSG10_Msg_EPS_A_HW_CHANNEL       2
#define CanTxSG11_Msg_EPS_A_HW_OBJ           202
#define CanTxSG11_Msg_EPS_A_HW_CHANNEL       2
#define CanTxSG12_Msg_EPS_A_HW_OBJ           203
#define CanTxSG12_Msg_EPS_A_HW_CHANNEL       2
#define CanTxSG13_Msg_EPS_A_HW_OBJ           204
#define CanTxSG13_Msg_EPS_A_HW_CHANNEL       2
#define CanTxSG14_Msg_EPS_A_HW_OBJ           205
#define CanTxSG14_Msg_EPS_A_HW_CHANNEL       2
#define CanTxSG15_Msg_EPS_A_HW_OBJ           206
#define CanTxSG15_Msg_EPS_A_HW_CHANNEL       2
#define CanTxSG16_Msg_EPS_A_HW_OBJ           207
#define CanTxSG16_Msg_EPS_A_HW_CHANNEL       2
#define CanRxSG16_Msg_EPS_B_HW_OBJ           20
#define CanRxSG16_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG15_Msg_EPS_B_HW_OBJ           21
#define CanRxSG15_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG14_Msg_EPS_B_HW_OBJ           22
#define CanRxSG14_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG13_Msg_EPS_B_HW_OBJ           23
#define CanRxSG13_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG12_Msg_EPS_B_HW_OBJ           24
#define CanRxSG12_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG11_Msg_EPS_B_HW_OBJ           25
#define CanRxSG11_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG10_Msg_EPS_B_HW_OBJ           26
#define CanRxSG10_Msg_EPS_B_HW_CHANNEL       2
#define CanRxSG9_Msg_EPS_B_HW_OBJ            27
#define CanRxSG9_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG8_Msg_EPS_B_HW_OBJ            28
#define CanRxSG8_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG7_Msg_EPS_B_HW_OBJ            29
#define CanRxSG7_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG6_Msg_EPS_B_HW_OBJ            30
#define CanRxSG6_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG5_Msg_EPS_B_HW_OBJ            31
#define CanRxSG5_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG4_Msg_EPS_B_HW_OBJ            32
#define CanRxSG4_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG3_Msg_EPS_B_HW_OBJ            33
#define CanRxSG3_Msg_EPS_B_HW_CHANNEL        2
#define CanRxSG2_Msg_EPS_B_HW_OBJ            34
#define CanRxSG2_Msg_EPS_B_HW_CHANNEL        2
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\GENy\can_par.h> is different. Please check time and date of generated files!"
  #endif
#else
