...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\GENy\xcp_par.c> is different. Please check time and date of generated files!"
  #endif
#else
