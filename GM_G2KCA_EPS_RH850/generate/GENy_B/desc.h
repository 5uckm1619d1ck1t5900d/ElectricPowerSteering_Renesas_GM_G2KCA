...
2012-07-27  6.12.00
                    -      -                 -             -                              No relevant changes available in this version.
2012-10-27  6.12.01
                    Ktw    Fixed             ESCAN00061436 General Motors(KWP2000)        CANdesc does not support dynamically defined DPID 0x03
                    Ktw    Fixed             ESCAN00061312 General Motors(KWP2000)        Not possible to support negative responses while suppressing positive response for service $A5 03
...
2014-01-31  6.16.00
                    ...
                    Rpk    Fixed             ESCAN00074177 General Motors(KWP2000)        Service 0x2C: Defining a DPID with a secured PID not allowed in the current security state leads to undefined behavior
2014-07-14  6.17.00
                    Rpk    Fixed             ESCAN00077492 General Motors(KWP2000)        Unsolicited responses (e.g. 0x60) is sent on wrong CAN channel or undefined behavior
                    Rpk    Fixed             ESCAN00076096 General Motors(KWP2000)        Periodic response of a DPID requested with service $AA return wrong data
                    Rpk    Fixed             ESCAN00074189 General Motors(KWP2000)        Service 0x2C: A PID declined by the application via pre-handler is skipped for the DPID definition
                    Rpk    Fixed             ESCAN00073848 General Motors(KWP2000)        Tester present timeout occurs too early after a 0x28 request
...
2014-08-12  6.17.01
                    Rpk    Fixed             ESCAN00077788 General Motors(KWP2000)        Compiler error: busProperty is not a member of t_descUudtNetBusInfoTag
2014-11-05  6.18.00
...
2015-06-23  6.19.00
                    Aey    Fixed             ESCAN00084348 KWP2000                        Unexpected negative response for a Security Access request with NRC 0x36 or 0x24
...
/* UUDT ensure request order on the bus  will not be supported. */
#define DESC_UUDTNET_DISABLE_ORDERED_TX
/* UUDT retransmit on failed transmission will not be supported. */
#define DESC_UUDTNET_DISABLE_RETRANSMIT_ON_FAILED_TX
...
#define DIAG_CANDESC__CORE_VERSION                                   0x0620
#define DIAG_CANDESC__CORE_RELEASE_VERSION                           0x00
#define DESC_VERSION                                                 0x0620
...
#define DESC_PUBLIC_INTERFACE_MAGIC_NUMBER                           16339
...
#define kDescUudtNetMaxNumCanMsgsPerChannel                          1
#define kDescUudtNetNumEcus                                          1
#define kDescUudtNetNumChannels                                      2
