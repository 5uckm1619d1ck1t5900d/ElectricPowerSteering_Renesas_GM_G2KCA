...
{
  kIlNoCycleTime /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  kIlNoCycleTime /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  kIlNoCycleTime /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  kIlNoCycleTime /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  kIlNoCycleTime /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
{
  kIlNoDelayTime /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  kIlNoDelayTime /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  11 /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  kIlNoDelayTime /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  kIlNoDelayTime /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
{
  100 /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  1 /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  100 /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  2 /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  1 /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
{
  kIlNoCycleTimeFast /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  kIlNoCycleTimeFast /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  kIlNoCycleTimeFast /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  kIlNoCycleTimeFast /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  kIlNoCycleTimeFast /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\GENy_B\gmlcal.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\GENy_B\gmlcal.c> "
