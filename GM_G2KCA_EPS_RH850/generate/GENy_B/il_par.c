...
{
  V_NULL /* ID: 0x000007cb, T1_HostToTarget [BC] */, 
...
V_MEMROM0 V_MEMROM1 vuint8 V_MEMROM2 IlRxHndStartIndex[kIlNrOfPackedRxObjectBytes+1] = 
{
  ...
  20 /* Channel_3 ilRxPackedIndex: 3 stop element */
};
...
V_MEMROM0 V_MEMROM1 vuint8 V_MEMROM2 IlVnRxMessageMapping[kIlNumberOfVirtualNets][kIlNrOfPackedRxObjectBytes] = 
{
  ...
  { 0xFF, 0x7F, 0x00 } /* AllNodes */, 
  { 0x00, 0x00, 0x00 } /* SLHS_VNReq */, 
  { 0x00, 0x00, 0x00 } /* SLHSSharedDiagnostic */, 
  { 0x00, 0x00, 0x1F } /* AllNodes */, 
  { 0x00, 0x00, 0x00 } /* SLHS_VNReq */
};
#endif
...
{
  kIlRxTimeoutHandleNotUsed /* ID: 0x000007cb, Handle: 0, T1_HostToTarget [BC] */, 
...
{
  IlRxMsgHndT1_HostToTarget /* ID: 0x000007cb, Handle: 0, T1_HostToTarget [BC] */, 
  IlRxMsgHndWheel_Pulses_HS /* ID: 0x00000500, Handle: 1, Wheel_Pulses_HS [FC] */, 
  IlRxMsgHndPPEI_Engine_General_Status_5 /* ID: 0x000004d1, Handle: 2, PPEI_Engine_General_Status_5 [FC] */, 
  IlRxMsgHndPPEI_Platform_Eng_Cntrl_Requests /* ID: 0x000003f1, Handle: 3, PPEI_Platform_Eng_Cntrl_Requests [FC] */, 
  IlRxMsgHndNonDriven_Wheel_Grnd_Velocity_HS /* ID: 0x0000034a, Handle: 4, NonDriven_Wheel_Grnd_Velocity_HS [FC] */, 
  ...
  kIlRxHandleNotUsed /* ID: 0x00000020, Handle: 20, SG16_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000001e, Handle: 21, SG15_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000001c, Handle: 22, SG14_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000001a, Handle: 23, SG13_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000018, Handle: 24, SG12_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000016, Handle: 25, SG11_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000014, Handle: 26, SG10_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000012, Handle: 27, SG9_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000010, Handle: 28, SG8_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000000e, Handle: 29, SG7_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000000c, Handle: 30, SG6_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000000a, Handle: 31, SG5_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000008, Handle: 32, SG4_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000006, Handle: 33, SG3_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000004, Handle: 34, SG2_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000002, Handle: 35, SG1_Msg_EPS_A [FC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000000, Handle: 36, SG0_Msg_EPS_A_ONLY_SCI [BC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000713, Handle: 37, CmnMfgSrvReq [BC] */, 
  kIlRxHandleNotUsed /* ID: 0x0000070c, Handle: 38, Xcp_Master_Msg [BC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000242, Handle: 39, USDT_Req_to_EHPS_EPS_HS [BC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000101, Handle: 40, USDT_Req_to_All_HS_ECUs [BC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000242, Handle: 41, USDT_Req_to_EPS_EPS_JR_CE [BC] */, 
  kIlRxHandleNotUsed /* ID: 0x00000101, Handle: 42, USDT_Req_to_All_CE_ECUs [BC] */
};
#endif
...
{
  kIlRxExtIdHandleNotUsed /* ID: 0x000007cb, Handle: 0, T1_HostToTarget [BC] */, 
...
{
  kIlNoTxToutIndirection /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  kIlNoTxToutIndirection /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  kIlNoTxToutIndirection /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  kIlNoTxToutIndirection /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  kIlNoTxToutIndirection /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
{
  kIlNoFastOnStartDuration /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  kIlNoFastOnStartDuration /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  kIlNoFastOnStartDuration /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  kIlNoFastOnStartDuration /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  kIlNoFastOnStartDuration /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
V_MEMROM0 V_MEMROM1 IltTxCounter V_MEMROM2 IlTxFastOnStartMuxDelay[kIlNumberOfTxObjects] = 
{
  ...
  0 /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  0 /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  0 /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  0 /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
V_MEMROM0 V_MEMROM1 IlConfirmationFct V_MEMROM2 IlTxConfirmationFctPtr[kIlNumberOfTxObjects] = 
{
  ...
  V_NULL /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  V_NULL /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  V_NULL /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  V_NULL /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
void IlResetCanConfirmationFlags(CanChannelHandle channel)
{
  ...
  if(channel == 1)
  {
    IlGetTxConfirmationFlags(0) &= (vuint8) 0xE7;
  }
  CanGlobalInterruptRestore();
}
...
/* Handle:   38,Name:               DrvStrIntfrDtcdV,Size:  1,UsedBytes:  1,PartialSignal */
#ifdef IL_ENABLE_TX
...
/* Handle:   39,Name:                DrvStrIntfrDtcd,Size:  1,UsedBytes:  1,PartialSignal */
#ifdef IL_ENABLE_TX
...
/* Handle:   48,Name:                    StrWhAngV_1,Size:  1,UsedBytes:  1,PartialSignal */
#ifdef IL_ENABLE_TX
...
/* Handle:   54,Name:                 StrWhAngGrdV_1,Size:  1,UsedBytes:  1,PartialSignal */
#ifdef IL_ENABLE_TX
...
/* Handle:   49,Name:                     StrWhAng_1,Size: 16,UsedBytes:  2,PartialSignal */
#ifdef IL_ENABLE_TX
...
/* Handle:   53,Name:                  StrWhAngGrd_1,Size: 12,UsedBytes:  2,PartialSignal */
#ifdef IL_ENABLE_TX
...
/* Handle:   56,Name:               StrAngSnsChksm_1,Size: 11,UsedBytes:  2,SingleSignal */
#ifdef IL_ENABLE_TX
...
{
  0 /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  5 /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  6 /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  9 /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  10 /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
{
  { 0, 1 } /* start - stop  ID: 0x0000078a, DTC_Triggered_778 [BC] */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
  { 1, 2 } /* start - stop  ID: 0x00000185, PPEI_Steering_Wheel_Angle [BC] */, 
  { 2, 3 } /* start - stop  ID: 0x00000149, Power_Steering_Information_HS [BC] */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
  { 3, 4 } /* start - stop  ID: 0x00000336, Electric_Power_Steering_CE [BC] */, 
  { 4, 5 } /* start - stop  ID: 0x00000185, PPEI_Steering_Wheel_Angle_CE [BC] */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
  { 0, 0 } /* no Il message */, 
...
{
  kTxSendCyclic /* ID: 0x0000078a, Handle: 0, DTC_Triggered_778 [BC] */, 
  kTxSendCyclic /* ID: 0x00000185, Handle: 1, PPEI_Steering_Wheel_Angle [BC] */, 
  kTxSendCyclic /* ID: 0x00000149, Handle: 2, Power_Steering_Information_HS [BC] */, 
  kTxSendCyclic /* ID: 0x00000336, Handle: 3, Electric_Power_Steering_CE [BC] */, 
  kTxSendCyclic /* ID: 0x00000185, Handle: 4, PPEI_Steering_Wheel_Angle_CE [BC] */
};
#endif
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\GENy_B\il_par.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\GENy_B\il_par.c> "
