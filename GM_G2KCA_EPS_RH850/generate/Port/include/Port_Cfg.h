...
/*
 * INPUT FILE:    C:\Users\cz8l9t\AppData\Local\Temp\Cfg_Gen-1480610144188-4\AutosarFiles_ValGen-1480615447001-0\Port_ECUC_4850428325287837488.arxml
 *                C:\_synergy\G2KCAT3_CZ8L9T\Port\generate\R403_PORT_P1x_BSWMDT.arxml
 * GENERATED ON:   1 Dec 2016 - 13:04:30
 */
...
#define PORT_DEM_ERROR_DETECT               STD_OFF
...
#define PORT_IOHOLD_FUNC_AVAILABLE          STD_OFF

/*  Indicates the size of PPCMD register  */
...
#define PORT_JTAG_PDSC_REG_ADD_OFFSET       (uint16)0x0000
...
#define PORT_LOOP_TIMEOUT                   (uint8)0x32
...
/* Availability of  Edge Detect Control Register. */
#define PORT_EDGE_DETECT_CONTROL            STD_OFF

/* Availability of DNFAnENnoise elimination registers. */
#define PORT_DNFAEN_REG_AVAILABLE           STD_ON

/* Availability of DNFCKS noise elimination sampling clock source selection register. */
#define PORT_DNF_CLK_SRC_AVAILABLE          STD_OFF


/* Starting address for DNFA noise elimination registers */
#define PORT_DNFA_BASE_ADDRESS              (uint32)0xffc31400UL

/* Address offset for Digital noise elimination enable registers */
#define PORT_DNFAEN_ADDRESS_OFFSET          (uint32)0x4UL
...
/* The Total number of Numeric PIS registers configured  */
#define PORT_NUM_PIS_REGS                   (uint8)0x05 
...
#define PORT_JTAG_PUCC_REGS                 (uint8)0x00 
...
/* The following constant contains total number of  JPIS registers */
#define PORT_JTAG_PIS_REGS                  (uint8)0x01 

/* The following constant contains total number of  JPIBC registers */
#define PORT_JTAG_PIBC_REGS                 (uint8)0x01 

/* The following constant contains total number of  JPIPC registers */
#define PORT_JTAG_PIPC_REGS                 (uint8)0x00 
...
/* The following constant contains total number of  JPFC registers */
#define PORT_JTAG_PFC_REGS                  (uint8)0x00 

/* The following constant contains total number of  JPFCAE registers */
#define PORT_JTAG_PFCAE_REGS                (uint8)0x00 
