/* file: C:/_synergy/G2KCAT3_CZ8L9T/GM_G2KCA_EPS_RH850/generate/tcbpost.h */
...
#define OS_MS2TICKS_osSystemSWCounter(x) ((TickType)((((osTimeComputationType)(x)) * 1.00000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2MS_osSystemSWCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 1.00000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_NS2TICKS_osSystemSWCounter(x) ((TickType)((((osTimeComputationType)(x)) * 1.00000e-006)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2NS_osSystemSWCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 1.00000e+006)+0.5)) /* valid range for x: 0..4294 */
#define OS_SEC2TICKS_osSystemSWCounter(x) ((TickType)((((osTimeComputationType)(x)) * 1000.00)+0.5)) /* valid range for x: 0..4294967 */
#define OS_TICKS2SEC_osSystemSWCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 0.00100000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_US2TICKS_osSystemSWCounter(x) ((TickType)((((osTimeComputationType)(x)) * 0.00100000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2US_osSystemSWCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 1000.00)+0.5)) /* valid range for x: 0..4294967 */
#define OS_MS2TICKS_OsCounter(x) ((TickType)((((osTimeComputationType)(x)) * 0.500000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2MS_OsCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 2.00000)+0.5)) /* valid range for x: 0..2147483647 */
#define OS_NS2TICKS_OsCounter(x) ((TickType)((((osTimeComputationType)(x)) * 5.00000e-007)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2NS_OsCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 2.00000e+006)+0.5)) /* valid range for x: 0..2147 */
#define OS_SEC2TICKS_OsCounter(x) ((TickType)((((osTimeComputationType)(x)) * 500.000)+0.5)) /* valid range for x: 0..8589934 */
#define OS_TICKS2SEC_OsCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 0.00200000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_US2TICKS_OsCounter(x) ((TickType)((((osTimeComputationType)(x)) * 0.000500000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2US_OsCounter(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 2000.00)+0.5)) /* valid range for x: 0..2147483 */
/* Counters */
...
#define Task_10msBsw_Appl10 ((TaskType)10)
#define Task_100ms_Appl10 ((TaskType)11)
#define Task_100ms_Appl6 ((TaskType)12)
#define osSystemBasicTask ((TaskType)13)
...
void Task_100ms_Appl6func(void);
...
#define osdIsrCanIsrStatus_2Cat 2
#define osdIsrCanIsrTx_0Cat 2
#define osdIsrCanIsrTx_1Cat 2
#define osdIsrCanIsrTx_2Cat 2
...
#define osdIsrosMemoryProtectionViolationCat 1
#define osdIsrosPrivilegedInstructionExceptionCat 1
...
#define CanIsrStatus_2 ((ISRType)4)
#define CanIsrTx_0 ((ISRType)5)
#define CanIsrTx_1 ((ISRType)6)
#define CanIsrTx_2 ((ISRType)7)
#define MCU_ECM_EIC_CAT2_ISR ((ISRType)8)
#define SPI_CSIG0_TIC_CAT2_ISR ((ISRType)9)
#define SPI_CSIG0_TIRE_CAT2_ISR ((ISRType)10)
#define SPI_CSIG0_TIR_CAT2_ISR ((ISRType)11)
#define SPI_CSIH0_TIC_CAT2_ISR ((ISRType)12)
#define SPI_CSIH0_TIRE_CAT2_ISR ((ISRType)13)
#define SPI_CSIH0_TIR_CAT2_ISR ((ISRType)14)
#define SPI_CSIH2_TIC_CAT2_ISR ((ISRType)15)
#define SPI_CSIH2_TIRE_CAT2_ISR ((ISRType)16)
#define SPI_CSIH2_TIR_CAT2_ISR ((ISRType)17)
#define SnsrMeasStrtIrq ((ISRType)18)
#define osOstmInterrupt_c0 ((ISRType)19)
#define osSystemCat2ISR ((ISRType)20)
...
void CanIsrStatus_2func(void);
void CanIsrTx_0func(void);
void CanIsrTx_1func(void);
void CanIsrTx_2func(void);
...
void CanIsrStatus_2_CAT2(void);
void CanIsrTx_0_CAT2(void);
void CanIsrTx_1_CAT2(void);
void CanIsrTx_2_CAT2(void);
...
#define Rte_Al_TE_Task_100ms_Appl6_0_100ms ((AlarmType)3)
#define Rte_Al_TE_Task_10ms_Appl10_0_10ms ((AlarmType)4)
#define Rte_Al_TE_Task_10ms_Appl6_0_10ms ((AlarmType)5)
...
#pragma ghs startdata
#pragma alignvar(16)
extern const osuint32 osSysCallTable[osdNumberOfSysCallFunctions];
#pragma ghs enddata
...
#define osSystemResource ((ResourceType)1)
...
/* END OF C:\_synergy\G2KCAT3_CZ8L9T\GM_G2KCA_EPS_RH850\generate\tcb.h */
