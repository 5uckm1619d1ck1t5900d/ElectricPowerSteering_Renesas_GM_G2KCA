/* file: C:/_synergy/G2KCAT3_CZ8L9T/GM_G2KCA_EPS_RH850/generate/trustfct.c */
...
{
   (void) CallTrustedFunction(osd_TFCT_IninSciDtsChMstReg, (TrustedFunctionParameterRefType)0);
}
 ...
 * this prototype is required by the AUTOSAR specification.
 */
void TRUSTED_IninSciDtsChMstReg(TrustedFunctionIndexType FunctionIndex, TrustedFunctionParameterRefType FunctionParams)  /* PRQA S 1505, 3673 */
{
   /* osdDummyRead might intentionally assign a value to an unused variable on
    * some platforms to avoid compiler warnings. This is no MISRA error. (3199) */
   osdDummyRead(FunctionIndex)   /* PRQA S 3199 */
