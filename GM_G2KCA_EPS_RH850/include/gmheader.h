...
#define PART_NO_APPLICATION   84235164u  /* DID C1 ESP A*/
#elif defined (DUALECUSELECT_EPSB_SELECTED)
#define PART_NO_APPLICATION   84235206u  /* DID C1 EPS B*/
#else
...
#if defined(DUALECUSELECT_EPSA_SELECTED)
#define DLS_APPLICATION  0x4141  /* ASCII "AA" - DID D1 EPS A */
#elif defined (DUALECUSELECT_EPSB_SELECTED)
#define DLS_APPLICATION  0x4141  /* ASCII "AA" - DID D1 EPS B */
#else
#error "No ECU selected."
#endif

#define DLS_CALIBRATION1 0x4145  /* ASCII "AE" - Region 01 - System Cals - DID D4 */
#define DLS_CALIBRATION2 0x4145  /* ASCII "AE" - Region 02 - Feature Cals - DID D3 */
#define DLS_CALIBRATION3 0x4145  /* ASCII "AE" - Region 03 - Performance Cals - DID D2 */
...
#define DCID_CALIBRATION     0x8202u
