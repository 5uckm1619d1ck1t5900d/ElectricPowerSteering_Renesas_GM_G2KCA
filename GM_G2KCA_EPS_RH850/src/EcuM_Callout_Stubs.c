 ...
 *   Generation Time: 2016-07-19 11:19:43
 ...
 *********************************************************************************************************************/
  ...
  {
    EcuM_SelectShutdownTarget(ECUM_STATE_RESET, EcuMConf_EcuMResetMode_ECUM_RESET_WAKEUP);
  }
 ...
 *********************************************************************************************************************/
 ...
 SYSRESFC = CLEARRESETSOURCES_CNT_U32;
 Mcu_PerformReset();
 while(1);
...
FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne(void)
{
  ...
  EcmOutpAndDiagcInit3();  /* JWJ: EcmOutpAndDiagcInit3 needs to be called before Mcu_Init */
  Mcu_Init(McuModuleConfiguration);
  Mcu_InitClock(McuConf_McuClockSettingConfig_McuClockSettingConfig);
  Mcu_InitRamSection(McuConf_McuRamSectorSettingConf_DummySection);
  EcmOutpAndDiagcInit4(); /* JWJ: EcmOutpAndDiagcInit4 needs to be called immediately after MCU Init */
  EcmOutpAndDiagcInit1(); /* JWJ: EcmOutpAndDiagcInit1 needs to be called immediately after EcmOutpAndDiagcInit4 */
  Spi_Init(SpiDriver);
