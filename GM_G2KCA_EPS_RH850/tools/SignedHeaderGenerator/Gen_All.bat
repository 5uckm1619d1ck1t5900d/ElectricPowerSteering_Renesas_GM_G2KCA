...
%HEXVIEW_EXE% ../output/g2kca.hex %SILENT%  /AR:0x18000-0xB7DFF /XI:16 -o g2kca_Appl%PEXT%.hex
%HEXVIEW_EXE% ../output/g2kca.hex %SILENT%  /AR:0xC0000-0xDFDFF /XI:16 -o g2kca_Cal1%PEXT%.hex
%HEXVIEW_EXE% ../output/g2kca.hex %SILENT%  /AR:0xB8000-0xBFDFF /XI:16 -o g2kca_Cal2%PEXT%.hex
%HEXVIEW_EXE% ../output/g2kca.hex %SILENT%  /AR:0xE0000-0xFFDFF /XI:16 -o g2kca_Cal3%PEXT%.hex

call :GenCalHeaders "g2kca_Cal1"
call :GenCalHeaders "g2kca_Cal2"
call :GenCalHeaders "g2kca_Cal3"

call :GenAppHeaders "g2kca_Appl"
...
%HEXVIEW_EXE% %SILENT% g2kca_Appl%SEXT%.hex /XI:16 –o g2kca_Appl%SEXT%.hex
%HEXVIEW_EXE% %SILENT% g2kca_Cal1%SEXT%.hex /XI:16 –o g2kca_Cal1%SEXT%.hex
%HEXVIEW_EXE% %SILENT% g2kca_Cal2%SEXT%.hex /XI:16 –o g2kca_Cal2%SEXT%.hex
%HEXVIEW_EXE% %SILENT% g2kca_Cal3%SEXT%.hex /XI:16 –o g2kca_Cal3%SEXT%.hex
