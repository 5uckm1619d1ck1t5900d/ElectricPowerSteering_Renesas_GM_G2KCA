...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_SerlComInpProxy_SetRxSigGroup_Oper(uint8 SigGroup_Arg, ImcArbnRxDataSrc1 DataSrc_Arg, P2CONST(uint8, AUTOMATIC, RTE_SERLCOMINPPROXY_APPL_DATA) Buf_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_SerlComInpProxy_SetRxSigGroup_Oper(uint8 SigGroup_Arg, ImcArbnRxDataSrc1 DataSrc_Arg, P2CONST(Ary1D_u8_8, AUTOMATIC, RTE_SERLCOMINPPROXY_APPL_DATA) Buf_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
...
# define Rte_Call_SetRxSigGroup_Oper Rte_Call_SerlComInpProxy_SetRxSigGroup_Oper
...
#    error "The magic number of the generated file <C:/_synergy/Componentes/MM000B_SerlComInpProxy_Impl-CZ8L9T/MM000B_SerlComInpProxy_Impl/tools/contract/Rte_SerlComInpProxy.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
