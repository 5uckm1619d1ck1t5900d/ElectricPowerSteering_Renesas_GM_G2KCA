...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_SerlComOutpProxy_GetTxSigGroup_Oper(uint8 SigGroupId_Arg, P2VAR(uint8, AUTOMATIC, RTE_SERLCOMOUTPPROXY_APPL_VAR) Buf_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_SerlComOutpProxy_SetRxSigGroup_Oper(uint8 SigGroup_Arg, ImcArbnRxDataSrc1 DataSrc_Arg, P2CONST(uint8, AUTOMATIC, RTE_SERLCOMOUTPPROXY_APPL_DATA) Buf_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_SerlComOutpProxy_SetRxSigGroup_Oper(uint8 SigGroup_Arg, ImcArbnRxDataSrc1 DataSrc_Arg, P2CONST(Ary1D_u8_8, AUTOMATIC, RTE_SERLCOMOUTPPROXY_APPL_DATA) Buf_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
 ...
 *********************************************************************************************************************/
# define Rte_Call_GetTxSigGroup_Oper Rte_Call_SerlComOutpProxy_GetTxSigGroup_Oper
...
# define Rte_Call_SetRxSigGroup_Oper Rte_Call_SerlComOutpProxy_SetRxSigGroup_Oper
...
#   if RTE_MAGIC_NUMBER != 1486396996
#    error "The magic number of the generated file <C:/_synergy/Componentes/MM500B_SerlComOutpProxy_Impl-CZ8L9T/MM500B_SerlComOutpProxy_Impl/tools/contract/Rte_SerlComOutpProxy.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1486396996
