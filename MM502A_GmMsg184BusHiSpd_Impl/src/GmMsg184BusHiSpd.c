...
#define GMMSG184BUSHISPDLKAPRMNTFAILD_CNT_U08  3U
 ...
 *********************************************************************************************************************/
	...
	VAR(float32, AUTOMATIC) HandsOnWhlEstim_Uls_T_f32;
	...
	/* Read inputs */
	(void)Rte_Read_HandsOnWhlEstim_Val(&HandsOnWhlEstim_Uls_T_f32);
	...
	if (HandsOnWhlEstim_Uls_T_f32 > Rte_Prm_GmMsg184BusHiSpdHandsOnThd_Val())
	{
	...
	{
		LkaTqOvrlTqDlvdSts_Cnt_T_u08 = GMMSG184BUSHISPDLKAPRMNTFAILD_CNT_U08;
	}
	else
	{
