 ...
 *  Generated at:  Tue Aug 30 12:50:22 2016
 *
...
# define Rte_InitValue_HandsOnWhlEstim_Val (0.0F)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmMsg184BusHiSpd_HandsOnWhlEstim_Val(P2VAR(float32, AUTOMATIC, RTE_GMMSG184BUSHISPD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmMsg184BusHiSpd_SysStFltOutpReqDi_Logl(P2VAR(boolean, AUTOMATIC, RTE_GMMSG184BUSHISPD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(float32, RTE_CODE) Rte_Prm_GmMsg184BusHiSpd_GmMsg184BusHiSpdHandsOnThd_Val(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
# define Rte_Read_HandsOnWhlEstim_Val Rte_Read_GmMsg184BusHiSpd_HandsOnWhlEstim_Val
...
# define Rte_Read_SysStFltOutpReqDi_Logl Rte_Read_GmMsg184BusHiSpd_SysStFltOutpReqDi_Logl
...
# define Rte_Prm_GmMsg184BusHiSpdHandsOnThd_Val Rte_Prm_GmMsg184BusHiSpd_GmMsg184BusHiSpdHandsOnThd_Val
 ...
 *   ---------------------------------------------
 *   float32 Rte_Prm_GmMsg184BusHiSpdHandsOnThd_Val(void)
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_HandsOnWhlEstim_Val(float32 *data)
...
#   if RTE_MAGIC_NUMBER != 1472568081
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Sandbox/MM502A_GmMsg184BusHiSpd_Impl/tools/contract/Rte_GmMsg184BusHiSpd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1472568081
