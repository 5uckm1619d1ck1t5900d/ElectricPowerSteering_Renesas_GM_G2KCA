 ...
 *********************************************************************************************************************/
	...
	(void)Rte_Read_HwAgStsToSerlCom_Logl(&HwAgVld_Cnt_T_logl);
	...
	/* Handle handwheel velocity validity */
	/* Handwheel velocity is calculated by motor velocity, so the validity of motor angle goes sour, so does HW velocity */
	if (MotAgLoaMtgtnEna_Cnt_T_logl == FALSE)
	{
