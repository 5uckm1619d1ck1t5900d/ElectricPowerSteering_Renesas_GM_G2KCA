 ...
 *  Generated at:  Tue Aug 30 11:37:38 2016
 *
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmMsg1E5BusHiSpd_HwAgStsToSerlCom_Logl(P2VAR(boolean, AUTOMATIC, RTE_GMMSG1E5BUSHISPD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_GmMsg1E5BusHiSpd_MotAgLoaMtgtnEna_Logl(P2VAR(boolean, AUTOMATIC, RTE_GMMSG1E5BUSHISPD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Read_HwAgStsToSerlCom_Logl Rte_Read_GmMsg1E5BusHiSpd_HwAgStsToSerlCom_Logl
...
# define Rte_Read_MotAgLoaMtgtnEna_Logl Rte_Read_GmMsg1E5BusHiSpd_MotAgLoaMtgtnEna_Logl
...
#   if RTE_MAGIC_NUMBER != 1472574185
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Sandbox/MM503A_GmMsg1E5BusHiSpd_Impl/tools/contract/Rte_GmMsg1E5BusHiSpd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1472574185
