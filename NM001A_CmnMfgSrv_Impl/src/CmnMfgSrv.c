 ...
 *          File:  CmnMfgSrv.c
 *     SW-C Type:  CmnMfgSrv
 *  Generated at:  Thu Jul 14 08:40:54 2016
 *
...
/* Local Definitions */
/* ------------------------------------------------------------------------------------------------------------------ */
#define CMNMFGSRV_MECPRODUCTION		0x00U
#define CMNMFGSRV_MECENGINEERING	0xFFU
 ...
 *********************************************************************************************************************/
	...
	/* No data to be returned unless the service is actually executed, so start with zero */
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CmnMfgSrvInit
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
...
FUNC(void, CmnMfgSrv_CODE) CmnMfgSrvInit(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CmnMfgSrvInit
 *********************************************************************************************************************/
	...
	if (*Rte_Pim_NxtrMfgEnaCntr() == 0x00U)
	{
		MfgEnaSt_Cnt_T_enum = MFGENAST_PRDNMOD;
	}
	else if (*Rte_Pim_NxtrMfgEnaCntr() == 0xFFU)
	{
	...
	/* If a reset request is stored in NvM (indicating that a reset service was previously issued) honor the positive
	 * response expected at power up */
	/* if (*Rte_Pim_RstReqd() != 0U) */
	/* { */
	/* Return a positive response for the reset service */
	/* 	DataBuf_Cnt_T_u08[0U] = 0x51U; */
	/* 	DataBuf_Cnt_T_u08[1U] = *Rte_Pim_RstReqd(); */
	...
	/* Clear the reset flag in NvM */
	/* 	*Rte_Pim_RstReqd() = 0U; */
	/* 	(void)Rte_Call_NvmRstReqd_SetRamBlockStatus(TRUE); */
	/* } */
