...
# if ((NVM_DEV_ERROR_DETECT == STD_ON) && (NVM_CFG_CHK_PARAM_BLOCKID == STD_ON)) || (NVM_KILL_WRITEALL_API == STD_ON)
/**********************************************************************************************************************
 * NvM_CheckBlockId
 *********************************************************************************************************************/
...
# if(NVM_CFG_CHK_PARAM_DATAINDEX == STD_ON)
/**********************************************************************************************************************
...
# if(NVM_CFG_CHK_PARAM_POINTER == STD_ON)
/**********************************************************************************************************************
 * NvM_CheckNotNull
 *********************************************************************************************************************/
...
# if(NVM_CFG_CHK_STATUS_UNINIT == STD_ON)
/**********************************************************************************************************************
...
# if(NVM_CFG_CHK_BLOCK_PENDING == STD_ON)
/**********************************************************************************************************************
...
# if (NVM_CFG_CHK_STATUS_UNINIT == STD_ON) /* ECO_IGNORE_LINE */
...
# if (NVM_CFG_CHK_PARAM_BLOCKID == STD_ON) /* ECO_IGNORE_LINE */
    if(NvM_CheckBlockId(BlockId) == FALSE)
    {
        detErrorId = NVM_E_PARAM_BLOCK_ID;
    }
    else
# endif /* ECO_IGNORE_LINE */
# if (NVM_CFG_CHK_BLOCK_PENDING == STD_ON) /* ECO_IGNORE_LINE */
...
# endif /* ECO_IGNORE_LINE */
# if (NVM_CFG_CHK_PARAM_DATAINDEX == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_CheckDataIndex(BlockId, DataIndex) == FALSE)
    {
...
# endif /* ECO_IGNORE_LINE */
#endif /* ECO_IGNORE_LINE */
    {
        ...
        {
#if(NVM_CFG_CHK_MNGMT_TYPE == STD_ON) /* ECO_IGNORE_LINE */
...
# if (NVM_CFG_CHK_PARAM_POINTER == STD_ON) /* ECO_IGNORE_LINE */
...
#  endif /* ECO_IGNORE_LINE */
#  if (NVM_CFG_CHK_PARAM_DATAINDEX == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_CheckCurrDataIndex(BlockId) == FALSE)
    {
        detErrorId = NVM_E_PARAM_BLOCK_DATA_IDX;
    }
    else
...
# endif /* ECO_IGNORE_LINE */
# if (NVM_CFG_CHK_PARAM_POINTER == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_CheckNotNull(RequestResultPtr) == FALSE) /* SBSW_NvM_FuncCall_PtrParam_ParamChecker */
    {
        detErrorId = NVM_E_PARAM_DATA;
    }
    else
...
# endif
        ...
        {
#  if (NVM_CFG_CHK_MNGMT_TYPE == STD_ON)
            detErrorId = NVM_E_PARAM_BLOCK_TYPE;
#  endif
        }
    }
...
#  endif /* ECO_IGNORE_LINE */
#  if (NVM_CFG_CHK_PARAM_POINTER == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_CheckAddress(BlockId, NvM_DstPtr) == FALSE) /* SBSW_NvM_FuncCall_PtrParam_ParamChecker */
    {
...
#  endif /* ECO_IGNORE_LINE */
#  if (NVM_CFG_CHK_PARAM_POINTER == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_CheckAddress(BlockId, NvM_SrcPtr) == FALSE) /* SBSW_NvM_FuncCall_PtrParam_ParamChecker */
    {
        detErrorId = NVM_E_PARAM_ADDRESS;
    }
    else
...
#  endif /* ECO_IGNORE_LINE */
#  if (NVM_CFG_CHK_MNGMT_TYPE == STD_ON) /* ECO_IGNORE_LINE */
    if ((NvM_BlockDescriptorTable_at[NVM_BLOCK_FROM_DCM_ID(BlockId)].RomBlockDataAddr_pt == NULL_PTR) &&
...
#  endif /* ECO_IGNORE_LINE */
#  if (NVM_CFG_CHK_PARAM_BLOCKID == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_BlockDescriptorTable_at[NVM_BLOCK_FROM_DCM_ID(BlockId)].BlockPrio_u8 != 0)
    {
        detErrorId = NVM_E_BLOCK_CONFIG;
    }
    else
...
# endif /* ECO_IGNORE_LINE */
# if (NVM_CFG_CHK_BLOCK_PENDING == STD_ON) /* ECO_IGNORE_LINE */
    if (NvM_CheckMultiBlockPending() == TRUE)
    {
        detErrorId = NVM_E_BLOCK_PENDING;
    }
    else
 ...
 *
 */
FUNC(void, NVM_PUBLIC_CODE) NvM_SetBlockLockStatus(NvM_BlockIdType BlockId, boolean Locked)
{
    uint8 detErrorId = NVM_E_NO_ERROR;
 ...
 *
 */
NVM_LOCAL boolean NvM_WriteProtectionChecks(const NvM_RamMngmtConstPtrType mngmtPtr)
{
 ...
 *
*/
NVM_LOCAL boolean NvM_CheckBlockType(const NvM_BlockIdType BlockId)
{
    /* PRQA S 3760 1 */ /* MD_NvM_10.1 */
    return (boolean)((NvM_BlockDescriptorTable_at[NVM_BLOCK_FROM_DCM_ID(BlockId)].MngmtType_t & NVM_BLOCK_DATASET) != 0);
}

# if (((NVM_DEV_ERROR_DETECT == STD_ON) && (NVM_CFG_CHK_PARAM_POINTER == STD_ON)) || (NVM_SET_RAM_BLOCK_STATUS_API == STD_ON))
/**********************************************************************************************************************
*  NvM_CheckAddress
**********************************************************************************************************************/
/*!
