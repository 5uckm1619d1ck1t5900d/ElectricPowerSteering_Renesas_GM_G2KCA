...
/* PRQA S 3206 13 */ /* Following three functions are intended to be empty; their function parameters are not used; signatures resulted from generalization */
