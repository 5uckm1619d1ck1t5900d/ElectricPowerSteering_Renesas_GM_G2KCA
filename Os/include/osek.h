...
/* KB end osekHWConfigBlockStartAddrSpecific */  
   ...
   osuint16 uiNumberOfDynamicMpuRegions; /* = osdNumberOfDynamicMpuRegions */
...
/* KB begin osekHWConfigBlockSubContainersSpecific (overwritten) */
   ...
   /* Sub-Container 32 */
   const tsOsMPUConfig        osMPUConfig;
   /* Sub-Container 33 */
...
#define osdSysCallLastIndex                   76    
#define osdNumberOfSysCallFunctions           77
