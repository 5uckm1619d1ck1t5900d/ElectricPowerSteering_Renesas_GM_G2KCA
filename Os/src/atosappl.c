...
|               C O P Y R I G H T
|-----------------------------------------------------------------------------
| Copyright (c) 2006-2014 Vector Informatik GmbH          All rights reserved.
|****************************************************************************/
                                                       ...
                                                       ObjectIDType      ObjectId)
{
   ...
   IF2ANDCOVER( (ApplID < osdNumberOfApplications) , (ObjectType < osdNumberOfObjectTypes),0x0487,0x0488,0x0489)
...
/*-+--------------------------------------------------------------------------
 ...
 / Scalability Classes: SC3, SC4
 /--------------------------------------------------------------------------*/
/* MISRA RULE 14.1 VIOLATION: The function osCallTrustedFunction is an API function which might be unused */
