...
osqFunc1 void osqFunc2 osShutdownOS(StatusType Error) /* PRQA S 1503 */ /* PRQA S 1505 */ /* PRQA S 3206 */ /* PRQA S 3199 */
{
   ...
   IF3ANDCOVER(appID < osdNumberOfApplications, osConfigBlock.applTrusted[appID] == 0, ((osdCtxErrorHook | osdCtxStartupHook) & osOwnCcb->LockIsNotNeeded.ossCurrentContext) == 0,0x00EC,0x00ED,0x00EE,0x00EF)
...
osqFunc1 osStackUsageType osqFunc2 osGetSystemStackUsage(void) /* PRQA S 1503 */
{
   ...
   IF2ANDCOVER((stackPtr < (osuint32*)osConfigBlock.SystemStack[osSysGetCoreID()].end), (*stackPtr == osdStackCheckPattern),0x00E0,0x00E1,0x00E2)   
...
osqFunc1 osStackUsageType osqFunc2 osGetStackUsage(TaskType taskId) /* PRQA S 1503 */
{
   ...
   osuint32 *stackPtr;
   COVER(0x0022) 
   IFCOVER(taskId < osdNumberOfAllTasks,0x00D8,0x00D9)
   ...
   IF2ANDCOVER((stackPtr < (osuint32*)osConfigBlock.aulTaskStackEndAddress[taskId]), (*stackPtr == osdStackCheckPattern),0x00E3,0x00E4,0x00E5)
...
osqFunc1 osStackUsageType osqFunc2 osGetISRStackUsage(ISRType isrId) /* PRQA S 1503 */
{
   ...
   osuint32 *stackPtr;
   COVER(0x0025)   
   IFCOVER(isrId < osdNumberOfCat2ISRs,0x00DA,0x00DB)
   ...
   IFCOVER(stackPtr != osdNULL,0x00DC,0x00DD)
   if (stackPtr != osdNULL)
   {
      IF2ANDCOVER((stackPtr < (osuint32*)(osConfigBlock.osCat2IsrStacks[isrId].end)) , (*stackPtr == osdStackCheckPattern),0x00E6,0x00E7,0x00E8)
...
osqFunc1 void osqFunc2 osInitTcb(void)
{
   ...
   IFCOVER(0 >= osConfigBlock.uiNumberOfTasks,0x00DE,0x00DF)
   ...
   else
   {
      ...
      if (osTcbTaskState[taskIndex] == PRE_READY)
      {
         ...
         if(osConfigBlock.aucTaskTrusted[taskIndex] == 0)
         {
            ...
            osSetMpuConfig((osuint32)&osConfigBlock.applMPUConfig[ptrToCcb2->ossActiveApplicationID]);
...
#if defined(osdTimerCompareRegValCore0) && defined(osdTimerInterruptSourceNumberCore0)
...
#define osCheckMPAT(regnr) \
        if(osGetMPAT##regnr() != osConfigBlock.osMPUConfig.osMPAT##regnr) \
        {osSetMPAT##regnr(osConfigBlock.osMPUConfig.osMPAT##regnr); \
         result = E_OS_SYS_API_ERROR;} /* PRQA S 881 */

/* MISRA RULE 19.12 not violated: The operator ## is used for symbol assignment in this macro. */         
#define osCheckMPUConfig(regnr) \
        if((osGetMPLA##regnr() != osConfigBlock.osMPUConfig.osMPLA##regnr) || \
           (osGetMPUA##regnr() != osConfigBlock.osMPUConfig.osMPUA##regnr) || \
           (osGetMPAT##regnr() != osConfigBlock.osMPUConfig.osMPAT##regnr))   \
...
{  
   ...
   #if osdNumberOfDynamicMpuRegions>0      
   osCheckMPAT(1)
   #endif
   #if osdNumberOfDynamicMpuRegions>1   
   osCheckMPAT(2)   
   #endif
   #if osdNumberOfDynamicMpuRegions>2      
   osCheckMPAT(3)
   #endif                                 
   #if osdNumberOfDynamicMpuRegions>3   
   osCheckMPAT(4)   
   #endif
   #if osdNumberOfDynamicMpuRegions>4   
   osCheckMPAT(5)   
   #endif 
   #if osdNumberOfDynamicMpuRegions>5                     
   osCheckMPAT(6)   
   #endif                     
   #if osdNumberOfDynamicMpuRegions>6      
   osCheckMPAT(7)   
   #endif                  
   #if osdNumberOfDynamicMpuRegions>7   
   osCheckMPAT(8)   
   #endif                  
   #if osdNumberOfDynamicMpuRegions>8   
   osCheckMPAT(9)   
   #endif                 
   #if osdNumberOfDynamicMpuRegions>9
   osCheckMPAT(10)   
   #endif                                                          
   #if osdNumberOfDynamicMpuRegions>10
   osCheckMPAT(11)   
   #endif
   #if osdNumberOfDynamicMpuRegions>11
   osCheckMPAT(12)   
   #endif
   #if osdNumberOfDynamicMpuRegions>12
   osCheckMPAT(13)   
   #endif
   #if osdNumberOfDynamicMpuRegions>13
   osCheckMPAT(14)   
   #endif
   #if osdNumberOfDynamicMpuRegions>14
   osCheckMPAT(15)   
   #endif
   ...
   #endif                            
   #if (osdNumberOfDynamicMpuRegions < 15)
   /* MISRA RULE 12.4 not violated: Reading the variable MPU registers is sideeffect free. */
...
osqFunc1 osuint32 osqFunc2 osCallCat2ISR(ISRType ISRID) /* PRQA S 1503 */
{
   ...
   retVal = 0;   
      ...
      if((osEICn & 0x000FU) != (osuint16)osGetLevelISPR())
      {       
      ...
      if(ptrToCcb->ossStartDispatcher == osdTRUE)
      {
         ...
         ELSEWITHCOVER(0x0064)
      }
      ELSEWITHCOVER(0x0065)
      #endif
...
osqFunc1 StatusType osqFunc2 osPsysGetTaskID(TaskRefType Param0_TaskId) /* PRQA S 1503 */
{
   ...
   {
      COVER(0x0067)      
      retVal = osPsysCallGetTaskID(&Index);
      *Param0_TaskId = Index;
   }
   else
   {
...
osqFunc1 StatusType osqFunc2 osPsysGetTaskState(TaskType Param0_TaskId, TaskStateRefType Param1_State) /* PRQA S 1503 */
{
   ...
   {   
      COVER(0x006A)
      retVal = osPsysCallGetTaskState(Param0_TaskId, &State);
      *Param1_State = State;
   }
   else
   {
...
osqFunc1 StatusType osqFunc2 osPsysGetApplicationState(ApplicationType Param0_Application, ApplicationStateRefType Param1_Value) /* PRQA S 1503 */
{
   ...
   {
      COVER(0x006D)            
      retVal = osPsysCallGetApplicationState(Param0_Application, &State);
      *Param1_Value = State;
   }
   else
   {
...
osqFunc1 StatusType osqFunc2 osPsysGetEvent(TaskType Param0_taskIndex, EventMaskRefType Param1_Event) /* PRQA S 1503 */
{
   ...
   {   
      COVER(0x0070)         
      retVal = osPsysCallGetEvent(Param0_taskIndex, &Event);
      *Param1_Event = Event;
   }
   else
   {
...
osqFunc1 StatusType osqFunc2 osPsysGetAlarm(AlarmType Param0_alarmID, TickRefType Param1_diffTickTime) /* PRQA S 1503 */
{
   ...
   {      
      COVER(0x0073)   
      retVal = osPsysCallGetAlarm(Param0_alarmID, &DiffTickTime);
...
osqFunc1 StatusType osqFunc2 osPsysGetScheduleTableStatus(ScheduleTableType Param0_ScheduleTableID, ScheduleTableStatusRefType Param1_ScheduleStatus) /* PRQA S 1503 */
{
   ...
   {
      COVER(0x0076)   
      retVal = osPsysCallGetScheduleTableStatus(Param0_ScheduleTableID, &ScheduleStatus);
...
osqFunc1 StatusType osqFunc2 osPsysGetCounterValue(CounterType Param0_CounterID, TickRefType Param1_Value) /* PRQA S 1503 */
{
   ...
   {     
      COVER(0x0079)      
      retVal = osPsysCallGetCounterValue(Param0_CounterID, &Value);
      *Param1_Value = Value;
   }
   else
   {
...
osqFunc1 StatusType osqFunc2 osPsysGetElapsedValue(CounterType Param0_CounterID, TickRefType Param1_Value, TickRefType Param2_ElapsedValue) /* PRQA S 1503 */
{
   ...
   if(osAmINotTrusted())    
   {
      ...
      retVal = osPsysCallGetElapsedValue(Param0_CounterID, &Value, &ElapsedValue);
      *Param1_Value = Value;
 ...
 */
   IF2ANDCOVER((osOwnCcb->LockIsNotNeeded.ossLockDispatcher == 0) , (osOwnCcb->LockIsNeeded.ossStartDispatcher != osdFALSE),0x00E9,0x00EA,0x00EB)
