...
osqFunc1 StatusType osqFunc2 osChainTask(TaskType taskIndex)   /* PRQA S 1503 */
{
   ...
   if (taskIndex != activeTaskID)
   {
      ...
      ELSEWITHCOVER(0x030A)
   }
   ELSEWITHCOVER(0x030B)
