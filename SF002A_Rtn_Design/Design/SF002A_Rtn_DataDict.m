%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 15-Jun-2016 14:10:06       %
...
SF002A.Description = [...
  ...
  'ward center as a function of output position and vehicle speed'];
...
RtnPer1.Description = 'Return Periodic Runnable';
...
HwAgAuthySca.LongName = 'Handwheel Authority Scale';
HwAgAuthySca.Description = 'Handwheel Authority Scale';
...
RtnCmdScaServo.LongName = 'Return Command Servo Scale';
RtnCmdScaServo.Description = 'Return Command Servo Scale';
