%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 07-Jul-2015 09:49:17       %
%                                  Created with tool release: 2.14.0     %
%%-----------------------------------------------------------------------%

SF003A = DataDict.FDD;
SF003A.Version = '1.0.X';
...
DampgHwTqX.ProgrammedBy = 'Nexteer';
DampgHwTqX.Cardinality = 'R';
...
DampgHwTqX.CoderInfo.CustomAttributes.PortName = 'DampgHwTqX';
...
DampgHwTqY.EngMin = 0;
DampgHwTqY.EngMax = 1;
DampgHwTqY.ProgrammedBy = 'Nexteer';
DampgHwTqY.Cardinality = 'R';
...
DampgHwTqY.CoderInfo.CustomAttributes.PortName = 'DampgHwTqY';
...
DampgHydAssiLim.ProgrammedBy = 'Nexteer';
DampgHydAssiLim.Cardinality = 'I';
...
DampgHydAssiLim.CoderInfo.CustomAttributes.PortName = 'DampgHydAssiLim';
...
DampgHydBasCoeff1.ProgrammedBy = 'Nexteer';
DampgHydBasCoeff1.Cardinality = 'I';
...
DampgHydBasCoeff1.CoderInfo.CustomAttributes.PortName = 'DampgHydBasCoeff1';
...
DampgHydBasCoeff2.ProgrammedBy = 'Nexteer';
DampgHydBasCoeff2.Cardinality = 'I';
...
DampgHydBasCoeff2.CoderInfo.CustomAttributes.PortName = 'DampgHydBasCoeff2';
...
DampgHydBasCoeff3.ProgrammedBy = 'Nexteer';
DampgHydBasCoeff3.Cardinality = 'I';
...
DampgHydBasCoeff3.CoderInfo.CustomAttributes.PortName = 'DampgHydBasCoeff3';
...
DampgHydBasCoeff4.ProgrammedBy = 'Nexteer';
DampgHydBasCoeff4.Cardinality = 'I';
...
DampgHydBasCoeff4.CoderInfo.CustomAttributes.PortName = 'DampgHydBasCoeff4';
...
DampgHydCoeff1ScaY.ProgrammedBy = 'Nexteer';
DampgHydCoeff1ScaY.Cardinality = 'R';
...
DampgHydCoeff1ScaY.CoderInfo.CustomAttributes.PortName = 'DampgHydCoeff1ScaY';
...
DampgHydCoeff2ScaY.ProgrammedBy = 'Nexteer';
DampgHydCoeff2ScaY.Cardinality = 'R';
...
DampgHydCoeff2ScaY.CoderInfo.CustomAttributes.PortName = 'DampgHydCoeff2ScaY';
...
DampgHydCoeff3ScaY.ProgrammedBy = 'Nexteer';
DampgHydCoeff3ScaY.Cardinality = 'R';
...
DampgHydCoeff3ScaY.CoderInfo.CustomAttributes.PortName = 'DampgHydCoeff3ScaY';
...
DampgHydCoeff4ScaY.ProgrammedBy = 'Nexteer';
DampgHydCoeff4ScaY.Cardinality = 'R';
...
DampgHydCoeff4ScaY.CoderInfo.CustomAttributes.PortName = 'DampgHydCoeff4ScaY';
...
DampgHydOutpLim.ProgrammedBy = 'Nexteer';
DampgHydOutpLim.Cardinality = 'I';
...
DampgHydOutpLim.CoderInfo.CustomAttributes.PortName = 'DampgHydOutpLim';
...
DampgMotVelLpFilFrq.ProgrammedBy = 'Nexteer';
DampgMotVelLpFilFrq.Cardinality = 'I';
...
DampgMotVelLpFilFrq.CoderInfo.CustomAttributes.PortName = 'DampgMotVelLpFilFrq';
...
DampgMotVelX.ProgrammedBy = 'Nexteer';
DampgMotVelX.Cardinality = 'R';
...
DampgMotVelX.CoderInfo.CustomAttributes.PortName = 'DampgMotVelX';
...
DampgMotVelY.ProgrammedBy = 'Nexteer';
DampgMotVelY.Cardinality = 'R';
...
DampgMotVelY.CoderInfo.CustomAttributes.PortName = 'DampgMotVelY';
...
DampgQuad13Mplr.ProgrammedBy = 'Nexteer';
DampgQuad13Mplr.Cardinality = 'I';
...
DampgQuad13Mplr.CoderInfo.CustomAttributes.PortName = 'DampgQuad13DmpgMplr';
...
DampgQuad24Mplr.ProgrammedBy = 'Nexteer';
DampgQuad24Mplr.Cardinality = 'I';
...
DampgQuad24Mplr.CoderInfo.CustomAttributes.PortName = 'DampgQuad24DmpgMplr';
...
DampgQuadHwTqBacklsh.ProgrammedBy = 'Nexteer';
DampgQuadHwTqBacklsh.Cardinality = 'N';
...
DampgQuadHwTqBacklsh.CoderInfo.CustomAttributes.PortName = 'DampgQuadHwTqBacklsh';
...
DampgQuadHwTqLpFilFrq.ProgrammedBy = 'Nexteer';
DampgQuadHwTqLpFilFrq.Cardinality = 'I';
...
DampgQuadHwTqLpFilFrq.CoderInfo.CustomAttributes.PortName = 'DampgQuadHwTqLpFilFrq';
...
DampgQuadMotVelBacklsh.ProgrammedBy = 'Nexteer';
DampgQuadMotVelBacklsh.Cardinality = 'N';
...
DampgQuadMotVelBacklsh.CoderInfo.CustomAttributes.PortName = 'DampgQuadMotVelBacklsh';
...
DampgQuadMotVelLpFilFrq.ProgrammedBy = 'Nexteer';
DampgQuadMotVelLpFilFrq.Cardinality = 'I';
...
DampgQuadMotVelLpFilFrq.CoderInfo.CustomAttributes.PortName = 'DampgQuadMotVelLpFilFrq';
...
DampgQuadScaLpFilFrq.ProgrammedBy = 'Nexteer';
DampgQuadScaLpFilFrq.Cardinality = 'I';
...
DampgQuadScaLpFilFrq.CoderInfo.CustomAttributes.PortName = 'DampgQuadScaLpFilFrq';
...
DampgTScaX.ProgrammedBy = 'Nexteer';
DampgTScaX.Cardinality = 'I';
...
DampgTScaX.CoderInfo.CustomAttributes.PortName = 'DampgTScaX';
...
DampgTScaY.ProgrammedBy = 'Nexteer';
DampgTScaY.Cardinality = 'I';
...
DampgTScaY.CoderInfo.CustomAttributes.PortName = 'DampgTScaY';
...
MotVelDampgLpFil.DocUnits = '';
MotVelDampgLpFil.EngDT = struct.FilLpRec1;
MotVelDampgLpFil.EngMin = [];
MotVelDampgLpFil.EngMax = [];
...
PrevHydOutpLim.EngMin = -8.8;
PrevHydOutpLim.EngMax = 8.8;
...
PrevMotVelBacklshOutp.EngMin = 0;
PrevMotVelBacklshOutp.EngMax = 128;
...
QuadDampgHwTqLpFil.DocUnits = '';
QuadDampgHwTqLpFil.EngDT = struct.FilLpRec1;
QuadDampgHwTqLpFil.EngMin = [];
QuadDampgHwTqLpFil.EngMax = [];
...
QuadDampgMotVelLpFil.DocUnits = '';
QuadDampgMotVelLpFil.EngDT = struct.FilLpRec1;
QuadDampgMotVelLpFil.EngMin = [];
QuadDampgMotVelLpFil.EngMax = [];
...
QuadDampgScaLpFil.DocUnits = '';
QuadDampgScaLpFil.EngDT = struct.FilLpRec1;
QuadDampgScaLpFil.EngMin = [];
QuadDampgScaLpFil.EngMax = [];
...
FLTINJ_DAMPG_DAMPGCMDBAS.Header = 'FltInj.h';
