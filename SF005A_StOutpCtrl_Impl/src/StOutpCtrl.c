 ...
 *  Generated at:  Tue Mar 29 16:27:15 2016
 *
 ...
 *********************************************************************************************************************/
	...
	*/	
	/* REQ: SF005A #50 I */
	/* REQ: SF005A #51 I */
	if (FALSE != SysStFltOutpReqDi_Cnt_T_lgc)
	{
	...
	*Rte_Pim_StOutpCtrlPrevCmdSca()  = Sca_Uls_T_f32;	
	...
	if((OPER_CNT_U08 == ArbdSt_Cnt_T_u08) || 
	   (DI_CNT_U08   == ArbdSt_Cnt_T_u08))
	{

		SysStReqDi_Cnt_T_lgc = RampComp_Cnt_T_lgc;
	}
	else
	{
