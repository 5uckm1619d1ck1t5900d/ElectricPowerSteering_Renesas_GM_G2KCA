%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 22-Sep-2016 14:29:12       %
...
MaxLrndFric.Description = 'Output for Maximum of Learned Friction values';
...
SysFricLrngIgnCycFricChgLim.EngVal = 100;
SysFricLrngIgnCycFricChgLim.EngMin = -127;
SysFricLrngIgnCycFricChgLim.EngMax = 127;
...
SysFricLrngLatAHiLim.EngVal = 9.8;
SysFricLrngLatAHiLim.EngMin = 0;
SysFricLrngLatAHiLim.EngMax = 9.8;
...
SysFricLrngLatALoLim.EngMin = -9.8;
...
FricLrngData.EngMin = [struct('FricOffs',-5,'BasLineFric',0,'VehLrndFric',0,'Hys',0,'RngCntr',0,'SysFricLrngOperMod',SysFricLrngOperMod1.SYSFRICLRNGOPERMOD_CALIBRATION)];
...
AssiMechTLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
AssiMechTLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
AvrgFricLpFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
AvrgFricLpFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
AvrgFricLpFil3.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
AvrgFricLpFil4.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
ColTqLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
ColTqLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
FricChgLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
FricChgLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgAuthyLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgAuthyLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwVelLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwVelLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
LatALpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
LatALpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
PrevMaxRawAvrgFric.Description = [...
  'Temporary variable for storing Previous Maximum Raw Average Friction Data from NVM'];
...
SatnAvrgFric.EngMin = -127;
SatnAvrgFric.EngMax = 254;
...
SCAGFACVEHLATA_MTRPERSECSQD_F32 = DataDict.Constant;
SCAGFACVEHLATA_MTRPERSECSQD_F32.LongName = 'Scaling Factor Vehicle Lateral Acceleration';
SCAGFACVEHLATA_MTRPERSECSQD_F32.Description = [...
  'Scaling Factor for Vehicle Lateral Acceleration'];
SCAGFACVEHLATA_MTRPERSECSQD_F32.DocUnits = 'MtrPerSecSqd';
SCAGFACVEHLATA_MTRPERSECSQD_F32.EngDT = dt.float32;
SCAGFACVEHLATA_MTRPERSECSQD_F32.EngVal = 9.81;
SCAGFACVEHLATA_MTRPERSECSQD_F32.Define = 'Local';
