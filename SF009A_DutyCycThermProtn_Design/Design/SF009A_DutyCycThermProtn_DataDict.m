%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 18-Nov-2016 15:36:37       %
%                                  Created with tool release: 2.50.0     %
%                                  Synergy file: %version: 9 %           %
%                                  Derived by: %derived_by: xz3vz1 %          %
%%-----------------------------------------------------------------------%

SF009A = DataDict.FDD;
SF009A.Version = '3.0.X';
...
IvtrLoaMtgtnEna.ReadIn = {'DutyCycThermProtnPer1'};
