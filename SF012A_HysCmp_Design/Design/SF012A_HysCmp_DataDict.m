%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 06-Jan-2016 16:29:11       %
...
HysCmpFricWhlImbRejctnOffY.GraphLink = {''};
...
HysCmpFricWhlImbRejctnOnY.GraphLink = {''};
...
FLTINJ_HYSCMP_HYSCMPCMD.Header = 'FltInj.h';
...
HYSSATNLOWLIM_HWNWTMTR_F32.Header = '';
