 ...
 *********************************************************************************************************************/
	...
	if(TRUE == Rte_Prm_PullCmpActvEna_Logl())
	{
		...
		if((TRUE == PullCmpLrngDi_Cnt_T_logl) || (TRUE == PullCmpCmdDi_Cnt_T_logl) || (TRUE == PullCmpActvDi_Cnt_T_logl))
		{
		...
		if( (AbslHwAg_HwDeg_T_f32 >= Rte_Prm_PullCmpActvCmpShoTermRstHwAgThd_Val()) ||
			...
			(AbslVehYawRateFild_VehDegPerSec_T_f32 >= Rte_Prm_PullCmpActvCmpShoTermRstYawRateThd_Val()) ||
...
*                 AbslHwVel_HwRadPerSec_T_f32, PullCmpSts_Cnt_T_logl
