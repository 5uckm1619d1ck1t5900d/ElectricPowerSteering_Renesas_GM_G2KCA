%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 12-Sep-2016 17:05:47       %
...
MaxMgnFlt.EngMin = 0;
MaxMgnFlt.EngMax = 1;
MaxMgnFlt.ReadIn = {'WhlImbRejctnPer1'};
MaxMgnFlt.WrittenIn = {'WhlImbRejctnInit1'};

IniCmpFlt = DataDict.IRV;
IniCmpFlt.LongName = 'Initial Compensation Fault';
IniCmpFlt.Description = [...
  'Logic variable indicating Compensation/Persistence Fault.  Sent to Per1 for a' ...
  'NTC setting. This is checked with NVm variables during init'];
IniCmpFlt.DocUnits = 'Cnt';
IniCmpFlt.EngDT = dt.lgc;
IniCmpFlt.EngInit = 0;
IniCmpFlt.EngMin = 0;
IniCmpFlt.EngMax = 1;
IniCmpFlt.ReadIn = {'WhlImbRejctnPer2'};
IniCmpFlt.WrittenIn = {'WhlImbRejctnPer1'};
...
%%-------------------------------------------
ActvCmpBand1 = DataDict.NVM;
ActvCmpBand1.LongName = 'Active Compensation Band 1';
ActvCmpBand1.Description = [...
  'This is an EEPROM variable to store time in band for each of three bin' ...
  's of command amplitude.'];
ActvCmpBand1.DocUnits = 'Cnt';
ActvCmpBand1.EngDT = dt.u32;
ActvCmpBand1.EngInit = 0;
ActvCmpBand1.EngMin = 0;
ActvCmpBand1.EngMax = 4.294967294000000e+09;
ActvCmpBand1.CustomerVisible = false;
ActvCmpBand1.Impact = 'H';
ActvCmpBand1.TuningOwner = 'CSE';
ActvCmpBand1.CoderInfo.Alias = 'ActvCmpBand1';
ActvCmpBand1.InitRowCol = [1  1];


ActvCmpBand2 = DataDict.NVM;
ActvCmpBand2.LongName = 'Active Compensation Band 2';
ActvCmpBand2.Description = [...
  'This is an EEPROM variable to store time in band for each of three bin' ...
  's of command amplitude.'];
ActvCmpBand2.DocUnits = 'Cnt';
ActvCmpBand2.EngDT = dt.u32;
ActvCmpBand2.EngInit = 0;
ActvCmpBand2.EngMin = 0;
ActvCmpBand2.EngMax = 4.294967294000000e+09;
ActvCmpBand2.CustomerVisible = false;
ActvCmpBand2.Impact = 'H';
ActvCmpBand2.TuningOwner = 'CSE';
ActvCmpBand2.CoderInfo.Alias = 'ActvCmpBand2';
ActvCmpBand2.InitRowCol = [1  1];


ActvCmpBand3 = DataDict.NVM;
ActvCmpBand3.LongName = 'Active Compensation Band 3';
ActvCmpBand3.Description = [...
  'This is an EEPROM variable to store time in band for each of three bin' ...
  's of command amplitude.'];
ActvCmpBand3.DocUnits = 'Cnt';
ActvCmpBand3.EngDT = dt.u32;
ActvCmpBand3.EngInit = 0;
ActvCmpBand3.EngMin = 0;
ActvCmpBand3.EngMax = 4.294967294000000e+09;
ActvCmpBand3.CustomerVisible = false;
ActvCmpBand3.Impact = 'H';
ActvCmpBand3.TuningOwner = 'CSE';
ActvCmpBand3.CoderInfo.Alias = 'ActvCmpBand3';
ActvCmpBand3.InitRowCol = [1  1];


LePeakPrev = DataDict.NVM;
LePeakPrev.LongName = 'Left Peak Previous';
LePeakPrev.Description = [...
  'EEPROM variable to store peak DistMag value between ignition cycles to' ...
  ' avoid slow re-learn each ignition cycle.'];
LePeakPrev.DocUnits = 'Uls';
LePeakPrev.EngDT = dt.float32;
LePeakPrev.EngInit = [];
LePeakPrev.EngMin = 0;
LePeakPrev.EngMax = 127;
LePeakPrev.CustomerVisible = false;
LePeakPrev.Impact = 'H';
LePeakPrev.TuningOwner = 'CSE';
LePeakPrev.CoderInfo.Alias = 'LePeakPrev';
LePeakPrev.InitRowCol = [1  1];


MaxCompPerc = DataDict.NVM;
MaxCompPerc.LongName = 'Maximum Compensation Percent';
MaxCompPerc.Description = [...
  '(*** The code is actually producting a 0-100 value, but that the funct' ...
  'ion should be reworked as a 0-1 Uls for consistency with other functio' ...
  'ns. ***) EEPROM variable to store the maximum compensation percent eve' ...
  'r seen.'];
MaxCompPerc.DocUnits = 'Uls';
MaxCompPerc.EngDT = dt.float32;
MaxCompPerc.EngInit = 0;
MaxCompPerc.EngMin = 0;
MaxCompPerc.EngMax = 1;
MaxCompPerc.CustomerVisible = false;
MaxCompPerc.Impact = 'H';
MaxCompPerc.TuningOwner = 'CSE';
MaxCompPerc.CoderInfo.Alias = 'MaxCompPerc';
MaxCompPerc.InitRowCol = [1  1];


RiPeakPrev = DataDict.NVM;
RiPeakPrev.LongName = 'Right Peak Previous';
RiPeakPrev.Description = [...
  'EEPROM variable to store peak DistMag value between ignition cycles to' ...
  ' avoid slow re-learn each ignition cycle.'];
RiPeakPrev.DocUnits = 'Uls';
RiPeakPrev.EngDT = dt.float32;
RiPeakPrev.EngInit = 0;
RiPeakPrev.EngMin = 0;
RiPeakPrev.EngMax = 127;
RiPeakPrev.CustomerVisible = false;
RiPeakPrev.Impact = 'H';
RiPeakPrev.TuningOwner = 'CSE';
RiPeakPrev.CoderInfo.Alias = 'RiPeakPrev';
RiPeakPrev.InitRowCol = [1  1];
...
DlyIdxLe = DataDict.PIM;
DlyIdxLe.LongName = 'Delay Index Left';
DlyIdxLe.Description = 'Tapped Delay index Left';
DlyIdxLe.DocUnits = 'Uls';
DlyIdxLe.EngDT = dt.u08;
DlyIdxLe.EngMin = 0;
DlyIdxLe.EngMax = 30;
DlyIdxLe.InitRowCol = [1  1];


DlyIdxRi = DataDict.PIM;
DlyIdxRi.LongName = 'Delay Index Right';
DlyIdxRi.Description = 'Tapped Delay index Right';
DlyIdxRi.DocUnits = 'Uls';
DlyIdxRi.EngDT = dt.u08;
DlyIdxRi.EngMin = 0;
DlyIdxRi.EngMax = 30;
DlyIdxRi.InitRowCol = [1  1];
...
LeStVariUpd.EngMin = 0;
LeStVariUpd.EngMax = 200;
...
PhaAdjFil1Coeff1.EngMin = -127;
PhaAdjFil1Coeff1.EngMax = 127;
...
PhaAdjFil1Coeff2.EngMin = -127;
PhaAdjFil1Coeff2.EngMax = 127;
...
PhaAdjFil2Coeff1.EngMin = -127;
PhaAdjFil2Coeff1.EngMax = 127;
...
PhaAdjFil2Coeff2.EngMin = -127;
PhaAdjFil2Coeff2.EngMax = 127;
...
RiStVariUpd.EngMin = 0;
RiStVariUpd.EngMax = 200;
...
ACTIVBANDMAX_ULS_U32.EngVal =  4.294967294000000e+09;
...
DURATIONDISABLE_CNT_U16.EngVal = 65535;
...
%% NTC Definition                            
%%-------------------------------------------
WirFltNtc = DataDict.NTC;
WirFltNtc.NtcNr = NtcNr1.NTCNR_0X0A5;
WirFltNtc.NtcTyp = 'None';
WirFltNtc.LongName = 'WIR Fault NTC';
WirFltNtc.Description = 'Immediate Shutdown - trouble code 0X0A5';
WirFltNtc.NtcStInfo = DataDict.NtcStInfoBitPacked;
WirFltNtc.NtcStInfo.Bit0Descr = 'Maximum Magintude Fault';
WirFltNtc.NtcStInfo.Bit1Descr = 'Wheel Frequency Status Fault';
WirFltNtc.NtcStInfo.Bit2Descr = 'DC Trend Fault';
WirFltNtc.NtcStInfo.Bit3Descr = 'Freqeuncy Diagnostic Fault';
WirFltNtc.NtcStInfo.Bit4Descr = 'Wheel Speed Correlation Fault';
WirFltNtc.NtcStInfo.Bit5Descr = 'Maximum Persistance Fault';
WirFltNtc.NtcStInfo.Bit6Descr = 'Unused';
WirFltNtc.NtcStInfo.Bit7Descr = 'Unused';
