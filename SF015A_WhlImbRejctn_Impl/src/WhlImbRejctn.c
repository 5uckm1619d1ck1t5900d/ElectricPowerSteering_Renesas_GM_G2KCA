...
#define MICROSECTOMILLISEC_ULS_F32      0.001F
...
#define PHAADJMAX_ULS_F32               127.0F
...
static FUNC(float32, WHLIMBREJCTN_CODE) ActvRejctnCmd(float32 HwTq_HwNwtMtr_T_f32,
                                                      ...
                                                      float32 FreqEst_Hz_T_f32,
                                                      P2VAR(float32, AUTOMATIC, WhlImbRejctn_VAR) WhlImbRejctnAmp_MtrNm_T_f32);
 ...
 *********************************************************************************************************************/
    ...
    VAR(NvM_RequestResultType, AUTOMATIC)   ActvCmpBand1ErrSts_Cnt_T_enum;
	VAR(NvM_RequestResultType, AUTOMATIC)   ActvCmpBand2ErrSts_Cnt_T_enum;
	VAR(NvM_RequestResultType, AUTOMATIC)   ActvCmpBand3ErrSts_Cnt_T_enum;
	VAR(NvM_RequestResultType, AUTOMATIC)   LePeakPrevErrSts_Cnt_T_enum;
	VAR(NvM_RequestResultType, AUTOMATIC)   MaxCompPercErrSts_Cnt_T_enum;
	VAR(NvM_RequestResultType, AUTOMATIC)   RiPeakPrevErrSts_Cnt_T_enum;
    ...
    *Rte_Pim_ScaRi() = 1.0F;
	...
	/* Check NVM Data */
	(void)Rte_Call_ActvCmpBand1_GetErrorStatus(&ActvCmpBand1ErrSts_Cnt_T_enum);
	(void)Rte_Call_ActvCmpBand2_GetErrorStatus(&ActvCmpBand2ErrSts_Cnt_T_enum);
	(void)Rte_Call_ActvCmpBand3_GetErrorStatus(&ActvCmpBand3ErrSts_Cnt_T_enum);
	(void)Rte_Call_LePeakPrev_GetErrorStatus(&LePeakPrevErrSts_Cnt_T_enum);
	(void)Rte_Call_MaxCompPerc_GetErrorStatus(&MaxCompPercErrSts_Cnt_T_enum);
	(void)Rte_Call_RiPeakPrev_GetErrorStatus(&RiPeakPrevErrSts_Cnt_T_enum);
    
    if((ActvCmpBand1ErrSts_Cnt_T_enum != NVM_REQ_OK) ||
	   (ActvCmpBand2ErrSts_Cnt_T_enum != NVM_REQ_OK) ||
	   (ActvCmpBand3ErrSts_Cnt_T_enum != NVM_REQ_OK) ||
	   (LePeakPrevErrSts_Cnt_T_enum != NVM_REQ_OK) ||
	   (MaxCompPercErrSts_Cnt_T_enum != NVM_REQ_OK) ||
	   (RiPeakPrevErrSts_Cnt_T_enum != NVM_REQ_OK))
    {
        /* NVM not valid */
		*Rte_Pim_ActvCmpBand1() = 0U;
		*Rte_Pim_ActvCmpBand2() = 0U;
		*Rte_Pim_ActvCmpBand3() = 0U;
		*Rte_Pim_LePeakPrev() = 0.0F;
		*Rte_Pim_MaxCompPerc() = 0.0F;
		*Rte_Pim_RiPeakPrev() = 0.0F;
    }
	
	if((*Rte_Pim_ActvCmpBand1() == ACTIVBANDMAX_ULS_U32) ||
	   (*Rte_Pim_ActvCmpBand2() == ACTIVBANDMAX_ULS_U32) ||
	   (*Rte_Pim_ActvCmpBand3() == ACTIVBANDMAX_ULS_U32) ||
	   ((*Rte_Pim_MaxCompPerc() < 0.0F) || (*Rte_Pim_MaxCompPerc() > (ONEHALF_ULS_F32 * TWO_ULS_F32))))
    {
		*Rte_Pim_ActvCmpBand1() = 0U;
		*Rte_Pim_ActvCmpBand2() = 0U;
		*Rte_Pim_ActvCmpBand3() = 0U;
	...
	if(((*Rte_Pim_LePeakPrev() < PEAKMIN_ULS_F32) || (*Rte_Pim_LePeakPrev() > PEAKMAX_ULS_F32)) ||
	   ((*Rte_Pim_RiPeakPrev() < PEAKMIN_ULS_F32) || (*Rte_Pim_RiPeakPrev() > PEAKMAX_ULS_F32)))
    {
		*Rte_Pim_LePeakPrev() = 0.0F;
		*Rte_Pim_RiPeakPrev() = 0.0F;
    }
	
	IniCmpFltSts_Cnt_T_lgc = ChkCompPersc(*Rte_Pim_ActvCmpBand1(),
										  *Rte_Pim_ActvCmpBand2(),
										  *Rte_Pim_ActvCmpBand3());
													 
	Rte_IrvWrite_WhlImbRejctnInit1_IniCmpFlt(IniCmpFltSts_Cnt_T_lgc);
	
	(void)Rte_Call_ActvCmpBand1_SetRamBlockStatus(TRUE);
	(void)Rte_Call_ActvCmpBand2_SetRamBlockStatus(TRUE);
	(void)Rte_Call_ActvCmpBand3_SetRamBlockStatus(TRUE);
	(void)Rte_Call_LePeakPrev_SetRamBlockStatus(TRUE);
	(void)Rte_Call_MaxCompPerc_SetRamBlockStatus(TRUE);
	(void)Rte_Call_RiPeakPrev_SetRamBlockStatus(TRUE);
 ...
 *********************************************************************************************************************/
    ...
    *Rte_Pim_dWhlImbRejctnFildWhlSpdLe() = WhlLeFrqQlfdUGRFild_MotRadPerSec_T_f32;
	...
	PimStordValLe[*Rte_Pim_DlyIdxLe()] = WhlLeFrqQlfdUGRFild_MotRadPerSec_T_f32 * (*Rte_Pim_ScaLe());
    *Rte_Pim_DlyIdxLe() = *Rte_Pim_DlyIdxLe() + 1U;
    if(*Rte_Pim_DlyIdxLe() >= NROFDLY_CNT_U08)
    {
        *Rte_Pim_DlyIdxLe() = 0U;
    }   
    ...
    *Rte_Pim_dWhlImbRejctnFildWhlSpdRi() = WhlRiFrqQlfdUGRFild_MotRadPerSec_T_f32;
    ...
    PimStordValRi[*Rte_Pim_DlyIdxRi()] = WhlRiFrqQlfdUGRFild_MotRadPerSec_T_f32 * (*Rte_Pim_ScaRi());
    *Rte_Pim_DlyIdxRi() = *Rte_Pim_DlyIdxRi() + 1U;
    if(*Rte_Pim_DlyIdxRi() >= NROFDLY_CNT_U08)
    {
        *Rte_Pim_DlyIdxRi() = 0U;
    }
    ...
    WhlImbRejctnCmd_MtrNwtMtr_T_f32 = ActvRejctnCmd(HwTq_HwNwtMtr_T_f32,
                                                    Enable_Uls_T_f32,
                                                    FreqEst_Hz_T_f32,
                                                    &WhlImbRejctnAmp_MtrNm_T_f32);
    /*** End of 'Active Rejection Command' ***/
    
    /*** Start of 'WIR Diagnostics' ***/        
    /* Amplitude Calculation1 */
    FilAmpTmp_MotNwtMtr_T_f32 = FilLpUpdOutp_f32(Abslt_f32_f32(WhlImbRejctnCmd_MtrNwtMtr_T_f32),Rte_Pim_CmdMgnLp1Fil());    
    CmdAmp_MotNwtMtr_T_f32 = FilLpUpdOutp_f32(FilAmpTmp_MotNwtMtr_T_f32 * ARCHGLBPRM_PIOVER2_ULS_F32,Rte_Pim_CmdMgnLp2Fil());
    
    /* MaxMagDiag */
    MaxMgnFlt_Cnt_T_lgc = MaxMagDiag(CmdAmp_MotNwtMtr_T_f32);
        
    /* DcTrendDiag */
    DCTrend_Cnt_T_lgc = DcTrendDiag(CmdAmp_MotNwtMtr_T_f32);
    
    /* FrequencyDiag */
    FrqDiagc_Cnt_T_lgc = FrequencyDiag(WhlImbRejctnCmd_MtrNwtMtr_T_f32,
                                       FreqEst_Hz_T_f32,
                                       Enable_Uls_T_f32,
    ...
    if((Rte_IrvRead_WhlImbRejctnPer1_SlowSpdDiagc() == TRUE) ||
       ...
       (Rte_Pim_MaxMgnFltRcvry()->Sts == SIGQLFR_FAILD) ||
    ...
    if((DCTrend_Cnt_T_lgc == TRUE) ||
       ...
       (Rte_Pim_DcTrendFltRcvry()->Sts == SIGQLFR_FAILD) ||
       (Rte_Pim_FrqDiagcFltRcvry()->Sts == SIGQLFR_FAILD) ||
       (Rte_Pim_WhlSpdCorrlnFltRcvry()->Sts == SIGQLFR_FAILD))
    {
        *Rte_Pim_RampNo() = TRUE;
    }
	else
    ...
    (void) Rte_Write_WhlImbRejctnCmd_Val(WhlImbRejctnCmd_MtrNwtMtr_T_f32);
 ...
 *********************************************************************************************************************/
    ...
    if((WhlSpdCorrlnFac_Uls_T_f32 >= TWOOVRTHREE_ULS_F32) && 
	   (*Rte_Pim_ActvCmpBand3() < ACTIVBANDMAX_ULS_U32))
    {
        *Rte_Pim_ActvCmpBand3() = 1U + *Rte_Pim_ActvCmpBand3();
    }
    ...
    if((WhlSpdCorrlnFac_Uls_T_f32 < TWOOVRTHREE_ULS_F32) &&
	   ...
	   (*Rte_Pim_ActvCmpBand2() < ACTIVBANDMAX_ULS_U32))
    {
        *Rte_Pim_ActvCmpBand2() = 1U + *Rte_Pim_ActvCmpBand2();
    }
    
    if((WhlSpdCorrlnFac_Uls_T_f32 < ONEOVRTHREE_ULS_F32) &&
       (WhlSpdCorrlnFac_Uls_T_f32 >= ONEOVRTWENTY_ULS_F32) &&
	   (*Rte_Pim_ActvCmpBand1() < ACTIVBANDMAX_ULS_U32))
    {
        *Rte_Pim_ActvCmpBand1() = 1U + *Rte_Pim_ActvCmpBand1();
    }
    
    if(WhlSpdCorrlnFac_Uls_T_f32 >= *Rte_Pim_MaxCompPerc())
    {
        *Rte_Pim_MaxCompPerc() = WhlSpdCorrlnFac_Uls_T_f32;
    }

	/* CheckCompPersistence */
	SlowSpeedDiag_Cnt_T_lgc = ChkCompPersc(*Rte_Pim_ActvCmpBand1(),
										   *Rte_Pim_ActvCmpBand2(),
										   *Rte_Pim_ActvCmpBand3());
                                                  ...
                                                  P2VAR(float32, AUTOMATIC, WhlImbRejctn_VAR) Coeff2_Uls_T_f32)
{
    ...
    Coeff2Tmp_Uls_T_f32 = ((In_MotNwtMtr_T_f32 - (*Coeff1_Uls_T_f32 * Zm_Uls_T_f32)) * B0_Uls_T_f32 ) +
                          (*Coeff2_Uls_T_f32 * Pk_Uls_T_f32);
    
    *Coeff1_Uls_T_f32 = In_MotNwtMtr_T_f32;
    
    *Coeff2_Uls_T_f32 = Coeff2Tmp_Uls_T_f32;
    
    Out_MotNwtMtr_T_f32 = Lim_f32(Coeff2Tmp_Uls_T_f32 * MagAtFreq_Uls_T_f32,
                                  -PHAADJMAX_ULS_F32,
                                  PHAADJMAX_ULS_F32);
...
* Inputs        :   HwTq_HwNwtMtr_T_f32,Enable_Uls_T_f32,FreqEst_Hz_T_f32, *WhlImbRejctnAmp_MtrNm_T_f32                    
                                                      ...
                                                      P2VAR(float32, AUTOMATIC, WhlImbRejctn_VAR) WhlImbRejctnAmp_MtrNm_T_f32)
{
    ...
    {
        /* FloatingL */
        LeStVariUpd_Uls_T_f32[Idx_Cnt_T_u08] = (Mplr_Uls_T_f32 * PimLeStDlyUpd[Idx_Cnt_T_u08]) + PimLeStVariUpd[Idx_Cnt_T_u08];
        ...
        /* FloatingR */
        RiStVariUpd_Uls_T_f32[Idx_Cnt_T_u08] = (Mplr_Uls_T_f32 * PimRiStDlyUpd[Idx_Cnt_T_u08]) + PimRiStVariUpd[Idx_Cnt_T_u08];
    ...
    LeOutp_Uls_T_f32 = Lim_f32(LeOutp_Uls_T_f32,-ADAPVFILMAX_ULS_F32,ADAPVFILMAX_ULS_F32);
	*Rte_Pim_dWhlImbRejctnLMSqdOutLe() = LeOutp_Uls_T_f32;
	
    RiOutp_Uls_T_f32 = Lim_f32(RiOutp_Uls_T_f32,-ADAPVFILMAX_ULS_F32,ADAPVFILMAX_ULS_F32);
	*Rte_Pim_dWhlImbRejctnLMSqdOutRi() = RiOutp_Uls_T_f32;
    ...
    if(AbsltPhaAdjY_HwDeg_T_f32 > NINETY_ULS_F32)
    {
        ...
        FinalPhaInp_Uls_T_f32 = -(LeOutp_Uls_T_f32 + RiOutp_Uls_T_f32);
    }
    else
    {
    ...
    *Rte_Pim_dWhlImbRejctnCnclTqOutp() = CnclTqOutp_MotNwtMtr_T_f32;
    ...
    FilAmpTmp_MotNwtMtr_T_f32 = FilLpUpdOutp_f32(Abslt_f32_f32(WhlImbRejctnCmd_MotNwtMtr_T_f32),Rte_Pim_BlndCmdMgnLp1Fil());
    
    Amp_MotNwtMtr_T_f32 = FilLpUpdOutp_f32(FilAmpTmp_MotNwtMtr_T_f32 * ARCHGLBPRM_PIOVER2_ULS_F32,Rte_Pim_BlndCmdMgnLp2Fil());
