%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 17-Nov-2016 14:40:24       %
...
IvtrLoaMtgtnEna.Description = [...
  'Inducates that a loss of assist has been detected'];
...
TqLimAssiRednLpFil.Description = [...
  'A Structure of Low Pass Filter Gain and State Variable'];
TqLimAssiRednLpFil.DocUnits = 'Cnt';
