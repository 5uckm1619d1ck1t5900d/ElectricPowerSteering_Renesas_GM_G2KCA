 ...
 *          File:  PwrLimr.c
 *     SW-C Type:  PwrLimr
 *  Generated at:  Tue Nov  8 15:43:28 2016
 *
 ...
 *********************************************************************************************************************/
	...
	VAR(float32, AUTOMATIC) MtrTrqCmdDualEcuFltScl_MotNwtMtr_T_f32;
    ...
    *Rte_Pim_dPwrLimrMinStdOperLim() = MinStdOperLim_MotNwtMtr_T_f32;
    ...
    /*** TrqCmd_Scl_DualEcu ***/
	MtrTrqCmdDualEcuFltScl_MotNwtMtr_T_f32 = MotTqCmdMrf_MotNwtMtr_T_f32 * DualEcuFltMtgtnSca_Uls_T_f32; 
	/*** END TrqCmd_Scl_DualEcu ***/
	
	/*** TrqCmd_Scl_Inverter ***/
    if((IvtrLoaMtgtnEna_Cnt_T_logl != FALSE) || (ELECGLBPRM_IVTRCNT_CNT_U08 == 1U))
    {
        MotTqCmdIvtrLoaSca_MotNwtMtr_T_f32 = MtrTrqCmdDualEcuFltScl_MotNwtMtr_T_f32;
    }
    else
    {
        MotTqCmdIvtrLoaSca_MotNwtMtr_T_f32 = MtrTrqCmdDualEcuFltScl_MotNwtMtr_T_f32 / (float32)MAXNRIVTRS_CNT_U08;
    }
