 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CurrReasbnDiagc_Type.h
...
#ifndef _RTE_CURRREASBNDIAGC_TYPE_H
# define _RTE_CURRREASBNDIAGC_TYPE_H
...
#    error "The magic number of the generated file <C:/Component/SF031A_CurrReasbnDiagc_Impl/tools/contract/Rte_CurrReasbnDiagc_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_CURRREASBNDIAGC_TYPE_H */
