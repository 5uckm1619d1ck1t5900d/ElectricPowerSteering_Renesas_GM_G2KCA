%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 19-Sep-2016 13:25:04       %
...
HwTqFilRec.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwTqFilRec.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
LatAFilRec.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
LatAFilRec.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
