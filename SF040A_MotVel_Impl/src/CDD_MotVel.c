...
#define HWVELMIN_HWRADPERSEC_F32        (-42.0F)
#define HWVELMAX_HWRADPERSEC_F32        42.0F
 ...
 *   uint8 *Rte_Pim_MotAgBufIdx(void)
 ...
 *********************************************************************************************************************/
 ...
 VAR(float32, AUTOMATIC)  HwVel_HwRadpSec_T_f32;
 ...
 VAR(sint8,   AUTOMATIC)  AssiMechPolarity_Uls_T_s08;
  ...
  /* Read Rte inputs */
 (void)Rte_Read_MotAgBufIdx_Val( &MotAgBufIdx_Cnt_T_u08 );               /* REQ: SF040A #68 I */
 (void)Rte_Read_MotAgTiBuf_Ary1D( MotAgTiBuf_MicroSec_T_u32 );           /* REQ: SF040A #38 I */
 (void)Rte_Read_MotAgBuf_Ary1D( MotAgBuf_MotRev_T_u0p16 );				 /* REQ: SF040A #37 I */
 (void)Rte_Read_AssiMechPolarity_Val( &AssiMechPolarity_Uls_T_s08 );     /* REQ: SF040A #67 I */
 ...
 *Rte_Pim_dMotVelAvrgTi() = (float32)AdjTiStampRef_MicroSec_T_u32;
 ...
 HwVel_HwRadpSec_T_f32 = MotVelCrf_MotRadpSec_T_f32 / Rte_Prm_SysGlbPrmSysKineRat_Val() ;
 HwVel_HwRadpSec_T_f32 = Lim_f32(HwVel_HwRadpSec_T_f32, HWVELMIN_HWRADPERSEC_F32, HWVELMAX_HWRADPERSEC_F32);
 /* ENDREQ: SF040A #88 */
 /* ENDREQ: SF040A #90 */
 /**************************************************************************************************/
 /*** ------------------------------   END: MtrVelHwVelCRFCalc --------------------------------- ***/
 /**************************************************************************************************/
 
 
 /* Write Rte Outputs */
 (void)Rte_Write_MotVelCrf_Val(MotVelCrf_MotRadpSec_T_f32);  /* REQ: SF040A #44 I */
 (void)Rte_Write_MotVelMrf_Val(MotVelMrf_MotRadpSec_T_f32);  /* REQ: SF040A #43 I */
 (void)Rte_Write_HwVel_Val(HwVel_HwRadpSec_T_f32);           /* REQ: SF040A #45 I */
