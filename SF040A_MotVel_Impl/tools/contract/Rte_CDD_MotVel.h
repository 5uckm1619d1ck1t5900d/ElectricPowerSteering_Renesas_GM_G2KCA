...
{
  /* PIM Handles section */
  P2VAR(uint8, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_MotAgBufIdx; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# endif
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CDD_MotVel_HwVel_Val(float32 data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(float32, RTE_CODE) Rte_Prm_CDD_MotVel_SysGlbPrmSysKineRat_Val(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
# define Rte_Write_HwVel_Val Rte_Write_CDD_MotVel_HwVel_Val
...
# define Rte_Prm_SysGlbPrmSysKineRat_Val Rte_Prm_CDD_MotVel_SysGlbPrmSysKineRat_Val
...
# define Rte_Pim_MotAgBufIdx() (Rte_Inst_CDD_MotVel->Pim_MotAgBufIdx) /* PRQA S 3453 */ /* MD_MSR_19.7 */
