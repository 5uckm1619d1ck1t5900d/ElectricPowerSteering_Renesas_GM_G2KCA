%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 04-Feb-2016 11:22:11       %
%                                  Created with tool release: 2.30.0     %
%                                  Synergy file: %version: 2 %           %
%                                  Date Modified: %date_modified: X %    %
%                                  Derived by: %derived_by: hz69by %          %
%%-----------------------------------------------------------------------%
...
DFTFALLRAMPRATE_MOTNWTMTRPERSEC_F32.Header = '';
...
DFTRISNGRAMPRATE_MOTNWTMTRPERSEC_F32.Header = '';
...
FLTINJ_TQOSCN_PREFINALCMD.Header = 'FltInj.h';
...
MAXRAMPRATE_MOTNWTMTR_F32.Header = '';
...
MINRAMPRATE_MOTNWTMTR_F32.Header = '';
