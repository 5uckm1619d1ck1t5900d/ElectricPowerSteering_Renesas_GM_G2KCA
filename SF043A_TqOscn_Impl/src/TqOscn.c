 ...
 *          File:  TqOscn.c
 *     SW-C Type:  TqOscn
 *  Generated at:  Fri Feb  5 13:32:09 2016
 *
...
#define PrmTqOscnAmpLim_u5p11	(*(const Ary1D_u5p11_5 *)	Rte_Prm_TqOscnAmpLimY_Ary1D())
#define PrmTqOscnFrqIn_u8p8		(*(const Ary1D_u8p8_5 *)	Rte_Prm_TqOscnFrqIn_Ary1D())
 ...
 *********************************************************************************************************************/
	...
	(void)Rte_Read_HwOscnMotAmp_Val(&HwOscnMotAmp_MotNwtMtr_T_f32);
	(void)Rte_Read_HwOscnEna_Logl(&HwOscnEna_Cnt_T_logl);
	(void)Rte_Read_HwOscnFrq_Val(&HwOscnFrq_HZ_T_f32);
	(void)Rte_Read_HwOscnFallRampRate_Val(&HwOscnFallRampRate_MotNwtMtrPerSec_T_f32);
	(void)Rte_Read_HwOscnRisngRampRate_Val(&HwOscnRisngRampRate_MotNwtMtrPerSec_T_f32);
	...
	*Rte_Pim_PrevEna() 								= HwOscnEna_Cnt_T_logl;						/*** PIM update ***/			
