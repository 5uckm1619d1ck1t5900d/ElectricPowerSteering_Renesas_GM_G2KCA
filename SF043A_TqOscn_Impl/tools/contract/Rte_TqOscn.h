...
# else
FUNC_P2CONST(Ary1D_u5p11_5, RTE_CONST_DEFAULT_RTE_CALPRM_GROUP, RTE_CODE) Rte_Prm_TqOscn_TqOscnAmpLimY_Ary1D(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# else
FUNC_P2CONST(Ary1D_u8p8_5, RTE_CONST_DEFAULT_RTE_CALPRM_GROUP, RTE_CODE) Rte_Prm_TqOscn_TqOscnFrqIn_Ary1D(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
...
#   if RTE_MAGIC_NUMBER != 1454701385
...
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1454701385
