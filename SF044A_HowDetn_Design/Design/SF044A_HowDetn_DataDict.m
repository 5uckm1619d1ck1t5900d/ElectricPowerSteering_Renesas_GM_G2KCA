%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 12-Aug-2016 09:36:49       %
...
SF044A.Description = [...
  ...
  'dence of the estimate is also specified.'];
...
HowDetnHiFrqRateY.GraphLink = {'HowDetnHiFrqRateX'};
...
HowDetnLoFrqRateX.EngVal =  ...
   [0                0                0
    0.07421875       0.07421875       0.07421875
...
HowDetnLoFrqRateY.GraphLink = {'HowDetnLoFrqRateX'};
...
EstimLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
EstimLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
FinalLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
FinalLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
IniLpFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
IniLpFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
IniLpFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
IniLpFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
IniLpFil3.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
IniLpFil3.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
StLpFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
StLpFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
TqHpFil.EngMin = [struct('FilLpRec',[struct('FilSt',-1000000000,'FilGain',0)],'CorrnFac',0)];
TqHpFil.EngMax = [struct('FilLpRec',[struct('FilSt',1000000000,'FilGain',3.402823466e+38)],'CorrnFac',3.402823466e+38)];
