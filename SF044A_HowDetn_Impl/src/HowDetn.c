...
#define PrmHowDetnHiFrqRateX_u8p8  (*(const Ary2D_u8p8_3_6 *) Rte_Prm_HowDetnHiFrqRateX_Ary2D())
#define PrmHowDetnHiFrqRateY_s7p8  (*(const Ary2D_s7p8_3_6 *) Rte_Prm_HowDetnHiFrqRateY_Ary2D())
#define PrmHowDetnLoFrqRateX_u8p8  (*(const Ary2D_u8p8_3_5 *) Rte_Prm_HowDetnLoFrqRateX_Ary2D())
#define PrmHowDetnLoFrqRateY_s7p8 (*(const Ary2D_s7p8_3_5 *) Rte_Prm_HowDetnLoFrqRateY_Ary2D())
 ...
 * Ary2D_s7p8_3_5: Array with 3 element(s) of type Ary1D_s7p8_5
 * Ary2D_s7p8_3_6: Array with 3 element(s) of type Ary1D_s7p8_6
 * Ary2D_u8p8_3_5: Array with 3 element(s) of type Ary1D_u8p8_5
 * Ary2D_u8p8_3_6: Array with 3 element(s) of type Ary1D_u8p8_6
 *
 *********************************************************************************************************************/
