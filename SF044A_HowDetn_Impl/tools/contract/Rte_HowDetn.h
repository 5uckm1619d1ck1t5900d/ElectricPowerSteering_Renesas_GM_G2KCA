...
# else
FUNC_P2CONST(Ary2D_u8p8_3_6, RTE_CONST_DEFAULT_RTE_CALPRM_GROUP, RTE_CODE) Rte_Prm_HowDetn_HowDetnHiFrqRateX_Ary2D(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# else
FUNC_P2CONST(Ary2D_s7p8_3_6, RTE_CONST_DEFAULT_RTE_CALPRM_GROUP, RTE_CODE) Rte_Prm_HowDetn_HowDetnHiFrqRateY_Ary2D(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# else
FUNC_P2CONST(Ary2D_u8p8_3_5, RTE_CONST_DEFAULT_RTE_CALPRM_GROUP, RTE_CODE) Rte_Prm_HowDetn_HowDetnLoFrqRateX_Ary2D(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# else
FUNC_P2CONST(Ary2D_s7p8_3_5, RTE_CONST_DEFAULT_RTE_CALPRM_GROUP, RTE_CODE) Rte_Prm_HowDetn_HowDetnLoFrqRateY_Ary2D(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
#    error "The magic number of the generated file <C:/Component/SF044A_HowDetn_Impl/tools/contract/Rte_HowDetn.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
