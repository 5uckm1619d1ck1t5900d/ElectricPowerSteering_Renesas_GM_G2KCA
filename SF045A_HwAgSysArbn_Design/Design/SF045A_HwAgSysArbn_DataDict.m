%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 16-Jun-2016 11:59:30       %
...
HwAgStsToSerlCom = DataDict.OpSignal;
HwAgStsToSerlCom.LongName = 'Handwheel Angle Status to Serial Communication';
HwAgStsToSerlCom.Description = [...
  'Handwheel Angle Status sent on Serial Com indicating the validity of H' ...
  'andwheel Angle in Pinion coordinates'];
HwAgStsToSerlCom.DocUnits = 'Cnt';
HwAgStsToSerlCom.SwcShoName = 'HwAgSysArbn';
HwAgStsToSerlCom.EngDT = dt.lgc;
HwAgStsToSerlCom.EngInit = 0;
HwAgStsToSerlCom.EngMin = 0;
HwAgStsToSerlCom.EngMax = 1;
HwAgStsToSerlCom.TestTolerance = 0;
HwAgStsToSerlCom.WrittenIn = {'HwAgSysArbnPer1'};
HwAgStsToSerlCom.WriteType = 'Rte';
...
HwAgSysArbnHwAgCorrlnRng.Impact = 'L';
...
HwAgSysArbnHwAgSlewRate.TuningOwner = 'Safety';
...
HwAgSysArbnHwAgSnsrlsKineThd.Impact = 'L';
...
HwAgSysArbnSlewRateTmr.TuningOwner = 'Safety';
...
CNVSECTOCNT_CNTPERSEC_U32 = DataDict.Constant;
CNVSECTOCNT_CNTPERSEC_U32.LongName = 'Convert Second to Count';
CNVSECTOCNT_CNTPERSEC_U32.Description = [...
  'Multiply by this constant to convert Second to Count'];
CNVSECTOCNT_CNTPERSEC_U32.DocUnits = 'CntPerSec';
CNVSECTOCNT_CNTPERSEC_U32.EngDT = dt.u32;
CNVSECTOCNT_CNTPERSEC_U32.EngVal = 10000;
CNVSECTOCNT_CNTPERSEC_U32.Define = 'Local';
...
%% NTC Definition                            
%%-------------------------------------------
NTCNR_0X0A1 = DataDict.NTC;
NTCNR_0X0A1.NtcNr = NtcNr1.NTCNR_0X0A1;
NTCNR_0X0A1.NtcTyp = 'None';
NTCNR_0X0A1.LongName = 'Nexteer Trouble Code Number 0X0A1';
NTCNR_0X0A1.Description = 'Kinematic Integrity Fault';
NTCNR_0X0A1.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0A1.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0A1.NtcStInfo.Bit7Descr = 'Unused';


NTCNR_0X0A6 = DataDict.NTC;
NTCNR_0X0A6.NtcNr = NtcNr1.NTCNR_0X0A6;
NTCNR_0X0A6.NtcTyp = 'Deb';
NTCNR_0X0A6.LongName = 'Nexteer Trouble Code Number 0X0A6';
NTCNR_0X0A6.Description = ' HwAg to Motor Angle Corrrelation';
NTCNR_0X0A6.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0A6.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0A6.NtcStInfo.Bit7Descr = 'Unused';
