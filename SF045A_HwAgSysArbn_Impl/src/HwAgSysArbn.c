...
#define CNVSECTOCNT_CNTPERSEC_U32           10000U
...
static FUNC(float32, HwAgSysArbn_CODE) HwSigSerlComArbn (float32 HwAgCorrdConf_Uls_T_f32,
 ...
 *   Std_ReturnType Rte_Write_HwAgStsToSerlCom_Logl(boolean data)
 ...
 *********************************************************************************************************************/
    ...
    HwAgToSerlCom_HwDeg_T_f32 = HwSigSerlComArbn(HwAgCorrdConf_Uls_T_f32, 
    ...
    *Rte_Pim_PrevPinionAgConf() = PinionAgConf_Uls_T_f32;
    ...
    (void)Rte_Write_HwAgStsToSerlCom_Logl(HwAgStsToSerlCom_Cnt_T_lgc); 
 ...
 *********************************************************************************************************************/
 ...
 /*****************************************************************************************************************
  * Name            :   HwSigSerlComArbn
  * Description     :   Implementation of 'HwSigSerlComArbn' subsystem. 
  ...
  * Outputs     :  , *HwAgStsToSerlCom_Cnt_T_lgc
...
static FUNC(float32, HwAgSysArbn_CODE) HwSigSerlComArbn (float32 HwAgCorrdConf_Uls_T_f32,
                                                         ...
                                                         P2VAR(boolean, AUTOMATIC, HwAgSysArbn_VAR) HwAgStsToSerlCom_Cnt_T_lgc)
{
    VAR(uint32, AUTOMATIC) TiSpan1_MilliSecPerCnt_T_u32;    
    VAR(float32, AUTOMATIC) HwAgToSerlCom_HwDeg_T_f32;
    ...
    else if(HwAgSnsrlsConf_Uls_T_f32 >= Rte_Prm_HwAgSysArbnHwAgSnsrlsCorrlnThd_Val())
    {
        ...
        (void)Rte_Call_GetTiSpan100MicroSec32bit_Oper(*Rte_Pim_HwAgToMotAgCorrlnDurnRefTmr(), &TiSpan1_MilliSecPerCnt_T_u32);
        
        if((*Rte_Pim_HwAgToMotAgCorrln() == TRUE) && 
          (TiSpan1_MilliSecPerCnt_T_u32 < (Rte_Prm_HwAgSysArbnHwAgToMotAgCorrlnElpdTiLim_Val() * CNVSECTOCNT_CNTPERSEC_U32)))
        {
