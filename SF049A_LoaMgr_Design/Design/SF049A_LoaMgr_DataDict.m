%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 07-Jun-2016 13:56:31       %
...
LoaScaDi.LongName = 'Lost Assist Scale disable';
LoaScaDi.Description = [...
  'Loss Assist Scale disable enabled during manufacturing'];
...
TqLoaAvl.LongName = 'Torque Loss of Assist Available';
...
%%-------------------------------------------
SnsrlsMotAgAvl = DataDict.IRV;
SnsrlsMotAgAvl.LongName = 'Sensor-Less Motor Angle Available';
SnsrlsMotAgAvl.Description = [...
  'Sensorless Motor Position Available boolean signal'];
SnsrlsMotAgAvl.DocUnits = 'Cnt';
SnsrlsMotAgAvl.EngDT = dt.lgc;
SnsrlsMotAgAvl.EngInit = 0;
SnsrlsMotAgAvl.EngMin = 0;
SnsrlsMotAgAvl.EngMax = 1;
SnsrlsMotAgAvl.ReadIn = {'LoaMgrPer1'};
SnsrlsMotAgAvl.WrittenIn = {'LoaMgrInit1'};
...
%% NTC Definition                            
%%-------------------------------------------
NTCNR_0X0AA = DataDict.NTC;
NTCNR_0X0AA.NtcNr = 'NTCNR_0X0AA';
NTCNR_0X0AA.NtcTyp = 'None';
NTCNR_0X0AA.LongName = 'Nexteer Trouble Code Number 0X0AA';
NTCNR_0X0AA.Description = 'Immediate Shutdown - trouble code 0X0AA';
NTCNR_0X0AA.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0AA.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0AA.NtcStInfo.Bit7Descr = 'Unused';


NTCNR_0X0AB = DataDict.NTC;
NTCNR_0X0AB.NtcNr = 'NTCNR_0X0AB';
NTCNR_0X0AB.NtcTyp = 'None';
NTCNR_0X0AB.LongName = 'Nexteer Trouble Code Number 0X0AB';
NTCNR_0X0AB.Description = 'Controlled Shutdown - trouble code 0X0AB';
NTCNR_0X0AB.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0AB.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0AB.NtcStInfo.Bit7Descr = 'Unused';


NTCNR_0X0AC = DataDict.NTC;
NTCNR_0X0AC.NtcNr = 'NTCNR_0X0AC';
NTCNR_0X0AC.NtcTyp = 'None';
NTCNR_0X0AC.LongName = 'Nexteer Trouble Code Number 0X0AC';
NTCNR_0X0AC.Description = 'Handwheel Torque Independent Signal too low - trouble code 0X0AC';
NTCNR_0X0AC.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0AC.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0AC.NtcStInfo.Bit7Descr = 'Unused';


NTCNR_0X0AD = DataDict.NTC;
NTCNR_0X0AD.NtcNr = 'NTCNR_0X0AD';
NTCNR_0X0AD.NtcTyp = 'None';
NTCNR_0X0AD.LongName = 'Nexteer Trouble Code Number 0X0AD';
NTCNR_0X0AD.Description = 'Motor Position Independent Signal too low - trouble code 0X0AD';
NTCNR_0X0AD.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0AD.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0AD.NtcStInfo.Bit7Descr = 'Unused';


NTCNR_0X0AE = DataDict.NTC;
NTCNR_0X0AE.NtcNr = 'NTCNR_0X0AE';
NTCNR_0X0AE.NtcTyp = 'None';
NTCNR_0X0AE.LongName = 'Nexteer Trouble Code Number 0X0AE';
NTCNR_0X0AE.Description = 'Motor Current Measure Independent Signal too low - trouble code 0X0AE';
NTCNR_0X0AE.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0AE.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0AE.NtcStInfo.Bit7Descr = 'Unused';


NTCNR_0X0AF = DataDict.NTC;
NTCNR_0X0AF.NtcNr = 'NTCNR_0X0AF';
NTCNR_0X0AF.NtcTyp = 'None';
NTCNR_0X0AF.LongName = 'Nexteer Trouble Code Number 0X0AF';
NTCNR_0X0AF.Description = 'Inverter Independent Signal too low - trouble code 0X0AF';
NTCNR_0X0AF.NtcStInfo = DataDict.NtcStInfoBitPacked;
NTCNR_0X0AF.NtcStInfo.Bit0Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit1Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit2Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit3Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit4Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit5Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit6Descr = 'Unused';
NTCNR_0X0AF.NtcStInfo.Bit7Descr = 'Unused';
