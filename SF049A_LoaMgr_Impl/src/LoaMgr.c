...
static FUNC(uint8, LoaMgr_CODE) ReqMotAgResp(uint8 MotAgIdptMin_Cnt_T_u08, boolean SmpAvl_Cnt_T_lgc);
 ...
 *********************************************************************************************************************/
    ...
    *Rte_Pim_PrevIvtrIdptSigVal() = MAXIVTRIDPTSIGALLWD_CNT_U08;
    ...
    /* Future input signal.  Logic is in place for FET Mitigation
       feature. Input value is hard coded to FALSE. */
    Rte_IrvWrite_LoaMgrInit1_SnsrlsMotAgAvl(FALSE);         /* REQ: SF049A #173 I */
 ...
 *********************************************************************************************************************/
    ...
    VAR(boolean, AUTOMATIC) SmpAvl_Cnt_T_lgc = Rte_IrvRead_LoaMgrPer1_SnsrlsMotAgAvl(); 
    ...
    *Rte_Pim_PrevHwTqIdptSigResp() = HwTqResp_Cnt_T_u08;
    ...
    /* REQ: SF049A #176 I */
    /* REQ: SF049A #62 I */
    MotAgResp_Cnt_T_u08 = ReqMotAgResp(MotAgIdptMin_Cnt_T_u08,SmpAvl_Cnt_T_lgc);
...
*                   functionality in 'Request_Responses' block.
* Inputs      :   MotAgIdptMin_Cnt_T_u08, SmpAvl_Cnt_T_lgc 
...
static FUNC(uint8, LoaMgr_CODE) ReqMotAgResp(uint8 MotAgIdptMin_Cnt_T_u08, boolean SmpAvl_Cnt_T_lgc)
{
    ...
    {
        case 1u: 
            MotAgResp_Cnt_T_u08 = ((SmpAvl_Cnt_T_lgc == TRUE) ? (Rte_Prm_LoaMgrMotAgAvlSnsrlsResp_Val()) : 
