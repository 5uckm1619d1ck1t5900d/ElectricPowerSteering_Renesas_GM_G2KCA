 ...
 *          File:  Rte_LoaMgr.h
 *     SW-C Type:  LoaMgr
 *  Generated at:  Wed Jun 22 09:26:42 2016
 *
...
FUNC(void, RTE_CODE) Rte_IrvWrite_LoaMgr_LoaMgrInit1_SnsrlsMotAgAvl(boolean data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(boolean, RTE_CODE) Rte_IrvRead_LoaMgr_LoaMgrPer1_SnsrlsMotAgAvl(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_IrvWrite_LoaMgrInit1_SnsrlsMotAgAvl(data) \
  Rte_IrvWrite_LoaMgr_LoaMgrInit1_SnsrlsMotAgAvl(data)
/* PRQA L:L1 */

/* PRQA S 3453 L1 */ /* MD_MSR_19.7 */
# define Rte_IrvRead_LoaMgrPer1_SnsrlsMotAgAvl() \
  Rte_IrvRead_LoaMgr_LoaMgrPer1_SnsrlsMotAgAvl()
/* PRQA L:L1 */
 ...
 *   ----------------------
 *   void Rte_IrvWrite_LoaMgrInit1_SnsrlsMotAgAvl(boolean data)
 *
 ...
 *   ---------------------
 *   boolean Rte_IrvRead_LoaMgrPer1_SnsrlsMotAgAvl(void)
 *
 * Client/Server Interfaces:
 * =========================
 *   Server Invocation:
...
#   if RTE_MAGIC_NUMBER != 1466569288
#    error "The magic number of the generated file <C:/Component/SF049A_LoaMgr_Impl/tools/contract/Rte_LoaMgr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1466569288
