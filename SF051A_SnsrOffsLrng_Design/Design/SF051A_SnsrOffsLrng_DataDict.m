%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 17-Aug-2016 09:35:34       %
...
HwTqLrngSts.Description = [...
  'Provides the learning Status of the HandWheel Torque'];
...
SnsrOffsLrngHwAgLrngYawRateThd.EngMin = -120;
...
SnsrOffsLrngHwTqLrngHwAgDbnd.EngVal = 0.2;
SnsrOffsLrngHwTqLrngHwAgDbnd.EngMin = 0.1;
...
SnsrOffsLrngHwTqLrngHwTqThd.EngMax = 3;
...
SnsrOffsLrngTqInpDetnSinGenrAmp.EngMax = 10;
...
SnsrOffsLrngTqInpDetnSinGenrFrq.EngMin = 0.1;
SnsrOffsLrngTqInpDetnSinGenrFrq.EngMax = 100;
...
SnsrOffsLrngTqInpDetnStg1FilGain.EngMin = -2;
SnsrOffsLrngTqInpDetnStg1FilGain.EngMax = 2;
...
SnsrOffsLrngTqInpDetnStg2FilGainCen.EngMin = -2;
SnsrOffsLrngTqInpDetnStg2FilGainCen.EngMax = 2;
...
SnsrOffsLrngTqInpDetnStg2FilGainDwn.EngMin = -2;
SnsrOffsLrngTqInpDetnStg2FilGainDwn.EngMax = 2;
...
SnsrOffsLrngTqInpDetnStg2FilGainUp.EngMin = -2;
SnsrOffsLrngTqInpDetnStg2FilGainUp.EngMax = 2;
...
SnsrOffsLrngTqInpDetnStg2WinSize.EngMax = 65463;
...
SnsrOffsLrnd.EngDT = struct.SnsrLrndOffsRec1;
SnsrOffsLrnd.EngInit = [];
SnsrOffsLrnd.EngMin = [struct('YawRateOffs',-50,'HwAgOffs',-20,'HwTqOffs',-5,'HwAgLrndTi',0,'HwAgLrngYawOffsRef',-60,'YawRateElpdTi',0,'HwAgLrngHwAgFilSt',-1440,'HwAgLrngSysTqFilSt',-362,'HwTqLrngHwAgRef',-1440,'HwTqLrngCovariMtrx',-4000,'HwTqLrngEstimnVect',-511,'HwTqLrngSampleCntNeg',0,'HwTqLrngSampleCntPos',0,'HwTqLrngSts',0,'YawRateOffsVld',0)];
SnsrOffsLrnd.EngMax = [struct('YawRateOffs',50,'HwAgOffs',20,'HwTqOffs',5,'HwAgLrndTi',1440,'HwAgLrngYawOffsRef',60,'YawRateElpdTi',1440,'HwAgLrngHwAgFilSt',1440,'HwAgLrngSysTqFilSt',362,'HwTqLrngHwAgRef',1440,'HwTqLrngCovariMtrx',4000,'HwTqLrngEstimnVect',511,'HwTqLrngSampleCntNeg',65535,'HwTqLrngSampleCntPos',65535,'HwTqLrngSts',4,'YawRateOffsVld',1)];
...
dSnsrOffsLrngHwTqLrngHwAgMeas.EngMin = -1440;
dSnsrOffsLrngHwTqLrngHwAgMeas.EngMax = 1440;
...
dSnsrOffsLrngHwTqLrngHwTqMeas.EngMin = -10;
dSnsrOffsLrngHwTqLrngHwTqMeas.EngMax = 10;
...
dSnsrOffsLrngHwTqLrngHwTqOffsRaw.EngMin = -10;
dSnsrOffsLrngHwTqLrngHwTqOffsRaw.EngMax = 10;
...
dSnsrOffsLrngSysTqFild.EngMin = -1000;
dSnsrOffsLrngSysTqFild.EngMax = 1000;
...
dSnsrOffsLrngTqInpDetnStg1Outp.EngMin = -100;
...
dSnsrOffsLrngYawA.EngMin = -1200;
dSnsrOffsLrngYawA.EngMax = 1200;
...
dSnsrOffsLrngYawLrngBiasEstimnRaw.EngMin = -120;
dSnsrOffsLrngYawLrngBiasEstimnRaw.EngMax = 120;
...
HwAgCdngFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgCdngFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgLrngFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgLrngFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgLrngFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgLrngFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgLrngSysTqFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgLrngSysTqFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgLrngSysTqFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgLrngSysTqFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgMeasFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgMeasFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwAgMeasFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwAgMeasFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwTqMeasFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwTqMeasFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwTqMeasFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwTqMeasFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
HwVelCdngFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
HwVelCdngFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
HwVelCdngFil.InitRowCol = [1  1];


SetRamBlkSts = DataDict.PIM;
SetRamBlkSts.LongName = 'SetRam Block Status';
SetRamBlkSts.Description = [...
  'Set Ram Block Status as True or False'];
SetRamBlkSts.DocUnits = 'Cnt';
SetRamBlkSts.EngDT = dt.lgc;
SetRamBlkSts.EngMin = 0;
SetRamBlkSts.EngMax = 1;
SetRamBlkSts.InitRowCol = [1  1];
...
SysTqCdngFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
SysTqCdngFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
TqInpDetnHwTqFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
TqInpDetnHwTqFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
TqInpDetnPreProcEnaLoop.EngMax = 65535;
...
YawACdngFil.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
YawACdngFil.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
YawCdngFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
YawCdngFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
YawCdngFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
YawCdngFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
YawLrngElpdLrngTi.DocUnits = 'MotNwtMtr';
YawLrngElpdLrngTi.EngDT = dt.float32;
YawLrngElpdLrngTi.EngMin = 0;
YawLrngElpdLrngTi.EngMax = 8.79;
...
YawLrngFil1.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
YawLrngFil1.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
YawLrngFil2.EngMin = [struct('FilSt',-3.402823466e+38,'FilGain',0)];
YawLrngFil2.EngMax = [struct('FilSt',3.402823466e+38,'FilGain',3.402823466e+38)];
...
YawRatePrev.DocUnits = 'VehDegPerSecSqd';
YawRatePrev.EngDT = dt.float32;
YawRatePrev.EngMin = -1200;
YawRatePrev.EngMax = 1200;
...
HWAGHILIM_HWDEG_F32.Description = 'Handwheel Angle High Limit';
...
TISTEP10MS_MINS_F32.EngVal = 1.6667e-05;
