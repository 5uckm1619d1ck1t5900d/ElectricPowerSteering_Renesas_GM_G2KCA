%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 31-Aug-2016 10:40:11       %
...
HwAgVehCentrTrimVld.NtcNr = 'HWAGVEHCENTRTRIM_HWAGVEHCENTRTRIMVLDNTCNR_CNT_ENUM';
