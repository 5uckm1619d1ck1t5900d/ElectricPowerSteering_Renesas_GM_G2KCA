 ...
 *          File:  MotRefMdl.c
 *     SW-C Type:  MotRefMdl
 *  Generated at:  Wed Nov  9 16:29:43 2016
 *
...
(void)Rte_Read_CurrMeasLoaMtgtnEna_Logl(&CurrMeasLoaMtgtnEna_Cnt_T_logl); 
...
if ((CurrMeasLoaMtgtnEna_Cnt_T_logl==TRUE) ||(IvtrLoaMtgtnEna_Cnt_T_logl==TRUE) || (Rte_Prm_MotRefMdlFbCtrlDi_Logl() == TRUE) || (DualEcuMotCtrlMtgtnEna_Cnt_T_logl == TRUE))
{
...
(void)Rte_Write_MotVltgDaxFf_Val(Lim_f32(MotVoltDaxFf_Volt_T_f32,MOTVLTGDAXFFLOLIM_VOLT_F32,MOTVLTGDAXFFHILIM_VOLT_F32));
(void)Rte_Write_MotVltgQaxFf_Val(Lim_f32(MotVoltQaxFf_Volt_T_f32,MOTVLTGQAXFFLOLIM_VOLT_F32,MOTVLTGQAXFFHILIM_VOLT_F32));
