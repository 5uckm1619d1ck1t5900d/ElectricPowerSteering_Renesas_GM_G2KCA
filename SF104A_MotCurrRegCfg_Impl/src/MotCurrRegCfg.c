...
#define MOTAGELECDLYHILIM_MOTRAD_F32      ((float32)Ag12_UpperLimit)    
#define MOTAGELECDLYLOLIM_MOTRAD_F32      ((float32)Ag12_LowerLimit)
#define MOTDAMPGHILIM_OHM_F32             ((float32)R2_UpperLimit)
#define MOTDAMPGLOLIM_OHM_F32             ((float32)R2_LowerLimit)
#define MOTINTGLGAINHILIM_OHM_F32         ((float32)R4_UpperLimit)
#define MOTINTGLGAINLOLIM_OHM_F32         ((float32)R4_LowerLimit)
 ...
 *********************************************************************************************************************/
    ...
    /* REQ: SF104A #36 I */
    (void)Rte_Read_IvtrLoaMtgtnEna_Logl(&IvtrLoaMtgtnEn_Cnt_T_lgc);  /* REQ: SF104A #120 I */
    (void)Rte_Read_MotCurrEolCalSt_Val(&MotCurrEolCalSt_T_enum);     /* REQ: SF104A #44 I */
    (void)Rte_Read_CurrMeasLoaMtgtnEna_Logl(&CurrMeasLoaMtgtnEna_Cnt_T_lgc); /* REQ: SF104A #119 I */
    (void)Rte_Read_MotInduDaxEstimd_Val(&MotInduDaxEstimd_Henry_T_f32); /* REQ: SF104A #46 I */
    (void)Rte_Read_MotInduQaxEstimd_Val(&MotInduQaxEstimd_Henry_T_f32); /* REQ: SF104A #47 I */
    (void)Rte_Read_MotREstimd_Val(&MotREstimd_Ohm_T_f32);   /* REQ: SF104A #45 I */
    (void)Rte_Read_MotVelMrf_Val(&MotVelMrf_MotRadPerSec_T_f32);  /* REQ: SF104A #27 I */
    (void)Rte_Read_VehSpd_Val(&VehSpd_Kph_T_f32);  /* REQ: SF104A #43 I */
    (void)Rte_Read_DualEcuMotCtrlMtgtnEna_Logl(&DualEcuMotCtrlMtgtnEna_Cnt_T_lgc);  /* REQ: SF104A #44 I */
    ...
    *Rte_Pim_dMotCurrRegCfgMotVelMrfFild()=MtrVelFiltLp_MotRadPerSec_T_f32;
    ...
    {   
        ...
        else
        {
            ...
            MotIntglGainQax_Ohm_T_f32 = MotGainClsdLoopQax_Hz_T_f32*(MotREstimd_Ohm_T_f32+ (Rte_Prm_MotCurrRegCfgMotRVirtQax_Val() / ARCHGLBPRM_HALFSQRT3_ULS_F32))* Rte_Prm_MotCurrRegCfgIntglGainSampleTi_Val();/* REQ: SF104A #118 I */
            MotIntglGainDax_Ohm_T_f32 = MotGainClsdLoopDax_Hz_T_f32 *(MotREstimd_Ohm_T_f32+ (Rte_Prm_MotCurrRegCfgMotRVirtDax_Val() / ARCHGLBPRM_HALFSQRT3_ULS_F32))* Rte_Prm_MotCurrRegCfgIntglGainSampleTi_Val();/* REQ: SF104A #118 I */
        }
        /* ENDEQ: SF104A #88 I */
        /* ENDREQ: SF104A #86 I */
    ...
    (void)Rte_Write_MotAgElecDly_Val(ElecPosDelayComp_MotRad_T_f32); /* REQ: SF104A #55 I */
    (void)Rte_Write_MotDampgDax_Val(MotDampgDax_Ohm_T_f32); /* REQ: SF104A #53 I */
    (void)Rte_Write_MotDampgQax_Val(MotDampgQax_Ohm_T_f32); /* REQ: SF104A #54I */
    (void)Rte_Write_MotIntglGainDax_Val(MotIntglGainDax_Ohm_T_f32); /* REQ: SF104A #51 I */
    (void)Rte_Write_MotIntglGainQax_Val(MotIntglGainQax_Ohm_T_f32); /* REQ: SF104A #52 I */
    (void)Rte_Write_MotPropGainDax_Val(MotPropGainDax_Ohm_T_f32); /* REQ: SF104A #28 I */
    (void)Rte_Write_MotPropGainQax_Val(MotPropGainQax_Ohm_T_f32); /* REQ: SF104A #49 I */
    /* ENDREQ: SF104A #36 I */
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
