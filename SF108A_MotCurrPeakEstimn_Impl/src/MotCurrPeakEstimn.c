 ...
 *********************************************************************************************************************/
	 ...
	 (void)Rte_Read_DualEcuMotCtrlMtgtnEna_Logl(&DualEcuMotCtrlMtgtnEna_Cnt_T_lgc);  /* REQ: SF108A #81 I */
	 (void)Rte_Read_IvtrLoaMtgtnEna_Logl(&IvtrLoaMtgtnEna_Cnt_T_lgc); /* REQ: SF108A #82 I */

	 /* Determine MotCurrDaxestimn and MotCurrQaxestimn */
     /* REQ: SF108A #48 I */ /* REQ: SF108A #49 I */
	 if((CurrMeasLoaMtgtnEna_Cnt_T_lgc== TRUE)||(DualEcuMotCtrlMtgtnEna_Cnt_T_lgc == TRUE)||(IvtrLoaMtgtnEna_Cnt_T_lgc == TRUE))
	 {
